...
Pizza color won't help tactics, but at least you'll look good before you shoot

## Obtaining

M9A4 can be obtained from the Creative Menu. It is registered as `minecraft:m9a4`.

## Usage

M9A4 is a TaCZ firearm. It uses [9mm Bullet](9mmBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
