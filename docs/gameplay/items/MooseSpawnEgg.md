...
The Moose Spawn Egg is available from the Creative Menu.

## Usage

Use the Moose Spawn Egg on a block to spawn a Moose.
...
* This item is registered as `minecraft:moose_spawn_egg`.
