# Light Ammo Extended Mag I

## Obtaining

Light Ammo Extended Mag I can be obtained from the Creative Menu. It is registered as `minecraft:light_extended_mag_1`.

## Usage

Light Ammo Extended Mag I is a TaCZ extended mag attachment. Install it through the gun refit screen on compatible firearms.
