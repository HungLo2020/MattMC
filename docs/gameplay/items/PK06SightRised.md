...
PK06 Sight Rised can be obtained from the Creative Menu. It is registered as `minecraft:sight_pk06_rifle`.

## Usage

PK06 Sight Rised is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
