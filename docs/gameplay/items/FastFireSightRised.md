...
FastFire Sight Rised can be obtained from the Creative Menu. It is registered as `minecraft:sight_fastfire_rifle`.

## Usage

FastFire Sight Rised is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
