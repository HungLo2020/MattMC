...
HK-416A5 can be obtained from the Creative Menu. It is registered as `minecraft:hk416d`.

## Usage

HK-416A5 is a TaCZ firearm. It uses [5.56x45mm Bullet](556x45mmBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
...
| Magazine size | 30 |
| Extended magazine sizes | 40, 50, 100 |
