...
Magpul MOE Stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_moe`.

## Usage

Magpul MOE Stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
