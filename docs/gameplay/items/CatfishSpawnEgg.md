...
The Catfish Spawn Egg is available from the Creative Menu.

## Usage

Use the Catfish Spawn Egg on a block to spawn a Catfish.
...
* This item is registered as `minecraft:catfish_spawn_egg`.
