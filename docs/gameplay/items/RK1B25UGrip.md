...
RK-1 B25U Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_rk1_b25u`.

## Usage

RK-1 B25U Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
