...
The Mudskipper Spawn Egg is available from the Creative Menu.

## Usage

Use the Mudskipper Spawn Egg on a block to spawn a Mudskipper.
...
* This item is registered as `minecraft:mudskipper_spawn_egg`.
