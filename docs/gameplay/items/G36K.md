...
G36K can be obtained from the Creative Menu. It is registered as `minecraft:g36k`.

## Usage

G36K is a TaCZ firearm. It uses [5.56x45mm Bullet](556x45mmBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
