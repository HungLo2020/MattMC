...
Scout 4-10x Scope can be obtained from the Creative Menu. It is registered as `minecraft:scope_standard_8x`.

## Usage

Scout 4-10x Scope is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
