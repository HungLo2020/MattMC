...
Just like petting a purring cat.

## Obtaining

HK-MP5A5 can be obtained from the Creative Menu. It is registered as `minecraft:hk_mp5a5`.

## Usage

HK-MP5A5 is a TaCZ firearm. It uses [9mm Bullet](9mmBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
...
| Magazine size | 30 |
| Extended magazine sizes | 40, 50, 60 |
