...
Light Ammo Extended Mag II can be obtained from the Creative Menu. It is registered as `minecraft:light_extended_mag_2`.

## Usage

Light Ammo Extended Mag II is a TaCZ extended mag attachment. Install it through the gun refit screen on compatible firearms.
...
Extended magazine attachments use level 2 to select the corresponding larger magazine size from each compatible gun.
