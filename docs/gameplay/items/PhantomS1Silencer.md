...
Phantom S1 Silencer can be obtained from the Creative Menu. It is registered as `minecraft:muzzle_silencer_phantom_s1`.

## Usage

Phantom S1 Silencer is a TaCZ muzzle attachment. Install it through the gun refit screen on compatible firearms.
