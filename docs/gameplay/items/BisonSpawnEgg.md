...
The Bison Spawn Egg is available from the Creative Menu.

## Usage

Use the Bison Spawn Egg on a block to spawn a Bison.
...
* This item is registered as `minecraft:bison_spawn_egg`.
