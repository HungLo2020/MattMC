...
OKP-7 Sight can be obtained from the Creative Menu. It is registered as `minecraft:sight_okp7`.

## Usage

OKP-7 Sight is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
