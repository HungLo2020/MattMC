...
AUG Builtin Scope can be obtained from the Creative Menu. It is registered as `minecraft:scope_aug_default`.

## Usage

AUG Builtin Scope is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
