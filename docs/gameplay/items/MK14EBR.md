...
Not born on the wrong date, just on the wrong place.

## Obtaining

MK14 EBR can be obtained from the Creative Menu. It is registered as `minecraft:mk14`.

## Usage

MK14 EBR is a TaCZ firearm. It uses [.308 Winchester Bullet](308WinchesterBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
...
| Magazine size | 10 |
| Extended magazine sizes | 15, 18, 20 |
