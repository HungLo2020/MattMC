...
The only bad thing for expensive things, is the expense.

## Obtaining

SCAR-H Battle Rifle can be obtained from the Creative Menu. It is registered as `minecraft:scar_h`.

## Usage

SCAR-H Battle Rifle is a TaCZ firearm. It uses [.308 Winchester Bullet](308WinchesterBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
...
| Magazine size | 20 |
| Extended magazine sizes | 25, 30, 40 |
