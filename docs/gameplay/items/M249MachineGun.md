...
Cut anything down in your way.

## Obtaining

M249 Machine Gun can be obtained from the Creative Menu. It is registered as `minecraft:m249`.

## Usage

M249 Machine Gun is a TaCZ firearm. It uses [5.56x45mm Bullet](556x45mmBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
