...
The Copper Golem Spawn Egg is available from the Creative Menu.

## Usage

Use the Copper Golem Spawn Egg on a block to spawn a Copper Golem.
...
* This item is registered as `minecraft:copper_golem_spawn_egg`.
