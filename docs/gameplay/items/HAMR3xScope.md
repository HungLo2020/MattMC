...
HAMR 3x Scope can be obtained from the Creative Menu. It is registered as `minecraft:scope_hamr`.

## Usage

HAMR 3x Scope is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
