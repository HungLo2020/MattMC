...
FastFire Sight can be obtained from the Creative Menu. It is registered as `minecraft:sight_fastfire_pistol`.

## Usage

FastFire Sight is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
