...
Talon SG2 Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_vertical_talon`.

## Usage

Talon SG2 Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
