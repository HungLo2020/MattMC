...
The Platypus Spawn Egg is available from the Creative Menu.

## Usage

Use the Platypus Spawn Egg on a block to spawn a Platypus.
...
* This item is registered as `minecraft:platypus_spawn_egg`.
