...
Incendiary Ammo can be obtained from the Creative Menu. It is registered as `minecraft:ammo_mod_i`.

## Usage

Incendiary Ammo is a TaCZ ammo modifier attachment. Install it through the gun refit screen on compatible firearms.
