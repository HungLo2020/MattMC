...
T-Rex Heavy Brake can be obtained from the Creative Menu. It is registered as `minecraft:muzzle_brake_trex`.

## Usage

T-Rex Heavy Brake is a TaCZ muzzle attachment. Install it through the gun refit screen on compatible firearms.
