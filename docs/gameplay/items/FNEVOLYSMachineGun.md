...
Hey, this is an integrated receiver... what are you doing!?

## Obtaining

FN EVOLYS Machine Gun can be obtained from the Creative Menu. It is registered as `minecraft:fn_evolys`.

## Usage

FN EVOLYS Machine Gun is a TaCZ firearm. It uses [.308 Winchester Bullet](308WinchesterBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
