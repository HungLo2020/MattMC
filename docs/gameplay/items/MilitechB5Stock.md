...
Militech B5 Stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_militech_b5`.

## Usage

Militech B5 Stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
