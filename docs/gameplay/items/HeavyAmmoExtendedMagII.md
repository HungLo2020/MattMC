...
Heavy Ammo Extended Mag II can be obtained from the Creative Menu. It is registered as `minecraft:extended_mag_2`.

## Usage

Heavy Ammo Extended Mag II is a TaCZ extended mag attachment. Install it through the gun refit screen on compatible firearms.
