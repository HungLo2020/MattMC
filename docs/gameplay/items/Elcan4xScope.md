...
Elcan 4x Scope can be obtained from the Creative Menu. It is registered as `minecraft:scope_elcan_4x`.

## Usage

Elcan 4x Scope is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
