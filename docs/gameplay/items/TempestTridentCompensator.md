# Tempest Trident Compensator

## Obtaining

Tempest Trident Compensator can be obtained from the Creative Menu. It is registered as `minecraft:muzzle_compensator_trident`.

## Usage

Tempest Trident Compensator is a TaCZ muzzle attachment. Install it through the gun refit screen on compatible firearms.
