...
Militech 552 HCOG can be obtained from the Creative Menu. It is registered as `minecraft:sight_552`.

## Usage

Militech 552 HCOG is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
