...
The Rain Frog Spawn Egg is available from the Creative Menu.

## Usage

Use the Rain Frog Spawn Egg on a block to spawn a Rain Frog.
...
* This item is registered as `minecraft:rain_frog_spawn_egg`.
