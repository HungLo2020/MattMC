...
Trijicon SRS-02 Reflex Sight can be obtained from the Creative Menu. It is registered as `minecraft:sight_srs_02`.

## Usage

Trijicon SRS-02 Reflex Sight is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
