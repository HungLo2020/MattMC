...
Pioneer A3 Brake can be obtained from the Creative Menu. It is registered as `minecraft:muzzle_brake_pioneer`.

## Usage

Pioneer A3 Brake is a TaCZ muzzle attachment. Install it through the gun refit screen on compatible firearms.
