# Carbon bone C5 Stock

## Obtaining

Carbon bone C5 Stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_carbon_bone_c5`.

## Usage

Carbon bone C5 Stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
