...
Koch Ranger Heavy Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_vertical_ranger`.

## Usage

Koch Ranger Heavy Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
