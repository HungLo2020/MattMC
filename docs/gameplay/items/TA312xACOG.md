...
TA31 2x ACOG can be obtained from the Creative Menu. It is registered as `minecraft:scope_acog_ta31`.

## Usage

TA31 2x ACOG is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
