...
Collectors love to see their favorites reborn in the modern age

## Obtaining

Sks Tactical Rifle can be obtained from the Creative Menu. It is registered as `minecraft:sks_tactical`.

## Usage

Sks Tactical Rifle is a TaCZ firearm. It uses [7.62x39mm Bullet](762x39mmBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
