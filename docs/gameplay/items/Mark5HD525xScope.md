# Mark 5 HD 5-25x Scope

## Obtaining

Mark 5 HD 5-25x Scope can be obtained from the Creative Menu. It is registered as `minecraft:scope_mk5hd`.

## Usage

Mark 5 HD 5-25x Scope is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
