...
RK-6 Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_rk6`.

## Usage

RK-6 Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
