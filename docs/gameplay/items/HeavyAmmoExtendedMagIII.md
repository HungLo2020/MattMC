...
Heavy Ammo Extended Mag III can be obtained from the Creative Menu. It is registered as `minecraft:extended_mag_3`.

## Usage

Heavy Ammo Extended Mag III is a TaCZ extended mag attachment. Install it through the gun refit screen on compatible firearms.
