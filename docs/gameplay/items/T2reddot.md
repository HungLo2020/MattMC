...
T2 red dot can be obtained from the Creative Menu. It is registered as `minecraft:sight_t2`.

## Usage

T2 red dot is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
