...
TD Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_td`.

## Usage

TD Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
