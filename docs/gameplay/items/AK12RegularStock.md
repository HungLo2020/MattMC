...
AK-12 Regular Stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_ak12`.

## Usage

AK-12 Regular Stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
