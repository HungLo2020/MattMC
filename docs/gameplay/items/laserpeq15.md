...
laser_peq15 can be obtained from the Creative Menu. It is registered as `minecraft:laser_peq15`.

## Usage

laser_peq15 is a TaCZ laser attachment. Install it through the gun refit screen on compatible firearms.
