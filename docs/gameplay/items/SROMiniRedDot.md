...
SRO Mini Red Dot can be obtained from the Creative Menu. It is registered as `minecraft:sight_sro_dot`.

## Usage

SRO Mini Red Dot is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
