...
Magpul CTR stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_tactical_ar`.

## Usage

Magpul CTR stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
