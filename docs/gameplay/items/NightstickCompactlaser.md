...
Nightstick Compact laser can be obtained from the Creative Menu. It is registered as `minecraft:laser_nightstick`.

## Usage

Nightstick Compact laser is a TaCZ laser attachment. Install it through the gun refit screen on compatible firearms.
