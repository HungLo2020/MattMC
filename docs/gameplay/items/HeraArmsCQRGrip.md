...
Hera Arms CQR Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_cqr`.

## Usage

Hera Arms CQR Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
