...
CMMG RipStock Stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_ripstock`.

## Usage

CMMG RipStock Stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
