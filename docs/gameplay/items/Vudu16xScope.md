...
Vudu 1-6x Scope can be obtained from the Creative Menu. It is registered as `minecraft:scope_vudu`.

## Usage

Vudu 1-6x Scope is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
