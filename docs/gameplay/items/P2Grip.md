...
P-2 Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_osovets_black`.

## Usage

P-2 Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
