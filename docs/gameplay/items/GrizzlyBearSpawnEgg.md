...
The Grizzly Bear Spawn Egg is available from the Creative Menu.

## Usage

Use the Grizzly Bear Spawn Egg on a block to spawn a Grizzly Bear.
...
* This item is registered as `minecraft:grizzly_bear_spawn_egg`.
