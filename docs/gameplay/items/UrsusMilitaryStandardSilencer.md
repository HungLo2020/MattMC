...
Ursus Military Standard Silencer can be obtained from the Creative Menu. It is registered as `minecraft:muzzle_silencer_ursus`.

## Usage

Ursus Military Standard Silencer is a TaCZ muzzle attachment. Install it through the gun refit screen on compatible firearms.
