# Aimpoint ACRO P-1 Sight

## Obtaining

Aimpoint ACRO P-1 Sight can be obtained from the Creative Menu. It is registered as `minecraft:sight_acro_pistol`.

## Usage

Aimpoint ACRO P-1 Sight is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
