...
The Underminer Spawn Egg is available from the Creative Menu.

## Usage

Use the Underminer Spawn Egg on a block to spawn an Underminer.
...
* This item is registered as `minecraft:underminer_spawn_egg`.
