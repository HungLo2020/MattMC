...
12 Gauge Silencer can be obtained from the Creative Menu. It is registered as `minecraft:muzzle_silencer_sg`.

## Usage

12 Gauge Silencer is a TaCZ muzzle attachment. Install it through the gun refit screen on compatible firearms.
