# QMK-152 3x White Light Sight

## Obtaining

QMK-152 3x White Light Sight can be obtained from the Creative Menu. It is registered as `minecraft:scope_qmk152`.

## Usage

QMK-152 3x White Light Sight is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
