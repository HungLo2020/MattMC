...
The Shoebill Spawn Egg is available from the Creative Menu.

## Usage

Use the Shoebill Spawn Egg on a block to spawn a Shoebill.
...
* This item is registered as `minecraft:shoebill_spawn_egg`.
