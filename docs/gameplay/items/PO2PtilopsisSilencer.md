...
PO-2 "Ptilopsis" Silencer can be obtained from the Creative Menu. It is registered as `minecraft:muzzle_silencer_ptilopsis`.

## Usage

PO-2 "Ptilopsis" Silencer is a TaCZ muzzle attachment. Install it through the gun refit screen on compatible firearms.
