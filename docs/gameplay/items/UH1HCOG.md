...
UH-1 HCOG can be obtained from the Creative Menu. It is registered as `minecraft:sight_uh1`.

## Usage

UH-1 HCOG is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
