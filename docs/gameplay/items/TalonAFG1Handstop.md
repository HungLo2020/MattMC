...
Talon AFG1 Handstop can be obtained from the Creative Menu. It is registered as `minecraft:grip_magpul_afg_2`.

## Usage

Talon AFG1 Handstop is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
