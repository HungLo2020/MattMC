...
Soldiers' love, wife, and mistress.

## Obtaining

M4A1 Carbine can be obtained from the Creative Menu. It is registered as `minecraft:m4a1`.

## Usage

M4A1 Carbine is a TaCZ firearm. It uses [5.56x45mm Bullet](556x45mmBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
