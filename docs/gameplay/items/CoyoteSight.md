...
Coyote Sight can be obtained from the Creative Menu. It is registered as `minecraft:sight_coyote`.

## Usage

Coyote Sight is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
