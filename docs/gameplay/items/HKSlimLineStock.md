...
HK Slim Line Stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_hk_slim_line`.

## Usage

HK Slim Line Stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
