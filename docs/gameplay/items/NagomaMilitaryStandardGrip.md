# Nagoma Military Standard Grip

## Obtaining

Nagoma Military Standard Grip can be obtained from the Creative Menu. It is registered as `minecraft:grip_vertical_military`.

## Usage

Nagoma Military Standard Grip is a TaCZ grip attachment. Install it through the gun refit screen on compatible firearms.
