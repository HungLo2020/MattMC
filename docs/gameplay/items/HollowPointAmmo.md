...
Hollow-Point Ammo can be obtained from the Creative Menu. It is registered as `minecraft:ammo_mod_hp`.

## Usage

Hollow-Point Ammo is a TaCZ ammo modifier attachment. Install it through the gun refit screen on compatible firearms.
