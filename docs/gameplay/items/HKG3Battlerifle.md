...
The other arm of the free world.

## Obtaining

HK G3 Battle rifle can be obtained from the Creative Menu. It is registered as `minecraft:hk_g3`.

## Usage

HK G3 Battle rifle is a TaCZ firearm. It uses [.308 Winchester Bullet](308WinchesterBullet.md) and fires with the TaCZ gun controls. Reload it with the reload key and aim down sights with the aim key.
...
| Magazine size | 20 |
| Extended magazine sizes | 30, 35, 40 |
