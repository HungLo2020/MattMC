# DeltaPoint Sight Rised

## Obtaining

DeltaPoint Sight Rised can be obtained from the Creative Menu. It is registered as `minecraft:sight_deltapoint_rifle`.

## Usage

DeltaPoint Sight Rised is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
