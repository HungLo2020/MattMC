...
PK06 Sight can be obtained from the Creative Menu. It is registered as `minecraft:sight_pk06_pistol`.

## Usage

PK06 Sight is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
