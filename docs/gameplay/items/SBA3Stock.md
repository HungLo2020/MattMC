...
SBA3 Stock can be obtained from the Creative Menu. It is registered as `minecraft:stock_sba3`.

## Usage

SBA3 Stock is a TaCZ stock attachment. Install it through the gun refit screen on compatible firearms.
