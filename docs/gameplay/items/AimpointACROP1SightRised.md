# Aimpoint ACRO P-1 Sight Rised

## Obtaining

Aimpoint ACRO P-1 Sight Rised can be obtained from the Creative Menu. It is registered as `minecraft:sight_acro_rifle`.

## Usage

Aimpoint ACRO P-1 Sight Rised is a TaCZ scope attachment. Install it through the gun refit screen on compatible firearms.
