...
public enum EnumOptionsMinimap {
    ...
    RADAR_MODE("voxelmap.options.minimap.radar.radarMode", false, false, true),
    SHOW_RADAR("voxelmap.options.minimap.radar.showRadar", false, true, false),
    SHOW_MOBS("voxelmap.options.minimap.radar.showMobs", false, false, true),
    SHOW_PLAYERS("voxelmap.options.minimap.radar.showPlayers", false, true, false),
    SHOW_PLAYER_HELMETS("voxelmap.options.minimap.radar.showPlayerHelmets", false, true, false),
    SHOW_MOB_HELMETS("voxelmap.options.minimap.radar.showMobHelmets", false, true, false),
    SHOW_PLAYER_NAMES("voxelmap.options.minimap.radar.showPlayerNames", false, true, false),
    SHOW_MOB_NAMES("voxelmap.options.minimap.radar.showMobNames", false, true, false),
    RADAR_OUTLINES("voxelmap.options.minimap.radar.iconOutlines", false, true, false),
    RADAR_FILTERING("voxelmap.options.minimap.radar.iconFiltering", false, true, false),
    SHOW_FACING("voxelmap.options.minimap.radar.showFacing", false, true, false),
