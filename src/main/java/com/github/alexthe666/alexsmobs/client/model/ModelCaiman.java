...
import com.github.alexthe666.alexsmobs.client.render.CaimanRenderState;
...
public class ModelCaiman extends AdvancedEntityModel<CaimanRenderState> {
    ...
    public void setupAnim(CaimanRenderState state) {
        ...
        float swimProgress = state.swimProgress * 0.2F;
        float grabProgress = state.holdProgress;
        float vibrateProgress = state.vibrateProgress * 0.2F;
