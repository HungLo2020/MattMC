...
import com.github.alexthe666.alexsmobs.client.render.SugarGliderRenderState;
...
public class ModelSugarGlider extends AdvancedEntityModel<SugarGliderRenderState> {
    ...
    @Override
    public void setupAnim(SugarGliderRenderState state) {
        ...
        float glideProgress = state.glideProgress;
        float sitProgress = state.sitProgress;
        float forageProgress = state.forageProgress;
