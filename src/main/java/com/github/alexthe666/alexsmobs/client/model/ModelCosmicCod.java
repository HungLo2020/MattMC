...
import com.github.alexthe666.alexsmobs.client.render.state.CosmicCodRenderState;
...
public class ModelCosmicCod extends AdvancedEntityModel<CosmicCodRenderState> {
    ...
    @Override
    public void setupAnim(CosmicCodRenderState renderState){
        ...
        float pitch = Maths.rad(Mth.rotLerp(1.0F, renderState.prevFishPitch, renderState.fishPitch));
