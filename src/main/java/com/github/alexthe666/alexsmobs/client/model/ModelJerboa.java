...
import com.github.alexthe666.alexsmobs.client.render.state.JerboaRenderState;
...
public class ModelJerboa extends AdvancedEntityModel<JerboaRenderState> {
    ...
    @Override
    public void setupAnim(JerboaRenderState renderState){
