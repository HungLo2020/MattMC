...
import com.github.alexthe666.alexsmobs.client.render.SunbirdRenderState;
...
public class ModelSunbird extends AdvancedEntityModel<SunbirdRenderState> {
    ...
    @Override
    public void setupAnim(SunbirdRenderState state) {
        ...
        this.faceTarget(state.yRot, state.xRot, 1, neck, head);
