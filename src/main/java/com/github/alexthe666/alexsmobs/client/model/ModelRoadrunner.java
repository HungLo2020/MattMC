...
import com.github.alexthe666.alexsmobs.client.render.RoadrunnerRenderState;
...
public class ModelRoadrunner extends AdvancedEntityModel<RoadrunnerRenderState> {
    ...
    public ModelRoadrunner() {
        ...
        left_wing.setPos(2.0F, -1.0F, -3.0F);
        ...
        right_wing.setPos(-2.0F, -1.0F, -3.0F);
        ...
        right_spin.setPos(-1.5F, 4.5F, 1.5F);
        ...
        left_spin.setPos(1.5F, 4.5F, 1.5F);
        ...
        left_leg.setPos(1.5F, 2.0F, 3.0F);
        ...
        left_knee.setPos(0.0F, 2.0F, 0.0F);
        ...
        left_foot.setPos(0.0F, 4.0F, 0.0F);
        ...
        right_leg.setPos(-1.5F, 2.0F, 3.0F);
        ...
        right_knee.setPos(0.0F, 2.0F, 0.0F);
        ...
        right_foot.setPos(0.0F, 4.0F, 0.0F);
    ...
    @Override
    public void setupAnim(RoadrunnerRenderState renderState) {
        ...
        float netneckYaw = renderState.yRot;
        float neckPitch = renderState.xRot;
        
        float runProgress = 5F * limbSwingAmount;
        boolean spinnyLegs = limbSwingAmount > 0.5F && renderState.isMeep;
        ...
        float f = renderState.wingRotation;
        float f1 = renderState.destPos;
