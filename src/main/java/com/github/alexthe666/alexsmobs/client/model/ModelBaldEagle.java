...
import com.github.alexthe666.alexsmobs.client.render.BaldEagleRenderState;
...
public class ModelBaldEagle extends AdvancedEntityModel<BaldEagleRenderState> {
    ...
    public void setupAnim(BaldEagleRenderState state){
        ...
        boolean isVehicle = state.isPassenger;
