...
import com.github.alexthe666.alexsmobs.client.render.state.GazelleRenderState;
...
public class ModelGazelle extends AdvancedEntityModel<GazelleRenderState> {
    ...
    public void animate(int animationId, int animationTick, float f, float f1, float f2, float f3, float f4) {
        // Create a temporary animated entity wrapper for animation
        IAnimatedEntity tempEntity = new IAnimatedEntity() {
            ...
            public com.github.alexthe666.citadel.animation.Animation getAnimation() {
                if (animationId == EntityGazelle.ANIMATION_FLICK_TAIL.getID()) {
                    return EntityGazelle.ANIMATION_FLICK_TAIL;
                } else if (animationId == EntityGazelle.ANIMATION_FLICK_EARS.getID()) {
                    return EntityGazelle.ANIMATION_FLICK_EARS;
                } else if (animationId == EntityGazelle.ANIMATION_EAT_GRASS.getID()) {
                    return EntityGazelle.ANIMATION_EAT_GRASS;
                }
                return IAnimatedEntity.NO_ANIMATION;
            }
            ...
            public com.github.alexthe666.citadel.animation.Animation[] getAnimations() {
                return new com.github.alexthe666.citadel.animation.Animation[]{
                    EntityGazelle.ANIMATION_FLICK_EARS, 
                    EntityGazelle.ANIMATION_FLICK_TAIL, 
                    EntityGazelle.ANIMATION_EAT_GRASS
                };
            }
        };
    ...
    public void setupAnim(GazelleRenderState renderState) {
        ...
        boolean running = renderState.isRunning;
        int animationId = renderState.currentAnimationId;
        int animationTick = renderState.animationTick;
        
        // Run animations
        animate(animationId, animationTick, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
