...
import com.github.alexthe666.alexsmobs.client.render.AlligatorSnappingTurtleRenderState;
...
public class ModelAlligatorSnappingTurtle extends AdvancedEntityModel<AlligatorSnappingTurtleRenderState> {
    ...
    @Override
    public void setupAnim(AlligatorSnappingTurtleRenderState renderState) {
        this.resetToDefaultPose();
        float idleSpeed = 0.05F;
        float idleDegree = 0.25F;
        float walkSpeed = renderState.isInWater ? 0.5F : 1F;
        float walkDegree = 0.75F;
        float openProgress = renderState.openMouthProgress;
        float snapProgress = renderState.attackProgress;
        ...
        this.swing(tail, idleSpeed, idleDegree * 1.15F, false, 3, 0F, renderState.ageInTicks, 1);
        this.swing(leg_right, walkSpeed, walkDegree, true, 1, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.swing(leg_left, walkSpeed, walkDegree, false, 1, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.swing(arm_right, walkSpeed, walkDegree, false, 0, 0.1F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.swing(arm_left, walkSpeed, walkDegree, true, 0, 0.1F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.swing(tail, walkSpeed * 1.35F, walkDegree * 1.15F, false, 3, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.swing(neck, walkSpeed * 0.75F, walkDegree * 0.15F, false, -2, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.swing(head, walkSpeed * 0.75F, walkDegree * 0.15F, false, -2, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
    }
