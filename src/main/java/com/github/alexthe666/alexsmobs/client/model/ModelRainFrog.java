...
import com.github.alexthe666.alexsmobs.client.render.RainFrogRenderState;
...
public class ModelRainFrog extends AdvancedEntityModel<RainFrogRenderState> {
    ...
    @Override
    public void setupAnim(RainFrogRenderState state){
        this.resetToDefaultPose();
        float limbSwing = state.walkAnimationPos;
        float limbSwingAmount = state.walkAnimationSpeed;
        float ageInTicks = state.ageInTicks;
        float walkSpeed = state.isBaby ? 1F : 2.3F;
        float walkDegree = 1;
        float digSpeed = 0.8f;
        float digDegree = 0.5f;
        float danceSpeed = 0.8f;
        float danceDegree = 0.5f;
        float burrowProgress = state.burrowProgress;
        float danceProgress = state.danceProgress;
        float attackProgress = state.attackProgress;
        float stanceProgress = state.stanceProgress;
