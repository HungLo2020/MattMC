...
public class ModelCockroach extends AdvancedEntityModel<CockroachRenderState> {
    ...
    @Override
    public void setupAnim(CockroachRenderState renderState) {
        ...
        if (renderState.randomWingFlapTick > 0) {
