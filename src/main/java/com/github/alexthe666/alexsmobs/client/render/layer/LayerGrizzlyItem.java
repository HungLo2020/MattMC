...
import com.github.alexthe666.alexsmobs.client.render.GrizzlyBearRenderState;
...
public class LayerGrizzlyItem extends RenderLayer<GrizzlyBearRenderState, ModelGrizzlyBear> {
    ...
    @Override
    public void submit(PoseStack matrixStackIn, SubmitNodeCollector submitNodeCollector, int packedLight, GrizzlyBearRenderState state, float f, float g) {
