...
import com.github.alexthe666.alexsmobs.client.render.TasmanianDevilRenderState;
	...
	public void animate(TasmanianDevilRenderState renderState) {
		...
		IAnimatedEntity tempEntity = new IAnimatedEntity() {
			...
			public com.github.alexthe666.citadel.animation.Animation[] getAnimations() {
				return new com.github.alexthe666.citadel.animation.Animation[]{EntityTasmanianDevil.ANIMATION_ATTACK, EntityTasmanianDevil.ANIMATION_HOWL};
			}
		};
