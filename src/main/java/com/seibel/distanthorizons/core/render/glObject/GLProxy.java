...
public class GLProxy
{
	...
	private GLProxy() throws IllegalStateException
	{
		...
		LOGGER.info("Lod Render OpenGL version [" + VulkanicAPI.getString(VulkanicAPI.getImmediateContext(), VulkanicAPI.GL_VERSION) + "].");
		...
		String vendor = VulkanicAPI.getString(VulkanicAPI.getImmediateContext(), VulkanicAPI.GL_VENDOR).toUpperCase(); // example return: "NVIDIA CORPORATION"
