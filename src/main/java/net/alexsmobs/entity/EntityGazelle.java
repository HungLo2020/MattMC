...
import net.alexsmobs.entity.ai.AnimalAIHerdPanic;
...
public class EntityGazelle extends Animal implements IAnimatedEntity, IHerdPanic {
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return SoundEvents.GAZELLE_HURT;
    }
    ...
    public void addAdditionalSaveData(ValueOutput valueOutput) {
        ...
        valueOutput.putBoolean("GazelleRunning", this.isRunning());
    }

    public void readAdditionalSaveData(ValueInput valueInput) {
        super.readAdditionalSaveData(valueInput);
        this.setRunning(valueInput.getBooleanOr("GazelleRunning", false));
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 8.0D).add(Attributes.ATTACK_DAMAGE, 2.0D).add(Attributes.MOVEMENT_SPEED, 0.25F);
    }

    @Nullable
    @Override
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        return EntityType.GAZELLE.create(p_241840_1_, EntitySpawnReason.BREEDING);
    }
