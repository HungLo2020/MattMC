...
import net.alexsmobs.entity.ai.CosmicCodAIFollowLeader;
...
public class EntityCosmicCod extends Mob implements Bucketable {
    ...
    public EntityCosmicCod(EntityType<? extends Mob> type, Level world) {
        super(type, world);
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return SoundEvents.COSMIC_COD_HURT;
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(Items.COSMIC_COD_BUCKET);
    ...
    public void tick() {
        super.tick();
        if (!this.level().isClientSide() && this.hurtTime > 0 && this.hurtTime == this.hurtDuration - 1) {
            teleportIn = 5;
        }
