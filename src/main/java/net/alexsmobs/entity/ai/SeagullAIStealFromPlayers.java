...
import net.alexsmobs.entity.EntitySeagull;
...
public class SeagullAIStealFromPlayers extends Goal {
            ...
            if(hasFoods(target)){
                ...
                if(!foodStack.isEmpty()){
                    ...
                    if(target instanceof ServerPlayer serverPlayer){
                        AMAdvancementTriggerRegistry.triggerSeagullSteal(serverPlayer);
                    }
                }else{
                    stop();
                }
    ...
    private boolean isBlacklisted(ItemStack stack){
        // Blacklist check simplified - all food items are stealable
        return false;
    }
