...
public class EntityCockroach extends Animal implements Shearable, ITargetsDroppedItems {
    ...
    public boolean checkSpawnRules(LevelAccessor worldIn, EntitySpawnReason spawnReasonIn) {
        return true; // AMConfig.cockroachSpawnRolls removed
    }
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return SoundEvents.COCKROACH_HURT;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
        final EntityCockroach roach = EntityType.COCKROACH.create(serverWorld, EntitySpawnReason.BREEDING);
        if (roach != null) {
    ...
    public boolean canTargetItem(ItemStack stack) {
        return stack.has(net.minecraft.core.component.DataComponents.FOOD) || stack.is(COCKROACH_BREEDABLES);
    }
