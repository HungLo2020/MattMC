...
public class EntityRhinoceros extends Animal implements IAnimatedEntity {
    ...
    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput valueOutput) {
        ...
        valueOutput.putInt("PotionDuration", this.getPotionDuration());
        valueOutput.putInt("InflictedCount", this.getInflictedCount());
    }
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput valueInput) {
        ...
        this.setPotionLevel(valueInput.getIntOr("PotionLevel", 0));
        this.setPotionDuration(valueInput.getIntOr("PotionDuration", 0));
        this.setInflictedCount(valueInput.getIntOr("InflictedCount", 0));
    }
