...
import net.alexsmobs.entity.ai.EntityAINearestTarget3D;
import net.alexsmobs.entity.ai.FlightMoveController;
import net.alexsmobs.entity.ai.GroundPathNavigatorWide;
...
public class EntityEnderiophage extends Animal implements Enemy, FlyingAnimal {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 20.0D).add(Attributes.FOLLOW_RANGE, 16.0D).add(Attributes.MOVEMENT_SPEED, 0.15F).add(Attributes.ATTACK_DAMAGE, 2F).add(Attributes.STEP_HEIGHT, 1.0D);
    }
    ...
    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput valueOutput) {
        ...
        valueOutput.putBoolean("MissingEye", this.isMissingEye());
        valueOutput.putInt("Variant", this.getVariant());
        valueOutput.putInt("SlowDownTicks", slowDownTicks);
    }
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput valueInput) {
        ...
        this.setMissingEye(valueInput.getBooleanOr("MissingEye", false));
        this.setVariant(valueInput.getIntOr("Variant", 0));
        this.slowDownTicks = valueInput.getIntOr("SlowDownTicks", 0);
    }
