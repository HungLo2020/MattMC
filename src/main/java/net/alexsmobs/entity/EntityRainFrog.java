...
public class EntityRainFrog extends Animal implements ITargetsDroppedItems,IDancingMob {
    ...
    public EntityRainFrog(EntityType type, Level lvl) {
        super(type, lvl);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new TemptGoal(this, 1.0D, stack -> stack.is(AMTagRegistry.RAIN_FROG_BREEDABLES), false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        EntityRainFrog frog = EntityType.RAIN_FROG.create(p_241840_1_, EntitySpawnReason.BREEDING);
        if (frog != null) {
    ...
    public void tick() {
        ...
        if (this.getDanceTime() > 0) {
            ...
            if(this.getDanceTime() == 1 && weatherCooldown <= 0 && this.level() instanceof ServerLevel serverLevel && serverLevel.getGameRules().getBoolean(GameRules.RULE_WEATHER_CYCLE)){
                changeWeather();
            }
        }
    ...
    protected void readAdditionalSaveData(ValueInput valueInput) {
        ...
        this.setDisturbed(valueInput.getBooleanOr("Disturbed", false));
        this.setVariant(valueInput.getIntOr("Variant", 0));
        this.weatherCooldown = valueInput.getIntOr("WeatherCooldown", 0);
    }

    protected void addAdditionalSaveData(ValueOutput valueOutput) {
        super.addAdditionalSaveData(valueOutput);
        valueOutput.putBoolean("Disturbed", isDisturbed());
        valueOutput.putInt("Variant", getVariant());
        valueOutput.putInt("WeatherCooldown", this.weatherCooldown);
    }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (item instanceof ShovelItem && (this.isBurrowed() || !this.isDisturbed()) && this.level() instanceof ServerLevel) {
    ...
    public void setRecordPlayingNearby(BlockPos pos, boolean isPartying) {
        // Client-side only - inline the dancing logic
