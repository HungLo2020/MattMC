...
public class EntityShoebill extends Animal implements IAnimatedEntity, ITargetsDroppedItems {
    ...
    public static AttributeSupplier.Builder bakeAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 10D).add(Attributes.ATTACK_DAMAGE, 4.0D).add(Attributes.MOVEMENT_SPEED, 0.2F).add(Attributes.STEP_HEIGHT, 1.0D).add(Attributes.TEMPT_RANGE, 10.0D);
    }
