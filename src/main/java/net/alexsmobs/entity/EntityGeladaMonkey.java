...
import net.alexsmobs.entity.ai.GeladaAIGroom;
...
public class EntityGeladaMonkey extends Animal implements IAnimatedEntity, IHerdPanic {
    ...
    public static AttributeSupplier.Builder bakeAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 18.0D).add(Attributes.ATTACK_DAMAGE, 4.0D).add(Attributes.MOVEMENT_SPEED, 0.25F).add(Attributes.TEMPT_RANGE, 10.0D);
    }
