...
import net.alexsmobs.entity.ai.AnimalAISwimBottom;
...
public class EntityFrilledShark extends WaterAnimal implements IAnimatedEntity, Bucketable {
    ...
    public EntityFrilledShark(EntityType<? extends WaterAnimal> type, Level worldIn) {
        super(type, worldIn);
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(Items.FRILLED_SHARK_BUCKET);
