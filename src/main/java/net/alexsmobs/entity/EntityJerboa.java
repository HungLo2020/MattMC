...
import net.alexsmobs.entity.ai.JerboaAIBeg;
...
public class EntityJerboa extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(7, new AnimalAIWanderRanged(this, 20, 1.0D, 10, 7));
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        EntityJerboa boa = EntityType.JERBOA.create(p_146743_, EntitySpawnReason.BREEDING);
        if (boa != null) {
