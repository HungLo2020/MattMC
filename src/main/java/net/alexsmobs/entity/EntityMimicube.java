...
import net.alexsmobs.entity.ai.MimiCubeAIRangedAttack;
...
public class EntityMimicube extends Monster implements RangedAttackMob {
    ...
    public EntityMimicube(EntityType<? extends EntityMimicube> type, Level world) {
        super(type, world);
    ...
    public void tick() {
        ...
        if (this.onGround() && !this.wasOnGround) {
            ...
            for (int j = 0; j < 8; ++j) {
                ...
                this.level().addParticle(new ItemParticleOption(ParticleTypes.ITEM, new ItemStack(Items.SLIME_BALL)), this.getX() + (double)f2, this.getY(), this.getZ() + (double)f3, 0.0D, 0.0D, 0.0D);
            }
    ...
    private SoundEvent getSquishSound() {
        return SoundEvents.MIMICUBE_JUMP;
    }
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return SoundEvents.MIMICUBE_HURT;
    }
