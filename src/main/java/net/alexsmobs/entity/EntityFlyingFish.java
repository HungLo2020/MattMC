...
public class EntityFlyingFish extends WaterAnimal implements FlyingAnimal, Bucketable {
    ...
    public EntityFlyingFish(EntityType<? extends WaterAnimal> type, Level level) {
        super(type, level);
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(Items.FLYING_FISH_BUCKET);
    ...
    private class GlideGoal extends Goal {
        ...
        private BlockPos findSurfacePos(){
            ...
            for(int i = 0; i < 15; i++){
                ...
                while(level.isWaterAt(offset) && offset.getY() < level.getMaxY()){
                    offset = offset.above();
                }
