...
import net.alexsmobs.entity.AMEntityRegistry;
import net.alexsmobs.entity.EntityCrocodile;
import net.alexsmobs.entity.EntityCaiman;
...
public class BlockCaimanEgg extends Block {
    ...
    public static boolean isProperHabitat(net.minecraft.world.level.BlockGetter reader, net.minecraft.core.BlockPos pos) {
        return reader.getBlockState(pos).is(net.minecraft.tags.BlockTags.SAND) || reader.getBlockState(pos).is(AMTagRegistry.CROCODILE_SPAWNS);
    }
    ...
    private boolean canTrample(net.minecraft.world.level.Level worldIn, net.minecraft.world.entity.Entity trampler) {
        if (!(trampler instanceof EntityCrocodile || trampler instanceof EntityCaiman) && !(trampler instanceof net.minecraft.world.entity.ambient.Bat)) {
            if (!(trampler instanceof net.minecraft.world.entity.LivingEntity)) {
                return false;
            } else {
