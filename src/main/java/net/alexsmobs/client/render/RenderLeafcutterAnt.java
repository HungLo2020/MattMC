...
import net.alexsmobs.client.model.ModelLeafcutterAntQueen;
import net.alexsmobs.client.render.layer.LayerLeafcutterAntLeaf;
import net.alexsmobs.entity.EntityLeafcutterAnt;
