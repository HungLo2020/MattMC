...
import net.alexsmobs.client.model.ModelCatfishLarge;
import net.alexsmobs.client.model.ModelCatfishMedium;
import net.alexsmobs.client.model.ModelCatfishSmall;
import net.alexsmobs.client.render.state.CatfishRenderState;
import net.alexsmobs.entity.EntityCatfish;
