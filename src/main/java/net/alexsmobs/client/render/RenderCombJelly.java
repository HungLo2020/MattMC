...
import net.alexsmobs.client.model.ModelCombJelly;
import net.alexsmobs.client.render.state.CombJellyRenderState;
import net.alexsmobs.entity.EntityCombJelly;
