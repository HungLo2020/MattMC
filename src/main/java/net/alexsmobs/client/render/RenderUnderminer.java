...
import net.alexsmobs.client.render.layer.LayerUnderminerItem;
import net.alexsmobs.client.render.layer.LayerUnderminerTransparency;
import net.alexsmobs.entity.EntityUnderminer;
