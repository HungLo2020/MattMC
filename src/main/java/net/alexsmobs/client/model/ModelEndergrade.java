package net.alexsmobs.client.model;// Made with Blockbench 3.7.4
...
public class ModelEndergrade extends AdvancedEntityModel<EndergadeRenderState> {
	...
	@Override
	public void setupAnim(EndergadeRenderState state) {
		...
		float birdPitch = state.tartigradePitch;
		...
		this.chainWave(bodyParts, walkSpeed, walkDegree * 0.3F, -1, state.walkAnimationPos, state.walkAnimationSpeed);
		this.chainWave(legPartsRight, walkSpeed, walkDegree, -1, state.walkAnimationPos, state.walkAnimationSpeed);
		this.chainWave(legPartsLeft, walkSpeed, walkDegree, -1, state.walkAnimationPos, state.walkAnimationSpeed);
		this.chainFlap(legPartsRight, walkSpeed, walkDegree, 3, state.walkAnimationPos, state.walkAnimationSpeed);
		this.chainFlap(legPartsLeft, walkSpeed, -walkDegree, 3, state.walkAnimationPos, state.walkAnimationSpeed);
		this.swing(tail, walkSpeed, walkDegree * 0.5F, false, 0f, 0f, state.walkAnimationPos, state.walkAnimationSpeed);
	}
