...
import net.alexsmobs.client.render.SnowLeopardRenderState;
    ...
    public void animate(SnowLeopardRenderState renderState) {
        ...
        IAnimatedEntity tempEntity = new IAnimatedEntity() {
            ...
            public Animation[] getAnimations() {
                return new Animation[]{EntitySnowLeopard.ANIMATION_ATTACK_L, EntitySnowLeopard.ANIMATION_ATTACK_R};
            }
        };
