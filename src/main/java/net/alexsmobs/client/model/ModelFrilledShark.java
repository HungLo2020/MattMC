...
import net.alexsmobs.client.render.state.FrilledSharkRenderState;
...
public class ModelFrilledShark extends AdvancedEntityModel<FrilledSharkRenderState> {
	...
	@Override
	public void setupAnim(FrilledSharkRenderState renderState) {
		...
		float landProgress = renderState.onLandProgress;
