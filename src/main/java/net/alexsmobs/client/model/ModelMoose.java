...
import net.alexsmobs.client.render.MooseRenderState;
import net.alexsmobs.entity.EntityMoose;
...
public class ModelMoose extends AdvancedEntityModel<MooseRenderState> {
    ...
    @Override
    public void setupAnim(MooseRenderState state) {
        this.resetToDefaultPose();
        ...
        float jostleProgress = state.jostleProgress;
        float jostleAngle = state.jostleAngle;
