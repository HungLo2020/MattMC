...
import net.alexsmobs.client.render.state.PotooRenderState;
...
public class ModelPotoo extends AdvancedEntityModel<PotooRenderState> {
    ...
    @Override
    public void setupAnim(PotooRenderState renderState){
        this.resetToDefaultPose();
        float flyProgress = renderState.flyProgress;
        float perchProgress = renderState.perchProgress;
        float mouthProgress = renderState.mouthProgress;
        float flapSpeed = 0.8F;
        float flapDegree = 0.2F;
        float walkSpeed = 1.6f;
        float walkDegree = 0.8f;
        float eyeScale = Mth.clamp((15F - renderState.eyeScale) / 15F, 0F, 1F);
        ...
        float walkSwingAmount = renderState.walkAnimationSpeed * walkAmount;
        ...
        progressRotationPrev(body, flyProgress * walkSwingAmount, Maths.rad(80), 0, 0, 5F);
