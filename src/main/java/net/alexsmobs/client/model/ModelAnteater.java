...
public class ModelAnteater extends AdvancedEntityModel<AnteaterRenderState> {
    ...
    public void animate(AnteaterRenderState renderState) {
        ...
        IAnimatedEntity tempEntity = new IAnimatedEntity() {
            ...
            public Animation[] getAnimations() {
                return new Animation[]{EntityAnteater.ANIMATION_SLASH_L, EntityAnteater.ANIMATION_SLASH_R, EntityAnteater.ANIMATION_TOUNGE_IDLE};
            }
        };
    ...
    @Override
    public void setupAnim(AnteaterRenderState renderState){
        ...
        float standProgress = renderState.prevStandProgress + (renderState.standProgress - renderState.prevStandProgress);
        float feedProgress = renderState.prevTongueProgress + (renderState.tongueProgress - renderState.prevTongueProgress);
        float leaningProgress = renderState.prevLeaningProgress + (renderState.leaningProgress - renderState.prevLeaningProgress);
        ...
        if(renderState.isBaby && renderState.isPassenger){
        ...
        this.walk(right_leg, walkSpeed, walkDegree, false, 0F, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.walk(left_leg, walkSpeed, walkDegree, true, 0F, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.walk(left_arm, walkSpeed, walkDegree, false, 0F, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.walk(right_arm, walkSpeed, walkDegree, true, 0F, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.swing(tail, walkSpeed, walkDegree * 0.2F, true, 1F, 0F, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.bob(body, walkSpeed, walkDegree * 2F, true, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
        this.bob(head, walkSpeed, walkDegree, true, renderState.walkAnimationPos, renderState.walkAnimationSpeed);
