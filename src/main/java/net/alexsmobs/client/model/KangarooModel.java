		...
		if (renderState.animation != null && renderState.animationTick >= 0) {
			...
			IAnimatedEntity animatedEntity = new IAnimatedEntity() {
				...
				public Animation[] getAnimations() {
					return new Animation[]{EntityKangaroo.ANIMATION_EAT_GRASS, EntityKangaroo.ANIMATION_KICK, EntityKangaroo.ANIMATION_PUNCH_L, EntityKangaroo.ANIMATION_PUNCH_R};
				}
			};
