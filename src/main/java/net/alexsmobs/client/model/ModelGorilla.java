...
import net.alexsmobs.entity.EntityGorilla;
...
public class ModelGorilla extends AdvancedEntityModel<GorillaRenderState> {
	...
	public void setupAnim(GorillaRenderState state) {
		...
		float rideProgress = state.isBaby ? 5F : 0;
		...
		// Note: Eating animation removed as we don't track eating state in render state for now
	}
