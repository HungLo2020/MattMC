...
public class ModelRaccoon extends AdvancedEntityModel<RaccoonRenderState> {
    ...
    public void animate(RaccoonRenderState state) {
        ...
        IAnimatedEntity animatedWrapper = new IAnimatedEntity() {
            ...
            public Animation[] getAnimations() {
                return new Animation[]{EntityRaccoon.ANIMATION_ATTACK};
            }
        };
    ...
    public void setupAnim(RaccoonRenderState state) {
        ...
        if (washProgress > 0) {
            ...
            this.faceTarget(state.yRot, state.xRot, 1.3F, head);
        }
        if (standProgress <= 0) {
