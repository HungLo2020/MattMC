package net.alexsmobs.client.model;// Made with Blockbench 3.7.2

import net.alexsmobs.client.render.GrizzlyBearRenderState;
import net.alexsmobs.entity.EntityGrizzlyBear;
...
public class ModelGrizzlyBear extends AdvancedEntityModel<GrizzlyBearRenderState> {
