...
public enum SortBehavior {
    ...
    SortBehavior(String shortName, SortMode sortMode, PriorityMode priorityMode,
            DeferMode deferMode) {
    ...
    SortBehavior(String shortName, SortMode sortMode) {
        this(shortName, sortMode, null, null);
    }

    SortBehavior(String shortName, PriorityMode priorityMode, DeferMode deferMode) {
