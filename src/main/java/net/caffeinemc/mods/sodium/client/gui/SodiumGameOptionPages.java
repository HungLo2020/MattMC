    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        .setName(Component.translatable("sodium.options.deferred_render_distance"))
                        .setTooltip(Component.translatable("sodium.options.deferred_render_distance.tooltip"))
                        .setControl(option -> new SliderControl(option, 0, 32, 1, (v) -> v == 0 ? Component.translatable("options.off") : Component.translatable("options.chunks", v)))
                        .setBinding((options, value) -> options.deferredChunks.deferredRenderDistance = value, options -> options.deferredChunks.deferredRenderDistance)
