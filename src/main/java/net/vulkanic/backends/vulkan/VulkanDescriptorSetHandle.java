...
/**
 * Vulkan backend implementation of descriptor-set allocation semantics.
 */
public final class VulkanDescriptorSetHandle implements DescriptorSetHandle {

    private final VulkanDescriptorPoolHandle pool;
    ...
    VulkanDescriptorSetHandle(VulkanDescriptorPoolHandle pool,
                              String layoutKey,
