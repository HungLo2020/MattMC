...
/**
 * A registry of {@link TooltipComponent} item components. Adding your item component to this registry will render the
...
public interface ComponentTooltipAppenderRegistry {
	 ...
	 */
	static void addFirst(DataComponentType<? extends TooltipComponent> componentType) {
	 ...
	 * @param componentType the component type to add
	 */
	static void addLast(DataComponentType<? extends TooltipComponent> componentType) {
		Preconditions.checkNotNull(componentType, "componentType");
	 ...
	 * @param componentType the component type to add
	 */
	static void addBefore(DataComponentType<?> anchor, DataComponentType<? extends TooltipComponent> componentType) {
	 ...
	 * @param componentType the component type to add
	 */
	static void addAfter(DataComponentType<?> anchor, DataComponentType<? extends TooltipComponent> componentType) {
		Preconditions.checkNotNull(anchor, "anchor");
		Preconditions.checkNotNull(componentType, "componentType");
