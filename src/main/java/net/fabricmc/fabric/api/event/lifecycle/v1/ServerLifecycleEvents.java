...
public final class ServerLifecycleEvents {
	 ...
	 *
	 * <p>This occurs before the player manager and any worlds are loaded.
	 */
	...
	public interface SyncDataPackContents {
		 ...
		 * The server resource manager is up-to-date when this is called.
		 *
	...
	public interface StartDataPackReload {
		void startDataPackReload(MinecraftServer server, ReloadableServerResources resourceManager);
	}
	...
	public interface EndDataPackReload {
		 ...
		 */
		void endDataPackReload(MinecraftServer server, ReloadableServerResources resourceManager, boolean success);
	}
