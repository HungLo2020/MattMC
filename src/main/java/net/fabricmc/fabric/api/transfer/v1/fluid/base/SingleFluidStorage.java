...
public abstract class SingleFluidStorage extends SingleVariantStorage<FluidVariant> {
	...
	/**
	 * Simple implementation of reading from {@link CompoundTag}, to match what is written by {@link #writeData}.
	...
	/**
	 * Simple implementation of writing to {@link CompoundTag}. Other formats are allowed, this is just a convenient suggestion.
	 */
