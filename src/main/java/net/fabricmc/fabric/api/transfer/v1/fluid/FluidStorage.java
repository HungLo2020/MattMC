...
import net.minecraft.core.component.type.PotionContentsComponent;
...
public final class FluidStorage {
	...
	public static final BlockApiLookup<Storage<FluidVariant>, @Nullable Direction> SIDED =
			BlockApiLookup.get(ResourceLocation.of("fabric", "sided_fluid_storage"), Storage.asClass(), Direction.class);
	...
	public static final ItemApiLookup<Storage<FluidVariant>, ContainerItemContext> ITEM =
			ItemApiLookup.get(ResourceLocation.of("fabric", "fluid_storage"), Storage.asClass(), ContainerItemContext.class);
