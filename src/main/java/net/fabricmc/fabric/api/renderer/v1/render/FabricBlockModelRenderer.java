...
import net.minecraft.client.rendererer.block.model.BlockStateModel;
import net.minecraft.core.BlockPos;
import net.minecraft.world.level.BlockAndTintGetter;
import net.minecraft.world.level.block.state.BlockState;

/**
 * Fabric extension interface for ModelBlockRenderer.
 */
public interface FabricBlockModelRenderer {
    ...
    static void render(PoseStack.Pose matrices, BlockVertexConsumerProvider vertexConsumers, 
                       ...
                       int light, int overlay, BlockAndTintGetter blockView, 
                       BlockPos pos, BlockState state) {
        Renderer renderer = Renderer.get();
        if (renderer != null) {
            renderer.render(matrices, vertexConsumers, model, red, green, blue, light, overlay, blockView, pos, state);
        }
    }
}
