...
public final class ScreenEvents {
	 ...
	 * }</pre>
	 *
	 * <p>Note that by adding an element to a screen, the element is not automatically {@link net.minecraft.client.gui.Renderable drawn}.
	 * Unless the element is button, you need to call the specific {@link net.minecraft.client.gui.Renderable#render(GuiGraphics, int, int, float) render} methods in the corresponding screen events.
	 *
