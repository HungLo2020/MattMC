 ...
 *
 * <pre>{@code
 * KeyMapping left = KeyBindingHelper.registerKeyBinding(new KeyMapping("key.example.left", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_P, "key.categories.misc"));
 * KeyMapping right = KeyBindingHelper.registerKeyBinding(new KeyMapping("key.example.right", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_U, "key.categories.misc"));
 * }</pre>
 *
 * @see KeyMapping
 */
