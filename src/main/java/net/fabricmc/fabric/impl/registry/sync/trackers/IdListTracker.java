...
public class IdListTracker<V, OV> implements RegistryEntryAddedCallback<V>, RegistryIdRemapCallback<V> {
	...
	private final IdMap<OV> mappers;
	private Map<ResourceLocation, OV> removedMapperCache = new HashMap<>();

	private IdListTracker(String name, IdMap<OV> mappers) {
		this.name = name;
		this.mappers = mappers;
	}

	public static <V, OV> void register(Registry<V> registry, String name, IdMap<OV> mappers) {
