package net.voxelmap.entityrender.variants;

import net.voxelmap.entityrender.EntityVariantData;
import net.voxelmap.entityrender.EntityVariantDataFactory;
import net.voxelmap.util.EnderDragonRendererAccessor;
