package net.voxelmap.entityrender;

import net.voxelmap.VoxelConstants;
import net.voxelmap.entityrender.variants.DefaultEntityVariantData;
import net.voxelmap.entityrender.variants.DefaultEntityVariantDataFactory;
import net.voxelmap.entityrender.variants.HorseVariantDataFactory;
import net.voxelmap.textures.Sprite;
import net.voxelmap.textures.TextureAtlas;
import net.voxelmap.util.AllocatedTexture;
...
public class EntityMapImageManager {
    ...
    public Sprite requestImageForMob(Entity entity, int size, boolean addBorder) {
        if (net.vulkanic.VulkanicAPI.isVulkanBackendSelected()
            || net.vulkanic.bridge.RustGalVulkanWholeFrameMode.enabled()) {
            throw new IllegalStateException("Java VoxelMap entity-image rendering is unavailable on selected Vulkan");
        }
