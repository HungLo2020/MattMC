...
import net.voxelmap.gui.GuiMinimapOptions;
import net.voxelmap.gui.GuiSubworldsSelect;
import net.voxelmap.gui.GuiWaypoints;
import net.voxelmap.gui.IGuiWaypoints;
import net.voxelmap.gui.overridden.Popup;
import net.voxelmap.gui.overridden.PopupGuiButton;
import net.voxelmap.gui.overridden.PopupGuiScreen;
...
import net.voxelmap.util.BackgroundImageInfo;
import net.voxelmap.util.BiomeMapData;
import net.voxelmap.util.CommandUtils;
import net.voxelmap.util.DimensionContainer;
import net.voxelmap.util.EasingUtils;
