...
public record CircularMaskBlitRenderState(
    ...
    public void buildVertices(VertexConsumer vertexConsumer) {
        ...
        for (int row = -radiusPixels; row < radiusPixels; row++) {
            ...
            this.addVertex(vertexConsumer, left, top, cos, sin, inverseScale, true);
            this.addVertex(vertexConsumer, left, bottom, cos, sin, inverseScale, false);
            this.addVertex(vertexConsumer, right, bottom, cos, sin, inverseScale, false);
            this.addVertex(vertexConsumer, right, top, cos, sin, inverseScale, true);
        }
    }

    private void addVertex(VertexConsumer vertexConsumer, float x, float y, float cos, float sin, float inverseScale, boolean top) {
        float dx = (x - this.centerX()) * inverseScale;
        float dy = (y - this.centerY()) * inverseScale;
