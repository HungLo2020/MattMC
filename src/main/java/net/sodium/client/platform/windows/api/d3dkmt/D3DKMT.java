...
import net.sodium.client.compatibility.environment.probe.GraphicsAdapterInfo;
import net.sodium.client.compatibility.environment.probe.GraphicsAdapterVendor;
import net.sodium.client.platform.windows.WindowsFileVersion;
import net.sodium.client.platform.windows.api.Gdi32;
import net.sodium.client.platform.windows.api.version.Version;
...
import static net.sodium.client.platform.windows.api.Gdi32.*;
import static net.sodium.client.platform.windows.api.d3dkmt.D3DKMTQueryAdapterInfoType.WDDM12.*;
