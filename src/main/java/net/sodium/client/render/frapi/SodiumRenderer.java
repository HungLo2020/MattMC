...
package net.sodium.client.render.frapi;
...
import net.sodium.mixin.features.render.frapi.BlockRenderDispatcherAccessor;
import net.sodium.mixin.features.render.frapi.ModelBlockRendererAccessor;
