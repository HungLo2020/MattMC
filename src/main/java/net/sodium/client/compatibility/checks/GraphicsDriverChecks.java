package net.sodium.client.compatibility.checks;
...
import net.sodium.client.compatibility.workarounds.intel.IntelWorkarounds;
import net.sodium.client.compatibility.workarounds.nvidia.NvidiaDriverVersion;
...
import net.sodium.client.platform.PlatformHelper;
