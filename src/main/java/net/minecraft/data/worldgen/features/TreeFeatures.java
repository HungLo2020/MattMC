...
public class TreeFeatures {
	...
	private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenTrees(Block block, int i, int j) {
		return new FallenTreeConfiguration.FallenTreeConfigurationBuilder(BlockStateProvider.simple(block), UniformInt.of(i, j))
			.logDecorators(
				ImmutableList.of(
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> bootstrapContext) {
		...
		FeatureUtils.register(bootstrapContext, DARK_OAK, Feature.TREE, createDarkOak().ignoreVines().build());
		FeatureUtils.register(
			bootstrapContext,
			PALE_OAK,
			Feature.TREE,
		...
		FeatureUtils.register(
			bootstrapContext, OAK_LEAF_LITTER, Feature.TREE, createOak().decorators(ImmutableList.of(placeOnGroundDecorator, placeOnGroundDecorator2)).build()
		);
		FeatureUtils.register(
			bootstrapContext,
		...
		FeatureUtils.register(
			bootstrapContext, BIRCH_LEAF_LITTER, Feature.TREE, createBirch().decorators(ImmutableList.of(placeOnGroundDecorator, placeOnGroundDecorator2)).build()
		);
		FeatureUtils.register(
			bootstrapContext, FANCY_OAK_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of(placeOnGroundDecorator, placeOnGroundDecorator2)).build()
		);
		FeatureUtils.register(bootstrapContext, FALLEN_OAK_TREE, Feature.FALLEN_TREE, createFallenOak().build());
		FeatureUtils.register(bootstrapContext, FALLEN_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(8).build());
		FeatureUtils.register(bootstrapContext, FALLEN_SUPER_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(15).build());
		FeatureUtils.register(bootstrapContext, FALLEN_JUNGLE_TREE, Feature.FALLEN_TREE, createFallenJungle().build());
		FeatureUtils.register(bootstrapContext, FALLEN_SPRUCE_TREE, Feature.FALLEN_TREE, createFallenSpruce().build());
	}
}
