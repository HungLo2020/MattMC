...
public class LocateCommand {
	...
	private static int showLocateResult(
		...
		// Create a simple literal component with styling to avoid translatable component issues
		String coordsText = "[" + blockPos2.getX() + ", " + string3 + ", " + blockPos2.getZ() + "]";
		Component styledCoords = Component.literal(coordsText)
		...
		commandSourceStack.sendSuccess(() -> Component.translatable(string, string2, styledCoords, i), false);
