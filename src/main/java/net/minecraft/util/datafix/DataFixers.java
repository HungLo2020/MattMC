...
public class DataFixers {
	...
	private static void addFixers(DataFixerBuilder dataFixerBuilder) {
		...
		dataFixerBuilder.addFixer(new EntityEquipmentToArmorAndHandFix(schema));
		...
		dataFixerBuilder.addFixer(new SignTextStrictJsonFix(schema15));
		dataFixerBuilder.addFixer(new WrittenBookPagesStrictJsonFix(schema15));
		...
		dataFixerBuilder.addFixer(new RemoveBlockEntityTagFix(schema42, Set.of("minecraft:noteblock", "minecraft:flower_pot")));
		...
		dataFixerBuilder.addFixer(new EntityCustomNameToComponentFix(schema46));
		dataFixerBuilder.addFixer(new ItemCustomNameToComponentFix(schema46));
		dataFixerBuilder.addFixer(new BlockEntityCustomNameToComponentFix(schema46));
		...
		dataFixerBuilder.addFixer(new ScoreboardDisplayNameFix(schema68, "ObjectiveDisplayNameFix", References.OBJECTIVE));
		dataFixerBuilder.addFixer(new ScoreboardDisplayNameFix(schema68, "TeamDisplayNameFix", References.TEAM));
		dataFixerBuilder.addFixer(new ObjectiveRenderTypeFix(schema68));
		...
		dataFixerBuilder.addFixer(new ItemLoreFix(schema74));
		...
		dataFixerBuilder.addFixer(new MapIdFix(schema84));
		...
		dataFixerBuilder.addFixer(new NamedEntityConvertUncheckedFix(schema107, "SplashPotionItemFieldRenameFix", References.ENTITY, "minecraft:potion"));
		...
		dataFixerBuilder.addFixer(new JigsawRotationFix(schema110));
		...
		dataFixerBuilder.addFixer(new LegacyDimensionIdFix(schema120));
		Schema schema121 = dataFixerBuilder.addSchema(2538, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new LevelLegacyWorldGenSettingsFix(schema121));
		Schema schema122 = dataFixerBuilder.addSchema(2550, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new WorldGenSettingsFix(schema122));
		Schema schema123 = dataFixerBuilder.addSchema(2551, V2551::new);
		dataFixerBuilder.addFixer(new WriteAndReadFix(schema123, "add types to WorldGenData", References.WORLD_GEN_SETTINGS));
		...
		dataFixerBuilder.addFixer(new NamespacedTypeRenameFix(schema125, "Biomes fix", References.BIOME, createRenamer(BiomeFix.BIOMES)));
		Schema schema126 = dataFixerBuilder.addSchema(2558, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new MissingDimensionFix(schema126, false));
		dataFixerBuilder.addFixer(new OptionsRenameFieldFix(schema126, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
		Schema schema127 = dataFixerBuilder.addSchema(2568, V2568::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema127, "Added Piglin Brute", References.ENTITY));
		Schema schema128 = dataFixerBuilder.addSchema(2571, V2571::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema128, "Added Goat", References.ENTITY));
		Schema schema129 = dataFixerBuilder.addSchema(2679, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new CauldronRenameFix(schema129, false));
		Schema schema130 = dataFixerBuilder.addSchema(2680, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(
			ItemRenameFix.create(schema130, "Renamed grass path item to dirt path", createRenamer("minecraft:grass_path", "minecraft:dirt_path"))
		);
		dataFixerBuilder.addFixer(
		...
		dataFixerBuilder.addFixer(new AddNewChoices(schema131, "Added Sculk Sensor", References.BLOCK_ENTITY));
		Schema schema132 = dataFixerBuilder.addSchema(2686, V2686::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema132, "Added Axolotl", References.ENTITY));
		Schema schema133 = dataFixerBuilder.addSchema(2688, V2688::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema133, "Added Glow Squid", References.ENTITY));
		dataFixerBuilder.addFixer(new AddNewChoices(schema133, "Added Glow Item Frame", References.ENTITY));
		...
		ImmutableMap<String, String> immutableMap = ImmutableMap.<String, String>builder()
			...
			.build();
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema134, "Renamed copper block items to new oxidized terms", createRenamer(immutableMap)));
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema134, "Renamed copper blocks to new oxidized terms", createRenamer(immutableMap)));
		...
		ImmutableMap<String, String> immutableMap2 = ImmutableMap.<String, String>builder()
			...
			.build();
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema135, "Rename copper item suffixes", createRenamer(immutableMap2)));
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema135, "Rename copper blocks suffixes", createRenamer(immutableMap2)));
		Schema schema136 = dataFixerBuilder.addSchema(2693, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AddFlagIfNotPresentFix(schema136, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
		...
		ImmutableMap<String, String> immutableMap3 = ImmutableMap.<String, String>builder()
			...
			.build();
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema137, "Renamed grimstone block items to deepslate", createRenamer(immutableMap3)));
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema137, "Renamed grimstone blocks to deepslate", createRenamer(immutableMap3)));
		...
		dataFixerBuilder.addFixer(new SavedDataFeaturePoolElementFix(schema139));
		Schema schema140 = dataFixerBuilder.addSchema(2702, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AbstractArrowPickupFix(schema140));
		Schema schema141 = dataFixerBuilder.addSchema(2704, V2704::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema141, "Added Goat", References.ENTITY));
		Schema schema142 = dataFixerBuilder.addSchema(2707, V2707::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema142, "Added Marker", References.ENTITY));
		dataFixerBuilder.addFixer(new AddFlagIfNotPresentFix(schema142, References.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
		...
		dataFixerBuilder.addFixer(new AddFlagIfNotPresentFix(schema145, References.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
		Schema schema146 = dataFixerBuilder.addSchema(2831, V2831::new);
		dataFixerBuilder.addFixer(new SpawnerDataFix(schema146));
		Schema schema147 = dataFixerBuilder.addSchema(2832, V2832::new);
		dataFixerBuilder.addFixer(new WorldGenSettingsHeightAndBiomeFix(schema147));
		dataFixerBuilder.addFixer(new ChunkHeightAndBiomeFix(schema147));
		Schema schema148 = dataFixerBuilder.addSchema(2833, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema148));
		...
		dataFixerBuilder.addFixer(new ChunkProtoTickListFix(schema150));
		Schema schema151 = dataFixerBuilder.addSchema(2842, V2842::new);
		dataFixerBuilder.addFixer(new ChunkRenamesFix(schema151));
		Schema schema152 = dataFixerBuilder.addSchema(2843, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new OverreachingTickFix(schema152));
		dataFixerBuilder.addFixer(
		...
		dataFixerBuilder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema154));
		Schema schema155 = dataFixerBuilder.addSchema(2967, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new StructureSettingsFlattenFix(schema155));
		Schema schema156 = dataFixerBuilder.addSchema(2970, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new StructuresBecomeConfiguredFix(schema156));
		Schema schema157 = dataFixerBuilder.addSchema(3076, V3076::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema157, "Added Sculk Catalyst", References.BLOCK_ENTITY));
		Schema schema158 = dataFixerBuilder.addSchema(3077, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new ChunkDeleteIgnoredLightDataFix(schema158));
		Schema schema159 = dataFixerBuilder.addSchema(3078, V3078::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema159, "Added Frog", References.ENTITY));
		dataFixerBuilder.addFixer(new AddNewChoices(schema159, "Added Tadpole", References.ENTITY));
		dataFixerBuilder.addFixer(new AddNewChoices(schema159, "Added Sculk Shrieker", References.BLOCK_ENTITY));
		...
		dataFixerBuilder.addFixer(
			new EntityVariantFix(
				schema164, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), int2ObjectOpenHashMap -> {
		...
		dataFixerBuilder.addFixer(
			new EntityVariantFix(
				schema165, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), int2ObjectOpenHashMap -> {
		...
		dataFixerBuilder.addFixer(new AddNewChoices(schema180, "Added Sniffer", References.ENTITY));
		Schema schema181 = dataFixerBuilder.addSchema(3327, V3327::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema181, "Archaeology", References.BLOCK_ENTITY));
		Schema schema182 = dataFixerBuilder.addSchema(3328, V3328::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema182, "Added interaction", References.ENTITY));
		...
		dataFixerBuilder.addFixer(new EntityBrushableBlockFieldsRenameFix(schema183));
		dataFixerBuilder.addFixer(
			ItemRenameFix.create(
				schema183,
		...
		dataFixerBuilder.addFixer(new AddNewChoices(schema183, "Added calibrated sculk sensor", References.BLOCK_ENTITY));
		Schema schema184 = dataFixerBuilder.addSchema(3439, V3439::new);
		dataFixerBuilder.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema184, "Updated sign text format for Signs", "minecraft:sign"));
		Schema schema185 = dataFixerBuilder.addSchema(3439, 1, V3439_1::new);
		dataFixerBuilder.addFixer(new BlockEntitySignDoubleSidedEditableTextFix(schema185, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
		...
		dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema186, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
		...
		dataFixerBuilder.addFixer(new DecoratedPotFieldRenameFix(schema188));
		...
		dataFixerBuilder.addFixer(new ChunkDeleteLightFix(schema190));
		Schema schema191 = dataFixerBuilder.addSchema(3459, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new LegacyDragonFightFix(schema191));
		Schema schema192 = dataFixerBuilder.addSchema(3564, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new DropInvalidSignDataFix(schema192, "minecraft:sign"));
		Schema schema193 = dataFixerBuilder.addSchema(3564, 1, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new DropInvalidSignDataFix(schema193, "minecraft:hanging_sign"));
		Schema schema194 = dataFixerBuilder.addSchema(3565, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new RandomSequenceSettingsFix(schema194));
		Schema schema195 = dataFixerBuilder.addSchema(3566, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new ScoreboardDisplaySlotFix(schema195));
		Schema schema196 = dataFixerBuilder.addSchema(3568, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new MobEffectIdFix(schema196));
		Schema schema197 = dataFixerBuilder.addSchema(3682, V3682::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema197, "Added Crafter", References.BLOCK_ENTITY));
		Schema schema198 = dataFixerBuilder.addSchema(3683, V3683::new);
		dataFixerBuilder.addFixer(new PrimedTntBlockStateFixer(schema198));
		Schema schema199 = dataFixerBuilder.addSchema(3685, V3685::new);
		dataFixerBuilder.addFixer(new FixProjectileStoredItem(schema199));
		Schema schema200 = dataFixerBuilder.addSchema(3689, V3689::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema200, "Added Breeze", References.ENTITY));
		dataFixerBuilder.addFixer(new AddNewChoices(schema200, "Added Trial Spawner", References.BLOCK_ENTITY));
		...
		dataFixerBuilder.addFixer(new AddNewChoices(schema202, "Added Armadillo", References.ENTITY));
		...
		dataFixerBuilder.addFixer(new AddNewChoices(schema205, "Added Vault", References.BLOCK_ENTITY));
		Schema schema206 = dataFixerBuilder.addSchema(3807, 1, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new MapBannerBlockPosFormatFix(schema206));
		Schema schema207 = dataFixerBuilder.addSchema(3808, V3808::new);
		dataFixerBuilder.addFixer(new HorseBodyArmorItemFix(schema207, "minecraft:horse", "ArmorItem", true));
		Schema schema208 = dataFixerBuilder.addSchema(3808, 1, V3808_1::new);
		dataFixerBuilder.addFixer(new HorseBodyArmorItemFix(schema208, "minecraft:llama", "DecorItem", false));
		Schema schema209 = dataFixerBuilder.addSchema(3808, 2, V3808_2::new);
		dataFixerBuilder.addFixer(new HorseBodyArmorItemFix(schema209, "minecraft:trader_llama", "DecorItem", false));
		Schema schema210 = dataFixerBuilder.addSchema(3809, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new ChestedHorsesInventoryZeroIndexingFix(schema210));
		Schema schema211 = dataFixerBuilder.addSchema(3812, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new FixWolfHealth(schema211));
		Schema schema212 = dataFixerBuilder.addSchema(3813, V3813::new);
		dataFixerBuilder.addFixer(new BlockPosFormatAndRenamesFix(schema212));
		...
		dataFixerBuilder.addFixer(new AddNewChoices(schema214, "Added Bogged", References.ENTITY));
		Schema schema215 = dataFixerBuilder.addSchema(3818, V3818::new);
		dataFixerBuilder.addFixer(new BeehiveFieldRenameFix(schema215));
		dataFixerBuilder.addFixer(new EmptyItemInHotbarFix(schema215));
		Schema schema216 = dataFixerBuilder.addSchema(3818, 1, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new BannerPatternFormatFix(schema216));
		Schema schema217 = dataFixerBuilder.addSchema(3818, 2, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new TippedArrowPotionToItemFix(schema217));
		Schema schema218 = dataFixerBuilder.addSchema(3818, 3, V3818_3::new);
		dataFixerBuilder.addFixer(new WriteAndReadFix(schema218, "Inject data component types", References.DATA_COMPONENTS));
		Schema schema219 = dataFixerBuilder.addSchema(3818, 4, V3818_4::new);
		dataFixerBuilder.addFixer(new ParticleUnflatteningFix(schema219));
		Schema schema220 = dataFixerBuilder.addSchema(3818, 5, V3818_5::new);
		dataFixerBuilder.addFixer(new ItemStackComponentizationFix(schema220));
		Schema schema221 = dataFixerBuilder.addSchema(3818, 6, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AreaEffectCloudPotionFix(schema221));
		Schema schema222 = dataFixerBuilder.addSchema(3820, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new PlayerHeadBlockProfileFix(schema222));
		dataFixerBuilder.addFixer(new LodestoneCompassComponentFix(schema222));
		Schema schema223 = dataFixerBuilder.addSchema(3825, V3825::new);
		dataFixerBuilder.addFixer(new ItemStackCustomNameToOverrideComponentFix(schema223));
		dataFixerBuilder.addFixer(new BannerEntityCustomNameToOverrideComponentFix(schema223));
		dataFixerBuilder.addFixer(new TrialSpawnerConfigFix(schema223));
		dataFixerBuilder.addFixer(new AddNewChoices(schema223, "Added Ominous Item Spawner", References.ENTITY));
		Schema schema224 = dataFixerBuilder.addSchema(3828, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new EmptyItemInVillagerTradeFix(schema224));
		Schema schema225 = dataFixerBuilder.addSchema(3833, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new RemoveEmptyItemInBrushableBlockFix(schema225));
		Schema schema226 = dataFixerBuilder.addSchema(3938, V3938::new);
		dataFixerBuilder.addFixer(new ProjectileStoredWeaponFix(schema226));
		Schema schema227 = dataFixerBuilder.addSchema(3939, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema227, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
		Schema schema228 = dataFixerBuilder.addSchema(3943, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new OptionsMenuBlurrinessFix(schema228));
		Schema schema229 = dataFixerBuilder.addSchema(3945, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AttributeModifierIdFix(schema229));
		dataFixerBuilder.addFixer(new JukeboxTicksSinceSongStartedFix(schema229));
		Schema schema230 = dataFixerBuilder.addSchema(4054, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new OminousBannerRarityFix(schema230));
		Schema schema231 = dataFixerBuilder.addSchema(4055, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AttributeIdPrefixFix(schema231));
		Schema schema232 = dataFixerBuilder.addSchema(4057, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new CarvingStepRemoveFix(schema232));
		Schema schema233 = dataFixerBuilder.addSchema(4059, V4059::new);
		dataFixerBuilder.addFixer(new FoodToConsumableFix(schema233));
		Schema schema234 = dataFixerBuilder.addSchema(4061, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new TrialSpawnerConfigInRegistryFix(schema234));
		Schema schema235 = dataFixerBuilder.addSchema(4064, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new FireResistantToDamageResistantComponentFix(schema235));
		Schema schema236 = dataFixerBuilder.addSchema(4067, V4067::new);
		dataFixerBuilder.addFixer(new BoatSplitFix(schema236));
		dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema236, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
		Schema schema237 = dataFixerBuilder.addSchema(4068, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new LockComponentPredicateFix(schema237));
		dataFixerBuilder.addFixer(new ContainerBlockEntityLockPredicateFix(schema237));
		Schema schema238 = dataFixerBuilder.addSchema(4070, V4070::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema238, "Added Pale Oak Boat and Pale Oak Chest Boat", References.ENTITY));
		Schema schema239 = dataFixerBuilder.addSchema(4071, V4071::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema239, "Added Creaking", References.ENTITY));
		dataFixerBuilder.addFixer(new AddNewChoices(schema239, "Added Creaking Heart", References.BLOCK_ENTITY));
		Schema schema240 = dataFixerBuilder.addSchema(4081, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new EntitySalmonSizeFix(schema240));
		Schema schema241 = dataFixerBuilder.addSchema(4173, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new EntityFieldsRenameFix(schema241, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
		Schema schema242 = dataFixerBuilder.addSchema(4175, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new EquippableAssetRenameFix(schema242));
		dataFixerBuilder.addFixer(new CustomModelDataExpandFix(schema242));
		Schema schema243 = dataFixerBuilder.addSchema(4176, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new InvalidBlockEntityLockFix(schema243));
		dataFixerBuilder.addFixer(new InvalidLockComponentFix(schema243));
		Schema schema244 = dataFixerBuilder.addSchema(4180, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema244, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
		Schema schema245 = dataFixerBuilder.addSchema(4181, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema245, "minecraft:furnace"));
		dataFixerBuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema245, "minecraft:smoker"));
		dataFixerBuilder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema245, "minecraft:blast_furnace"));
		...
		dataFixerBuilder.addFixer(new UnflattenTextComponentFix(schema247));
		Schema schema248 = dataFixerBuilder.addSchema(4291, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new LegacyHoverEventFix(schema248));
		dataFixerBuilder.addFixer(new TextComponentStringifiedFlagsFix(schema248));
		Schema schema249 = dataFixerBuilder.addSchema(4292, V4292::new);
		dataFixerBuilder.addFixer(new TextComponentHoverAndClickEventFix(schema249));
		Schema schema250 = dataFixerBuilder.addSchema(4293, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new DropChancesFormatFix(schema250));
		...
		dataFixerBuilder.addFixer(new BlendingDataFix(schema252));
		Schema schema253 = dataFixerBuilder.addSchema(4296, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new AreaEffectCloudDurationScaleFix(schema253));
		Schema schema254 = dataFixerBuilder.addSchema(4297, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new ForcedChunkToTicketFix(schema254));
		Schema schema255 = dataFixerBuilder.addSchema(4299, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new EntitySpawnerItemVariantComponentFix(schema255));
		Schema schema256 = dataFixerBuilder.addSchema(4300, V4300::new);
		dataFixerBuilder.addFixer(new SaddleEquipmentSlotFix(schema256));
		Schema schema257 = dataFixerBuilder.addSchema(4301, V4301::new);
		dataFixerBuilder.addFixer(new EquipmentFormatFix(schema257));
		Schema schema258 = dataFixerBuilder.addSchema(4302, V4302::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema258, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
		Schema schema259 = dataFixerBuilder.addSchema(4303, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema259, References.ENTITY));
		dataFixerBuilder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema259, References.PLAYER));
		...
		dataFixerBuilder.addFixer(new ThrownPotionSplitFix(schema261));
		Schema schema262 = dataFixerBuilder.addSchema(4307, V4307::new);
		dataFixerBuilder.addFixer(new TooltipDisplayComponentFix(schema262));
		Schema schema263 = dataFixerBuilder.addSchema(4309, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new RaidRenamesDataFix(schema263));
		dataFixerBuilder.addFixer(new ChunkTicketUnpackPosFix(schema263));
		...
		dataFixerBuilder.addFixer(new PlayerEquipmentFix(schema265));
		Schema schema266 = dataFixerBuilder.addSchema(4314, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new InlineBlockPosFormatFix(schema266));
		Schema schema267 = dataFixerBuilder.addSchema(4420, V4420::new);
		dataFixerBuilder.addFixer(new NamedEntityConvertUncheckedFix(schema267, "AreaEffectCloudCustomParticleFix", References.ENTITY, "minecraft:area_effect_cloud"));
		Schema schema268 = dataFixerBuilder.addSchema(4421, V4421::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema268, "Added Happy Ghast", References.ENTITY));
		Schema schema269 = dataFixerBuilder.addSchema(4424, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new FeatureFlagRemoveFix(schema269, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
		dataFixerBuilder.addFixer(new AddFieldFix(schema269, References.PLAYER, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
		dataFixerBuilder.addFixer(new AddFieldFix(schema269, References.ENTITY, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
		Schema schema270 = dataFixerBuilder.addSchema(4531, V4531::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema270, "Added Copper Golem", References.ENTITY));
		Schema schema271 = dataFixerBuilder.addSchema(4532, V4532::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema271, "Added Copper Golem Statue Block Entity", References.BLOCK_ENTITY));
		Schema schema272 = dataFixerBuilder.addSchema(4533, V4533::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema272, "Added Shelf", References.BLOCK_ENTITY));
		Schema schema273 = dataFixerBuilder.addSchema(4535, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new CopperGolemWeatherStateFix(schema273));
		Schema schema274 = dataFixerBuilder.addSchema(4537, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new ChunkDeleteLightFix(schema274));
		Schema schema275 = dataFixerBuilder.addSchema(4541, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(BlockRenameFix.create(schema275, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
		dataFixerBuilder.addFixer(ItemRenameFix.create(schema275, "Rename chain to iron_chain", createRenamer("minecraft:chain", "minecraft:iron_chain")));
		Schema schema276 = dataFixerBuilder.addSchema(4543, V4543::new);
		dataFixerBuilder.addFixer(new AddNewChoices(schema276, "Added Mannequin", References.ENTITY));
		Schema schema277 = dataFixerBuilder.addSchema(4544, SAME_NAMESPACED);
		dataFixerBuilder.addFixer(new LegacyWorldBorderFix(schema277));
			...
			BlockRenameFix.create(
				...
				createRenamer(
					ImmutableMap.<String, String>builder()
						...
						.put("quantize:elevator", "minecraft:elevator")
						.put("quantize:flytrap", "minecraft:flytrap")
