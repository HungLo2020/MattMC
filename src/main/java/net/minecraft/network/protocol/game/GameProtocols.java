...
public class GameProtocols {
	public static final CodecModifier<RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket, GameProtocols.Context> HAS_INFINITE_MATERIALS = (streamCodec, context) -> new StreamCodec<RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket>(
	...
	public static final SimpleUnboundProtocol<ClientGamePacketListener, RegistryFriendlyByteBuf> CLIENTBOUND_TEMPLATE = ProtocolInfoBuilder.clientboundProtocol(
		...
		protocolInfoBuilder -> protocolInfoBuilder.withBundlePacket(
			...
			.addPacket(GamePacketTypes.CLIENTBOUND_PLAYER_SKIN, ClientboundPlayerSkinPacket.STREAM_CODEC)
			.addPacket(GamePacketTypes.CLIENTBOUND_REMOVE_PLAYER_SKIN, ClientboundRemovePlayerSkinPacket.STREAM_CODEC)
