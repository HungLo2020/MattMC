...
public class BandwidthDebugChart extends AbstractDebugChart {
	...
	private void drawLabeledLineAtValue(GuiGraphics guiGraphics, int i, int j, int k, int l) {
		this.drawLineWithLabel(guiGraphics, i, j, k - getSampleHeightInternal(l), toDisplayStringInternal(l));
	}
	...
	protected int getSampleColor(long l) {
		return this.getSampleColor(toBytesPerSecond(l), 0.0, -16711681, 8192.0, -6250241, 1.048576E7, -65536);
	}
