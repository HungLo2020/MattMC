...
public class GameModeSwitcherScreen extends Screen {
	...
	private static final Component SELECT_KEY = Component.translatable(
		"debug.gamemodes.select_next", new Object[]{Component.translatable("debug.gamemodes.press_f4").withStyle(ChatFormatting.AQUA)}
	);
	...
	static enum GameModeIcon {
		...
		private GameModeIcon(final Component component, final GameType gameType, final ItemStack itemStack) {
			this.name = component;
			this.mode = gameType;
