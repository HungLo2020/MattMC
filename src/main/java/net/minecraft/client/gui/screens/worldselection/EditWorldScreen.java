...
public class EditWorldScreen extends Screen {
	...
	public static boolean makeBackupAndShowToast(LevelStorageAccess levelStorageAccess) {
		...
		if (iOException != null) {
			...
			Component component = Component.translatable("selectWorld.edit.backupCreated", new Object[]{levelStorageAccess.getLevelId()});
			Component component2 = Component.translatable("selectWorld.edit.backupSize", new Object[]{Mth.ceil(l / 1048576.0)});
			Minecraft.getInstance().getToastManager().addToast(new SystemToast(SystemToast.SystemToastId.WORLD_BACKUP, component, component2));
			return true;
		}
	}
