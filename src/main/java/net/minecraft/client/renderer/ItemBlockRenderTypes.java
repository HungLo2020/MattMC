...
public class ItemBlockRenderTypes {
	...
	private static final Map<Block, ChunkSectionLayer> TYPE_BY_BLOCK = Util.make(Maps.<Block, ChunkSectionLayer>newHashMap(), hashMap -> {
		...
		hashMap.put(Blocks.COPPER_TORCH, chunkSectionLayer3);
		hashMap.put(Blocks.COPPER_WALL_TORCH, chunkSectionLayer3);
		...
		Blocks.COPPER_LANTERN.forEach(block -> hashMap.put(block, chunkSectionLayer3));
