...
public class SpecialModelRenderers {
	public static final LateBoundIdMapper<ResourceLocation, MapCodec<? extends SpecialModelRenderer.Unbaked>> ID_MAPPER = new LateBoundIdMapper();
	...
	private static final Map<Block, SpecialModelRenderer.Unbaked> STATIC_BLOCK_MAPPING = ImmutableMap.<Block, SpecialModelRenderer.Unbaked>builder()
		.put(Blocks.SKELETON_SKULL, new SkullSpecialRenderer.Unbaked(Types.SKELETON))
		.put(Blocks.ZOMBIE_HEAD, new SkullSpecialRenderer.Unbaked(Types.ZOMBIE))
		.put(Blocks.CREEPER_HEAD, new SkullSpecialRenderer.Unbaked(Types.CREEPER))
		.put(Blocks.DRAGON_HEAD, new SkullSpecialRenderer.Unbaked(Types.DRAGON))
		.put(Blocks.PIGLIN_HEAD, new SkullSpecialRenderer.Unbaked(Types.PIGLIN))
		.put(Blocks.PLAYER_HEAD, new PlayerHeadSpecialRenderer.Unbaked())
		.put(Blocks.WITHER_SKELETON_SKULL, new SkullSpecialRenderer.Unbaked(Types.WITHER_SKELETON))
		.put(Blocks.SKELETON_WALL_SKULL, new SkullSpecialRenderer.Unbaked(Types.SKELETON))
		.put(Blocks.ZOMBIE_WALL_HEAD, new SkullSpecialRenderer.Unbaked(Types.ZOMBIE))
		.put(Blocks.CREEPER_WALL_HEAD, new SkullSpecialRenderer.Unbaked(Types.CREEPER))
		.put(Blocks.DRAGON_WALL_HEAD, new SkullSpecialRenderer.Unbaked(Types.DRAGON))
		.put(Blocks.PIGLIN_WALL_HEAD, new SkullSpecialRenderer.Unbaked(Types.PIGLIN))
		.put(Blocks.PLAYER_WALL_HEAD, new PlayerHeadSpecialRenderer.Unbaked())
		.put(Blocks.WITHER_SKELETON_WALL_SKULL, new SkullSpecialRenderer.Unbaked(Types.WITHER_SKELETON))
		...
		.put(Blocks.COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.UNAFFECTED, Pose.STANDING))
		.put(Blocks.EXPOSED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.EXPOSED, Pose.STANDING))
		.put(Blocks.WEATHERED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.WEATHERED, Pose.STANDING))
		.put(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.OXIDIZED, Pose.STANDING))
		.put(Blocks.WAXED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.UNAFFECTED, Pose.STANDING))
		.put(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.EXPOSED, Pose.STANDING))
		.put(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.WEATHERED, Pose.STANDING))
		.put(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, new CopperGolemStatueSpecialRenderer.Unbaked(WeatherState.OXIDIZED, Pose.STANDING))
	...
	public static void bootstrap() {
		...
		ID_MAPPER.put(ResourceLocation.withDefaultNamespace("tacz_gun"), TaczGlock17SpecialRenderer.Unbaked.MAP_CODEC);
	}
