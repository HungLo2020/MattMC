...
import net.minecraft.client.renderer.advanced.vertex.attributes.common.LightAttribute;
import net.minecraft.client.renderer.advanced.vertex.attributes.common.PositionAttribute;
import net.minecraft.client.renderer.advanced.vertex.attributes.common.TextureAttribute;
