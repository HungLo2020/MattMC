...
public class PlayerItemInHandLayer<S extends AvatarRenderState, M extends EntityModel<S> & ArmedModel & HeadedModel> extends ItemInHandLayer<S, M> {
	...
	protected void submitArmWithItem(
		S avatarRenderState, ItemStackRenderState itemStackRenderState, HumanoidArm humanoidArm, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int i
	) {
		if (!itemStackRenderState.isEmpty()) {
			...
			if (avatarRenderState.isUsingItem
				...
				super.submitArmWithItem(avatarRenderState, itemStackRenderState, humanoidArm, poseStack, submitNodeCollector, i);
			}
		}
	}
