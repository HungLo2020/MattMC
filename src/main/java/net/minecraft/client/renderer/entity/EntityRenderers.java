...
import net.alexscaves.client.render.entity.*;
import net.alexsmobs.client.render.*;
...
import net.alexsmobs.client.render.RenderBlobfish;
import net.alexsmobs.client.render.RenderCombJelly;
import net.alexsmobs.client.render.RenderCosmicCod;
import net.alexsmobs.client.render.RenderFrilledShark;
import net.alexsmobs.client.render.RenderFlyingFish;
import net.alexsmobs.client.render.RenderGazelle;
import net.alexsmobs.client.render.RenderMimicOctopus;
import net.alexsmobs.client.render.RenderTerrapin;
...
public class EntityRenderers {
	...
	static {
		...
		register(EntityType.ALLIGATOR_SNAPPING_TURTLE, RenderAlligatorSnappingTurtle::new);
		register(EntityType.ANACONDA, RenderAnaconda::new);
		register(EntityType.ANACONDA_PART, RenderAnacondaPart::new);
		register(EntityType.AREA_EFFECT_CLOUD, NoopRenderer::new);
		register(EntityType.ATLATITAN, AtlatitanRenderer::new);
		...
		register(EntityType.BISON, RenderBison::new);
		register(EntityType.CAIMAN, RenderCaiman::new);
		register(EntityType.CAPUCHIN_MONKEY, RenderCapuchinMonkey::new);
		register(EntityType.CAVE_CENTIPEDE_HEAD, RenderCentipedeHead::new);
		register(EntityType.CAVE_CENTIPEDE_BODY, RenderCentipedeBody::new);
		register(EntityType.CAVE_CENTIPEDE_TAIL, RenderCentipedeTail::new);
		register(EntityType.BLAZE, BlazeRenderer::new);
		register(EntityType.BLOBFISH, RenderBlobfish::new);
		register(EntityType.BLUE_JAY, RenderBlueJay::new);
		...
		register(EntityType.BUNFUNGUS, RenderBunfungus::new);
		register(EntityType.CACHALOT_WHALE, RenderCachalotWhale::new);
		register(EntityType.CACHALOT_ECHO, RenderCachalotEcho::new);
		register(EntityType.BREEZE_WIND_CHARGE, WindChargeRenderer::new);
		register(EntityType.CAMEL, CamelRenderer::new);
		register(EntityType.CATFISH, RenderCatfish::new);
		...
		register(EntityType.COCKROACH, RenderCockroach::new);
		...
		register(EntityType.COSMAW, RenderCosmaw::new);
		register(EntityType.COD, CodRenderer::new);
		register(EntityType.CROCODILE, RenderCrocodile::new);
		...
		register(EntityType.CROW, RenderCrow::new);
		...
		register(EntityType.ELEPHANT, RenderElephant::new);
		register(EntityType.EMU, RenderEmu::new);
		...
		register(EntityType.ENDERIOPHAGE, RenderEnderiophage::new);
		...
		register(EntityType.GELADA_MONKEY, RenderGeladaMonkey::new);
		...
		register(EntityType.GIANT_SQUID, RenderGiantSquid::new);
		register(EntityType.GOAT, GoatRenderer::new);
		register(EntityType.GORILLA, RenderGorilla::new);
		register(EntityType.GRIZZLY_BEAR, RenderGrizzlyBear::new);
		register(EntityType.GROTTOCERATOPS, GrottoceratopsRenderer::new);
		register(EntityType.GUARDIAN, GuardianRenderer::new);
		register(EntityType.HAMMERHEAD_SHARK, RenderHammerheadShark::new);
		...
		register(EntityType.HUMMINGBIRD, RenderHummingbird::new);
		...
		register(EntityType.JERBOA, RenderJerboa::new);
		...
		register(EntityType.KANGAROO, KangarooRenderer::new);
		register(EntityType.KOMODO_DRAGON, RenderKomodoDragon::new);
		register(EntityType.LEAFCUTTER_ANT, RenderLeafcutterAnt::new);
		...
		register(EntityType.MANTIS_SHRIMP, RenderMantisShrimp::new);
		...
		register(EntityType.MUDSKIPPER, RenderMudskipper::new);
		register(EntityType.MOOSE, RenderMoose::new);
		register(EntityType.MULE, context -> new DonkeyRenderer(context, DonkeyRenderer.Type.MULE));
		register(EntityType.MUNGUS, RenderMungus::new);
		...
		register(EntityType.ORCA, RenderOrca::new);
		...
		register(EntityType.PLATYPUS, RenderPlatypus::new);
		register(EntityType.POLAR_BEAR, PolarBearRenderer::new);
		register(EntityType.POTOO, RenderPotoo::new);
		register(EntityType.PUFFERFISH, PufferfishRenderer::new);
		register(EntityType.RABBIT, RabbitRenderer::new);
		register(EntityType.RACCOON, RenderRaccoon::new);
		register(EntityType.RAIN_FROG, RenderRainFrog::new);
		register(EntityType.RATTLESNAKE, RenderRattlesnake::new);
		register(EntityType.RHINOCEROS, RenderRhinoceros::new);
		register(EntityType.ROADRUNNER, RenderRoadrunner::new);
		register(EntityType.RAVAGER, RavagerRenderer::new);
		register(EntityType.RELICHEIRUS, RelicheirusRenderer::new);
		register(EntityType.SALMON, SalmonRenderer::new);
		register(EntityType.ANTEATER, RenderAnteater::new);
		register(EntityType.MIMICUBE, RenderMimicube::new);
		register(EntityType.SEAGULL, RenderSeagull::new);
		register(EntityType.SHEEP, SheepRenderer::new);
		register(EntityType.SHOEBILL, RenderShoebill::new);
		register(EntityType.SKUNK, RenderSkunk::new);
		register(EntityType.SPECTRE, RenderSpectre::new);
		register(EntityType.SUGAR_GLIDER, RenderSugarGlider::new);
		register(EntityType.SUNBIRD, RenderSunbird::new);
		...
		register(EntityType.SKELEWAG, RenderSkelewag::new);
		...
		register(EntityType.SNOW_LEOPARD, RenderSnowLeopard::new);
		register(EntityType.SUBTERRANODON, SubterranodonRenderer::new);
		register(EntityType.TREMORSAURUS, TremorsaurusRenderer::new);
		register(EntityType.TRILOCARIS, TrilocarisRenderer::new);
		register(EntityType.TOUCAN, RenderToucan::new);
		register(EntityType.TARANTULA_HAWK, RenderTarantulaHawk::new);
		register(EntityType.TASMANIAN_DEVIL, RenderTasmanianDevil::new);
		register(EntityType.TIGER, RenderTiger::new);
		register(EntityType.UNDERMINER, RenderUnderminer::new);
		register(EntityType.WARPED_TOAD, RenderWarpedToad::new);
		register(EntityType.VALLUMRAPTOR, VallumraptorRenderer::new);
