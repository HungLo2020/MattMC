package net.minecraft.client.renderer.sodium.platform.windows;

import net.minecraft.client.renderer.sodium.platform.windows.api.version.VersionFixedFileInfoStruct;
