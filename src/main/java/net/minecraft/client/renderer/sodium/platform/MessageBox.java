package net.minecraft.client.renderer.sodium.platform;

import net.minecraft.client.renderer.sodium.compatibility.environment.OsUtils;
import net.minecraft.client.renderer.sodium.platform.windows.api.Shell32;
import net.minecraft.client.renderer.sodium.platform.windows.api.User32;
import net.minecraft.client.renderer.sodium.platform.windows.api.msgbox.MsgBoxCallback;
import net.minecraft.client.renderer.sodium.platform.windows.api.msgbox.MsgBoxParamSw;
