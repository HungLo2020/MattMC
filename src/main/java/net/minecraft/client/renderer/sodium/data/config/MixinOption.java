package net.minecraft.client.renderer.sodium.data.config;
...
/**
 * Represents a mixin option that can be enabled/disabled.
 * Inlined from Sodium module as part of integration.
 */
