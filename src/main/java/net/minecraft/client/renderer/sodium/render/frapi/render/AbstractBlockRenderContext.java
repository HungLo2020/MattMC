...
import net.minecraft.client.renderer.chunk.advanced.compile.pipeline.BlockOcclusionCache;
...
import net.minecraft.client.renderer.sodium.services.PlatformModelAccess;
