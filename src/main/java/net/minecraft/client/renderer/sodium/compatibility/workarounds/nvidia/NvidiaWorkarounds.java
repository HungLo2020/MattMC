...
import net.minecraft.client.renderer.sodium.platform.unix.Libc;
import net.minecraft.client.renderer.sodium.platform.windows.WindowsCommandLine;
import net.minecraft.client.renderer.sodium.platform.windows.WindowsFileVersion;
import net.minecraft.client.renderer.sodium.platform.windows.api.d3dkmt.D3DKMT;
