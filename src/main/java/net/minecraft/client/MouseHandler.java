...
public class MouseHandler {
	...
	private void onButton(long l, MouseButtonInfo mouseButtonInfo, int i) {
				...
				if (this.minecraft.screen == null) {
					...
					if (bl) {
						...
						try {
							...
							boolean bl2 = m - this.lastClickTime < 250L && this.lastClickButton == mouseButtonEvent.button();
							if (screen.mouseClicked(mouseButtonEvent, bl2)) {
								this.lastClickTime = m;
