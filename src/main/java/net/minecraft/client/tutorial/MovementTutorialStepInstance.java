...
public class MovementTutorialStepInstance implements TutorialStepInstance {
	...
	private static final Component MOVE_TITLE = Component.translatable(
		"tutorial.move.title", new Object[]{Tutorial.key("forward"), Tutorial.key("left"), Tutorial.key("back"), Tutorial.key("right")}
	);
	private static final Component MOVE_DESCRIPTION = Component.translatable("tutorial.move.description", new Object[]{Tutorial.key("jump")});
