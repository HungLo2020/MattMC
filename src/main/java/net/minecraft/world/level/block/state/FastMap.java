 ...
 * This is FerriteCore optimization #2: replaces per-state neighbor tables with a shared FastMap per block.
 * Memory savings: ~600 MB by reducing complexity from O(states * sum(values)) to O(states)
 */
