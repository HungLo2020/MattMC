...
public class Vex extends Monster implements TraceableEntity {
	...
	protected void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.boundOrigin = (BlockPos)valueInput.read("bound_pos", BlockPos.CODEC).orElse(null);
		valueInput.getInt("life_ticks").ifPresentOrElse(this::setLimitedLife, () -> this.hasLimitedLife = false);
