...
import net.minecraft.world.entity.ai.goal.AnimalAIFindWater;
import net.minecraft.world.entity.ai.goal.AnimalAILeaveWater;
import net.minecraft.world.entity.ai.goal.BottomFeederAIWander;
import net.minecraft.world.entity.ai.navigation.SemiAquaticPathNavigator;
...
public class EntityLobster extends WaterAnimal implements ISemiAquatic, Bucketable {
    ...
    public EntityLobster(Level level) {
        this(EntityType.LOBSTER, level);
    }
    ...
    public static AttributeSupplier.Builder bakeAttributes() {
        return WaterAnimal.createMobAttributes().add(Attributes.MAX_HEALTH, 5D).add(Attributes.ARMOR, 2.0D).add(Attributes.ATTACK_DAMAGE, 2.0D).add(Attributes.MOVEMENT_SPEED, 0.15F);
    }
    ...
    protected SoundEvent getDeathSound() {
        return SoundEvents.LOBSTER_HURT;
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(Items.LOBSTER_BUCKET);
    ...
    public void tick() {
        ...
        if (this.entityData.get(ATTACK_TICK) > 0) {
            if(attackProgress == 3){
                this.playSound(SoundEvents.LOBSTER_ATTACK, this.getSoundVolume(), this.getVoicePitch());
            }
