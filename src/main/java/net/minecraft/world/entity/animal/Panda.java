...
public class Panda extends Animal {
	...
	protected void addAdditionalSaveData(ValueOutput valueOutput) {
		...
		valueOutput.store("MainGene", Panda.Gene.CODEC, this.getMainGene());
		valueOutput.store("HiddenGene", Panda.Gene.CODEC, this.getHiddenGene());
	}

	@Override
	protected void readAdditionalSaveData(ValueInput valueInput) {
		super.readAdditionalSaveData(valueInput);
		this.setMainGene((Panda.Gene)valueInput.read("MainGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
		this.setHiddenGene((Panda.Gene)valueInput.read("HiddenGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
	}
