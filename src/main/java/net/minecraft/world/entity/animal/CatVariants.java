...
public interface CatVariants {
	...
	private static void register(
		...
		bootstrapContext.register(resourceKey, new CatVariant(new ClientAsset.ResourceTexture(ResourceLocation.withDefaultNamespace(string)), spawnPrioritySelectors));
	}
}
