			...
			CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 1)
				...
				.displayItems(
					(itemDisplayParameters, output) -> {
						...
						output.accept(Items.TACZ_NINE_MM_AMMO);
						itemDisplayParameters.holders()
		...
		Registry.register(
			...
			CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4)
				...
				.displayItems((itemDisplayParameters, output) -> {
					...
					output.accept(Items.CACHALOT_WHALE_SPAWN_EGG);
					...
					output.accept(Items.GAZELLE_SPAWN_EGG);
					...
					output.accept(Items.GORILLA_SPAWN_EGG);
					...
					output.accept(Items.RHINOCEROS_SPAWN_EGG);
					...
					output.accept(Items.ANTEATER_SPAWN_EGG);
					output.accept(Items.MIMICUBE_SPAWN_EGG);
					...
					output.accept(Items.SNOW_LEOPARD_SPAWN_EGG);
					...
					output.accept(Items.TASMANIAN_DEVIL_SPAWN_EGG);
					output.accept(Items.TIGER_SPAWN_EGG);
					...
					output.accept(Items.UNDERMINER_SPAWN_EGG);
