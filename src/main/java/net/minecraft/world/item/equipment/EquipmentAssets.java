...
public interface EquipmentAssets {
	...
	Map<DyeColor, ResourceKey<EquipmentAsset>> CARPETS = Util.makeEnumMap(DyeColor.class, dyeColor -> createId(dyeColor.getSerializedName() + "_carpet"));
	ResourceKey<EquipmentAsset> TRADER_LLAMA = createId("trader_llama");
	Map<DyeColor, ResourceKey<EquipmentAsset>> HARNESSES = Util.makeEnumMap(DyeColor.class, dyeColor -> createId(dyeColor.getSerializedName() + "_harness"));
