...
import net.stareval.expression.CallExpression;
import net.stareval.expression.ConstantExpression;
import net.stareval.expression.Expression;
import net.stareval.expression.VariableExpression;
