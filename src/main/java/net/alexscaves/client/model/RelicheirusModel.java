...
import net.citadel.animation.LegSolverQuadruped;
...
public class RelicheirusModel extends AdvancedEntityModel<RelicheirusRenderState> {
    ...
    public void animate(Animation animation, int animationTick) {
        // Simplified: animator-based animations disabled for render state architecture
        // The animator requires an IAnimatedEntity which we don't have in render state
        // Basic animations are handled directly in setupAnim instead
    }
