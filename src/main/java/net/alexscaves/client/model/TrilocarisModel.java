...
import net.alexscaves.client.render.entity.TrilocarisRenderState;
...
public class TrilocarisModel extends AdvancedEntityModel<TrilocarisRenderState> {
    ...
    @Override
    public void setupAnim(TrilocarisRenderState renderState) {
