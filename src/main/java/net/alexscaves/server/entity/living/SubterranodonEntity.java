...
import net.alexscaves.server.entity.ai.*;
import net.alexscaves.server.entity.util.FlyingMount;
import net.alexscaves.server.entity.util.KeybindUsingMount;
import net.alexscaves.server.entity.util.PackAnimal;
...
import net.citadel.server.entity.collision.ICustomCollisions;
...
public class SubterranodonEntity extends DinosaurEntity implements PackAnimal, FlyingAnimal, KeybindUsingMount, FlyingMount {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.ATTACK_DAMAGE, 2.0D).add(Attributes.FLYING_SPEED, 1F).add(Attributes.MOVEMENT_SPEED, 0.2D).add(Attributes.FOLLOW_RANGE, 32.0D).add(Attributes.MAX_HEALTH, 20.0D).add(Attributes.TEMPT_RANGE, 10.0D);
    }
