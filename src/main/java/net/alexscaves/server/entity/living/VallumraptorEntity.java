...
import net.alexscaves.server.entity.ai.*;
import net.alexscaves.server.entity.util.ChestThief;
import net.alexscaves.server.entity.util.PackAnimal;
import net.alexscaves.server.entity.util.TargetsDroppedItems;
...
public class VallumraptorEntity extends DinosaurEntity implements IAnimatedEntity, ICustomCollisions, PackAnimal, ChestThief, TargetsDroppedItems {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.ATTACK_DAMAGE, 3.0D).add(Attributes.MOVEMENT_SPEED, 0.2D).add(Attributes.FOLLOW_RANGE, 32.0D).add(Attributes.MAX_HEALTH, 28.0D).add(Attributes.TEMPT_RANGE, 10.0D);
    }
