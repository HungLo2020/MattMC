...
/**
 * Alex's Caves Tag Registry for direct Minecraft source integration.
 * All tags use the minecraft namespace instead of alexscaves.
 */
public class ACTagRegistry {

    // Entity Type Tags - Most critical for mob interactions
    ...
    // Block Tags - For environment interactions
    ...
    // Tag registration helper methods - use minecraft namespace for direct source integration
