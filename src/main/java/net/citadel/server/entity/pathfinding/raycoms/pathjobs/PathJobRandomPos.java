...
public class PathJobRandomPos extends AbstractPathJob {
    ...
    protected Path search() {
        if (Pathfinding.isDebug()) {
            Citadel.LOGGER.info("Pathfinding from [{},{},{}] in the direction of [{},{},{}]", start.getX(), start.getY(), start.getZ(), destination.getX(), destination.getY(), destination.getZ());
        }
    ...
    public boolean posAndRangeMatch(final int range, final BlockPos pos) {
        return range == maxDistToDest && Objects.equals(destination, pos);
    }
}
