package net.citadel.client.model;

import net.citadel.client.model.basic.BasicEntityModel;
import net.citadel.client.model.container.TextureOffset;
 ...
 * @since 1.0.0
 */
public abstract class AdvancedEntityModel<T extends EntityRenderState> extends BasicEntityModel<T> {
    ...
    public AdvancedEntityModel(){
        super();
        // NOTE: Do NOT synchronize here - child classes set texWidth/texHeight in their constructors
        // and synchronization must happen AFTER those values are set
    }
