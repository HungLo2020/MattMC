...
import net.stareval.function.B2BFunction;
import net.stareval.function.BB2BFunction;
import net.stareval.function.F2FFunction;
import net.stareval.function.F2IFunction;
import net.stareval.function.FF2BFunction;
import net.stareval.function.FF2FFunction;
import net.stareval.function.FFF2BFunction;
import net.stareval.function.FFF2FFunction;
import net.stareval.function.FunctionContext;
import net.stareval.function.FunctionResolver;
import net.stareval.function.FunctionReturn;
import net.stareval.function.I2IFunction;
import net.stareval.function.II2BFunction;
import net.stareval.function.II2IFunction;
import net.stareval.function.III2BFunction;
import net.stareval.function.III2IFunction;
import net.stareval.function.Type;
import net.stareval.function.TypedFunction;
import net.stareval.function.TypedFunction.Parameter;
import net.stareval.function.V2FFunction;
import net.stareval.function.V2IFunction;
