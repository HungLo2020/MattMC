...
import net.distanthorizons.core.wrapperInterfaces.modAccessor.ISodiumAccessor;
import net.distanthorizons.core.wrapperInterfaces.world.IClientLevelWrapper;
import net.distanthorizons.fabric.hooks.DhLightTextureHook;
import net.distanthorizons.fabric.hooks.DhMinecraftLevelHook;
import net.distanthorizons.fabric.wrappers.modAccessor.SodiumAccessor;
...
public class FabricClientProxy implements AbstractModInitializer.IEventProxy
{
	...
	public void registerEvents()
	{
		...
		LOGGER.info("Registering Distant Horizons hooks");
		
		net.minecraft.hooks.HookRegistry.registerLightTextureHook(new DhLightTextureHook());
		net.minecraft.hooks.HookRegistry.registerMinecraftLevelHook(new DhMinecraftLevelHook());
		...
		// Register for both directions: client needs C2S to send packets, S2C to receive packets
