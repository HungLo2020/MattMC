...
import net.distanthorizons.core.jar.gui.BaseJFrame;
import net.distanthorizons.core.jar.gui.cusomJObject.JBox;
import net.distanthorizons.core.jar.installer.ModrinthGetter;
import net.distanthorizons.core.jar.installer.WebDownloader;
