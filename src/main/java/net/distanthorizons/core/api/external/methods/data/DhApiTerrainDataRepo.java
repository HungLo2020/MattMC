package net.distanthorizons.core.api.external.methods.data;

import net.distanthorizons.api.interfaces.data.IDhApiTerrainDataCache;
import net.distanthorizons.api.interfaces.world.IDhApiLevelWrapper;
import net.distanthorizons.api.objects.DhApiResult;
import net.distanthorizons.api.objects.data.DhApiRaycastResult;
import net.distanthorizons.api.objects.data.DhApiTerrainDataPoint;
import net.distanthorizons.api.interfaces.data.IDhApiTerrainDataRepo;
import net.distanthorizons.api.objects.math.DhApiVec3i;
import net.distanthorizons.core.api.internal.SharedApi;
import net.distanthorizons.core.dataObjects.fullData.FullDataPointIdMap;
...
import net.distanthorizons.core.util.math.Vec3i;
