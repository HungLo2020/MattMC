package net.distanthorizons.core.config.eventHandlers.presets;

import net.distanthorizons.api.enums.config.EDhApiHorizontalQuality;
import net.distanthorizons.api.enums.config.EDhApiMaxHorizontalResolution;
import net.distanthorizons.api.enums.config.EDhApiMcRenderingFadeMode;
import net.distanthorizons.api.enums.config.EDhApiVerticalQuality;
...
import net.distanthorizons.core.config.ConfigPresetOptions;
import net.distanthorizons.core.config.listeners.ConfigChangeListener;
import net.distanthorizons.core.config.types.AbstractConfigBase;
