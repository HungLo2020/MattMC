...
public class UIRenderer {
    ...
    public void drawLightingDebug(int screenWidth, int screenHeight, int backlogSize, 
        ...
        // Draw text
        drawText("Lighting Debug", x, y, scale, 0xFFFFFF);
        y += lineHeight;
        
        drawText(String.format("Backlog: %d", backlogSize), x, y, scale, 0xFFFFFF);
        y += lineHeight;
        
        drawText(String.format("Nodes/frame: %d", nodesProcessed), x, y, scale, 0xFFFFFF);
        y += lineHeight;
        ...
        drawText(String.format("Time: %.2fms", timeSpent), x, y, scale, timeColor);
    ...
    public void drawSystemInfo(int screenWidth, int screenHeight, long windowHandle) {
        ...
        drawTextRightAligned(javaVersion, screenWidth - 10f, y, scale, 0xFFFFFF);
        y += lineHeight;
        
        drawTextRightAligned(memoryInfo, screenWidth - 10f, y, scale, 0xFFFFFF);
        y += lineHeight;
        
        drawTextRightAligned(cpuInfo, screenWidth - 10f, y, scale, 0xFFFFFF);
        y += lineHeight;
        
        drawTextRightAligned(displayRes, screenWidth - 10f, y, scale, 0xFFFFFF);
        y += lineHeight;
        
        drawTextRightAligned(gpuName, screenWidth - 10f, y, scale, 0xFFFFFF);
        y += lineHeight;
        
        drawTextRightAligned(gpuUsageInfo, screenWidth - 10f, y, scale, 0xFFFFFF);
