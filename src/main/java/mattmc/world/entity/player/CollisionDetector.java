...
public class CollisionDetector {
    ...
    public CollisionDetector(LevelAccessor world) {
        this.world = world;
    }
    
    /**
     * Check if a player hitbox at the given position collides with any blocks.
     * @param x LocalPlayer center X position
     * @param y LocalPlayer feet Y position
     * @param z LocalPlayer center Z position
     * @return true if collision detected
     */
    public boolean checkCollision(float x, float y, float z) {
        // LocalPlayer feet are at y, head at y + HEIGHT
     ...
     * @param x LocalPlayer X position
     * @param z LocalPlayer Z position
