...
public class Blocks {
    ...
    public static final Block TORCH = register("torch", new Block(false, 14)); // Non-solid, emits light level 14 like Minecraft
    ...
    private static Block register(String name, Block block) {
        ...
        if (block instanceof StairsBlock) {
            ...
            registeredBlock = new Block(block.isSolid(), block.getLightLevel(), identifier);
        }
