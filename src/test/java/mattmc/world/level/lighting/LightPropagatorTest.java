...
public class LightPropagatorTest {
	...
	public void testAddBlockLightFromTorch() {
		...
		propagator.addBlockLightRGB(chunk, 8, torchY, 8, emission, emission, emission);
		
		// Verify light at source
		assertEquals(14, chunk.getBlockLightI(8, torchY, 8), "Source should have full emission");
		
		// Verify light propagates to neighbors with attenuation
		assertEquals(13, chunk.getBlockLightI(9, torchY, 8), "Neighbor +X should have 13");
		assertEquals(13, chunk.getBlockLightI(7, torchY, 8), "Neighbor -X should have 13");
		assertEquals(13, chunk.getBlockLightI(8, torchY, 9), "Neighbor +Z should have 13");
		assertEquals(13, chunk.getBlockLightI(8, torchY, 7), "Neighbor -Z should have 13");
		
		// Verify light propagates to distance 2
		assertEquals(12, chunk.getBlockLightI(10, torchY, 8), "Distance 2 should have 12");
		assertEquals(12, chunk.getBlockLightI(6, torchY, 8), "Distance 2 should have 12");
		
		// Verify light propagates diagonally
		assertEquals(12, chunk.getBlockLightI(9, torchY, 9), "Diagonal neighbor should have 12");
	}
	...
	public void testLightBlockedByOpaqueBlock() {
		...
		propagator.addBlockLightRGB(chunk, 8, y, 8, 14, 14, 14);
		
		// Light at source
		assertEquals(14, chunk.getBlockLightI(8, y, 8), "Source should have full light");
		
		// The enclosed position should have no light
		assertEquals(0, chunk.getBlockLightI(10, y, 8), "Fully enclosed position should have no light");
		
		// Light should still propagate in open directions
		assertEquals(13, chunk.getBlockLightI(7, y, 8), "Light should propagate backwards");
		assertEquals(13, chunk.getBlockLightI(8, y + 1, 8), "Light should propagate up");
	}
	...
	public void testRemoveBlockLight() {
		...
		assertEquals(14, chunk.getBlockLightI(8, y, 8));
		assertEquals(13, chunk.getBlockLightI(9, y, 8));
		assertEquals(12, chunk.getBlockLightI(10, y, 8));
		
		// Remove the light source
		propagator.removeBlockLight(chunk, 8, y, 8);
		
		// All light should be removed
		assertEquals(0, chunk.getBlockLightI(8, y, 8), "Source should have no light");
		assertEquals(0, chunk.getBlockLightI(9, y, 8), "Neighbor should have no light");
		assertEquals(0, chunk.getBlockLightI(10, y, 8), "Distance 2 should have no light");
	}
	...
	public void testMultipleLightSources() {
		...
		propagator.addBlockLightRGB(chunk, 5, y, 8, 14, 14, 14);
		propagator.addBlockLightRGB(chunk, 15, y, 8, 14, 14, 14);
		
		// Verify both sources have light
		assertEquals(14, chunk.getBlockLightI(5, y, 8));
		assertEquals(14, chunk.getBlockLightI(15, y, 8));
		
		// In the middle, light should come from whichever source is brighter
		// At position 10, it's 5 blocks from each source
		int midLight = chunk.getBlockLightI(10, y, 8);
	...
	public void testRemoveOneOfMultipleSources() {
		...
		propagator.addBlockLightRGB(chunk, 8, y, 8, 14, 14, 14);
		propagator.addBlockLightRGB(chunk, 10, y, 8, 14, 14, 14);
		
		// Position 9 should have light from both sources
		int lightBefore = chunk.getBlockLightI(9, y, 8);
		...
		int lightAfter = chunk.getBlockLightI(9, y, 8);
		...
		int light7 = chunk.getBlockLightI(7, y, 8);
	...
	public void testUpdateBlockLight() {
		...
		assertEquals(14, chunk.getBlockLightI(8, y, 8), "Torch should emit light");
		assertEquals(13, chunk.getBlockLightI(9, y, 8), "Light should propagate");
		
		// Remove the torch
		chunk.setBlock(8, y, 8, Blocks.AIR);
		
		// Light should be removed
		assertEquals(0, chunk.getBlockLightI(8, y, 8), "Light should be removed");
		assertEquals(0, chunk.getBlockLightI(9, y, 8), "Propagated light should be removed");
	}
	...
	public void testLightAttenuation() {
		...
		assertEquals(14, chunk.getBlockLightI(5, y, 8), "Distance 0: 14");
		assertEquals(13, chunk.getBlockLightI(6, y, 8), "Distance 1: 13");
		assertEquals(12, chunk.getBlockLightI(7, y, 8), "Distance 2: 12");
		assertEquals(11, chunk.getBlockLightI(8, y, 8), "Distance 3: 11");
		assertEquals(10, chunk.getBlockLightI(9, y, 8), "Distance 4: 10");
		assertEquals(9, chunk.getBlockLightI(10, y, 8), "Distance 5: 9");
		
		// Light should fade out after 14 blocks
		int farLight = chunk.getBlockLightI(15, y, 8);
	...
	public void testVerticalPropagation() {
		...
		assertEquals(13, chunk.getBlockLightI(8, y + 1, 8), "Light should propagate up");
		assertEquals(13, chunk.getBlockLightI(8, y - 1, 8), "Light should propagate down");
		assertEquals(12, chunk.getBlockLightI(8, y + 2, 8), "Light at distance 2 up");
		assertEquals(12, chunk.getBlockLightI(8, y - 2, 8), "Light at distance 2 down");
	}
}
