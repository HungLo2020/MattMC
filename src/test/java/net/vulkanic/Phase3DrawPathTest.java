...
public class Phase3DrawPathTest {
    ...
    public void testVulkanLegacyVaoCapturesAttributeBufferBindingsForInstancedDraws() throws IOException {
        ...
        assertTrue(backendSource.contains("captureRequestOwnedGalDraw(")
                ...
                && backendSource.contains("List<VulkanicPassResourceModel.ResourceUse> capturedUses")
                && backendSource.contains("Objects.requireNonNull(capturedUses, \"capturedUses\")")
                && backendSource.contains("containsEquivalentResourceUse(capturedUses, use)")
