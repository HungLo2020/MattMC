...
public class Phase3SynchronizationTest {
    ...
    public void testVulkanBackendSourceUsesNativePipelineBarrierForResourceBarriers() throws Exception {
        ...
        assertTrue(source.contains("VulkanResourceUsageExecutionPlanner.planResourceBarrier(barriers, isRenderPassRecording())"),
            "In-render-pass barriers should use resource-usage planner-owned render-pass-compatible masks");
        ...
        assertTrue(source.contains("VulkanResourceUsageExecutionPlanner.planConservativeMemoryBarrier(isRenderPassRecording())"),
            "Conservative memory barriers should also route through resource-usage planning inside an active render pass");
