...
public class ACPotionEffectLayer extends RenderLayer {
    ...
    private static final ResourceLocation TEXTURE_BUBBLE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID,
    ...
    public static final ResourceLocation INSIDE_BUBBLE_TEXTURE = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID,
            "textures/misc/inside_bubble.png");
    public static final ResourceLocation TEXTURE_DARKNESS = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID,
            "textures/entity/darkness_incarnate.png");
    public static final ResourceLocation TEXTURE_SUGAR_RUSH = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID,
