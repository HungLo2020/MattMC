package net.matt.quantize.worldgen.structures.structures;
...
public class DinoBowlStructure extends AbstractCaveGenerationStructure {
    ...
    private static final int BOWL_WIDTH_RADIUS = 100; //100
    private static final int BOWL_HEIGHT_RADIUS = 80; //80
    ...
    public DinoBowlStructure(StructureSettings settings) {
        super(settings, QBiomes.PRIMORDIAL_CAVES);
    }
