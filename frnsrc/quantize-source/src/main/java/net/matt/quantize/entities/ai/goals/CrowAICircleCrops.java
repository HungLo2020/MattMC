...
public class CrowAICircleCrops extends MoveToBlockGoal {
    ...
    public boolean canUse() {
        return !crow.isBaby() && QServerConfig.CROWS_STEAL_CROPS.get() && (crow.getTarget() == null || !crow.getTarget().isAlive()) && !crow.isTame() && crow.fleePumpkinFlag == 0 && !crow.aiItemFlag && super.canUse();
    }

    public boolean canContinueToUse() {
        return blockPos != null && QServerConfig.CROWS_STEAL_CROPS.get() && (crow.getTarget() == null || !crow.getTarget().isAlive()) && !crow.isTame() && !crow.aiItemFlag && crow.fleePumpkinFlag == 0 && super.canContinueToUse();
    }
    ...
    protected boolean isValidTarget(LevelReader worldIn, BlockPos pos) {
        return worldIn.getBlockState(pos).is(QTags.CROW_FOODBLOCKS);
    }
}
