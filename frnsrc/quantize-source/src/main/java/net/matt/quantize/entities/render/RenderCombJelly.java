...
import net.matt.quantize.entities.models.ModelCombJelly;
import net.matt.quantize.entities.mobs.EntityCombJelly;
...
public class RenderCombJelly extends MobRenderer<EntityCombJelly, ModelCombJelly> {
    private static final ResourceLocation TEXTURE_0 = new ResourceIdentifier("textures/model/entity/comb_jelly/comb_jelly_blue.png");
    private static final ResourceLocation TEXTURE_1 = new ResourceIdentifier("textures/model/entity/comb_jelly/comb_jelly_green.png");
    private static final ResourceLocation TEXTURE_2 = new ResourceIdentifier("textures/model/entity/comb_jelly/comb_jelly_red.png");
    private static final ResourceLocation TEXTURE_OVERLAY = new ResourceIdentifier("textures/model/entity/comb_jelly/comb_jelly_overlay.png");
