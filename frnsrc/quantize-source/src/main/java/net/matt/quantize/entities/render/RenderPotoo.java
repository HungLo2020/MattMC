...
import net.matt.quantize.entities.models.ModelPotoo;
import net.matt.quantize.entities.mobs.EntityPotoo;
...
public class RenderPotoo extends MobRenderer<EntityPotoo, ModelPotoo> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/potoo/potoo.png");
