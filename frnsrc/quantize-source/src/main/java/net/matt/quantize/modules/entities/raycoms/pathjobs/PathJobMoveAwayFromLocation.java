...
import net.matt.quantize.modules.entities.raycoms.MNode;
import net.matt.quantize.modules.entities.raycoms.Pathfinding;
...
public class PathJobMoveAwayFromLocation extends AbstractPathJob {
    ...
    protected Path search() {
        if (Pathfinding.isDebug()) {
            Quantize.LOGGER.info(String.format("Pathfinding from [%d,%d,%d] away from [%d,%d,%d]",
