...
public class PersonalSuperBatteryItem extends Item implements IEnergyItem {

    public static final int CAPACITY = 1000000;
    public static final int TRANSFER = 1000;
    public static final int ENERGY_USE = 1;

    public PersonalSuperBatteryItem(Properties properties) {
        super(properties);
    }
    ...
    public static void onPlayerTick(PlayerTickEvent event) {
        ...
        if (offhandItem.getItem() instanceof PersonalSuperBatteryItem) {
    ...
    public boolean isWirelessChargeable() {
        return true; // JetpackItem does not support wireless charging
    }
