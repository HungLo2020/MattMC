...
public class EntityTossedItem extends ThrowableItemProjectile {
    ...
    public EntityTossedItem(Level worldIn, LivingEntity throwerIn) {
        super(QEntities.TOSSED_ITEM.get(), throwerIn, worldIn);
    }

    public static EntityTossedItem create(EntityType<EntityTossedItem> type, Level level) {
        return new EntityTossedItem(type, level);
    }

    public EntityTossedItem(Level worldIn, double x, double y, double z) {
        super(QEntities.TOSSED_ITEM.get(), x, y, z, worldIn);
    }

    public EntityTossedItem(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this(QEntities.TOSSED_ITEM.get(), world);
    }
    ...
    protected Item getDefaultItem() {
        return isDart() ? QItems.ANCIENT_DART.get() : Items.COBBLESTONE;
    }
}
