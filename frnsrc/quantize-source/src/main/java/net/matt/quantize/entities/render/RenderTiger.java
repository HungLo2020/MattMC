...
import net.matt.quantize.entities.models.ModelTiger;
import net.matt.quantize.entities.layer.LayerTigerEyes;
import net.matt.quantize.entities.mobs.EntityTiger;
...
public class RenderTiger extends MobRenderer<EntityTiger, ModelTiger> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/tiger/tiger.png");
    private static final ResourceLocation TEXTURE_ANGRY = new ResourceIdentifier("textures/model/entity/tiger/tiger_angry.png");
    private static final ResourceLocation TEXTURE_SLEEPING = new ResourceIdentifier("textures/model/entity/tiger/tiger_sleeping.png");
    private static final ResourceLocation TEXTURE_WHITE = new ResourceIdentifier("textures/model/entity/tiger/tiger_white.png");
    private static final ResourceLocation TEXTURE_ANGRY_WHITE = new ResourceIdentifier("textures/model/entity/tiger/tiger_white_angry.png");
    private static final ResourceLocation TEXTURE_SLEEPING_WHITE = new ResourceIdentifier("textures/model/entity/tiger/tiger_white_sleeping.png");
