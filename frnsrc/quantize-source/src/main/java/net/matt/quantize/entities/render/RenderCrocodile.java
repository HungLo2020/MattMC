...
import net.matt.quantize.entities.models.ModelCrocodile;
import net.matt.quantize.entities.mobs.EntityCrocodile;
...
public class RenderCrocodile extends MobRenderer<EntityCrocodile, ModelCrocodile> {
    private static final ResourceLocation TEXTURE_0 = new ResourceIdentifier("textures/model/entity/crocodile/crocodile_0.png");
    private static final ResourceLocation TEXTURE_1 = new ResourceIdentifier("textures/model/entity/crocodile/crocodile_1.png");
    private static final ResourceLocation TEXTURE_CROWN = new ResourceIdentifier("textures/model/entity/crocodile/crocodile_crown.png");
