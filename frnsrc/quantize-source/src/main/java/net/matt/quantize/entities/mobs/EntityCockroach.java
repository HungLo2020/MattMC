...
import net.matt.quantize.entities.ai.goals.AnimalAIFleeLight;
...
public class EntityCockroach extends Animal implements Shearable, net.minecraftforge.common.IForgeShearable, ITargetsDroppedItems {
    ...
    public static final ResourceLocation MARACA_LOOT = new ResourceIdentifier("entities/cockroach_maracas");
    public static final ResourceLocation MARACA_HEADLESS_LOOT = new ResourceIdentifier("entities/cockroach_maracas_headless");
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.COCKROACH_HURT.get();
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.0D, Ingredient.of(QTags.COCKROACH_FOODSTUFFS), false));
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(QTags.COCKROACH_BREEDABLES);
    }
    ...
    public InteractionResult mobInteract(Player p_230254_1_, InteractionHand p_230254_2_) {
       ...
       if (lvt_3_1_.getItem() == QItems.MARACA.get() && this.isAlive() && !this.hasMaracas()) {
            this.setMaracas(true);
            lvt_3_1_.shrink(1);
            return InteractionResult.sidedSuccess(this.level().isClientSide);
        } else if (lvt_3_1_.getItem() != QItems.MARACA.get() && this.isAlive() && this.hasMaracas()) {
            this.setMaracas(false);
            this.setDancing(false);
            this.spawnAtLocation(new ItemStack(QItems.MARACA.get()));
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide && this.isAlive() && !this.isBaby() && --this.timeUntilNextEgg <= 0) {
           ItemEntity dropped = this.spawnAtLocation(QItems.COCKROACH_OOTHECA.get());
           if(dropped != null){
    ...
    public void handleEntityEvent(byte id) {
        if (id == 67) {
            //Quantize.PROXY.onEntityStatus(this, id);
        } else {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
        final EntityCockroach roach = QEntities.COCKROACH.get().create(serverWorld);
    ...
    @Override
    public List<ItemStack> onSheared(@Nullable Player player, @javax.annotation.Nonnull ItemStack item, Level world, BlockPos pos, int fortune) {
    ...
    public boolean canTargetItem(ItemStack stack) {
        return stack.getItem().isEdible() || stack.is(QTags.COCKROACH_BREEDABLES);
    }
    ...
    public void onGetItem(ItemEntity e) {
        if (e.getItem().getItem() == QItems.MARACA.get()) {
            this.setMaracas(true);
        } else {
            ...
            this.heal(5);
            if (e.getItem().is(QTags.COCKROACH_FOODSTUFFS)) {
