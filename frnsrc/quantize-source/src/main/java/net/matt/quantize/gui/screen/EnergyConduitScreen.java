...
public class EnergyConduitScreen extends AbstractContainerScreen<EnergyConduitMenu> {
    private static final ResourceIdentifier TEXTURE =
            new ResourceIdentifier("textures/gui/generic.png");

    public EnergyConduitScreen(EnergyConduitMenu menu, Inventory inv, Component title) {
