...
public class BatteryMenu extends AbstractContainerMenu {
            ...
            MENUS.register("battery_menu",
                    () -> IForgeMenuType.create((id, inv, data) -> {
                        ...
                        if (blockEntity instanceof BatteryBlockEntity) {
                            ...
                            return new BatteryMenu(id, inv, (BatteryBlockEntity) blockEntity);
                        }
    ...
    public BatteryMenu(int id, Inventory playerInventory, BatteryBlockEntity blockEntity) {
        super(BATTERY_MENU.get(), id);
        this.blockEntity = blockEntity;
        this.addSlot(new Slot(blockEntity, 0, 79, 36));
