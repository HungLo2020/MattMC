...
import net.matt.quantize.entities.models.ModelSeal;
import net.matt.quantize.entities.layer.LayerSealItem;
...
public class RenderSeal extends MobRenderer<EntitySeal, ModelSeal> {
    private static final ResourceLocation TEXTURE_BROWN_0 = new ResourceIdentifier("textures/model/entity/seal/seal_brown_0.png");
    private static final ResourceLocation TEXTURE_BROWN_1 = new ResourceIdentifier("textures/model/entity/seal/seal_brown_1.png");
    private static final ResourceLocation TEXTURE_ARCTIC_0 = new ResourceIdentifier("textures/model/entity/seal/seal_arctic_0.png");
    private static final ResourceLocation TEXTURE_ARCTIC_1 = new ResourceIdentifier("textures/model/entity/seal/seal_arctic_1.png");
    private static final ResourceLocation TEXTURE_ARCTIC_BABY = new ResourceIdentifier("textures/model/entity/seal/seal_arctic_baby.png");
    private static final ResourceLocation TEXTURE_TEARS = new ResourceIdentifier("textures/model/entity/seal/seal_crying.png");
    private static final ResourceLocation TEXTURE_TONGUE = new ResourceIdentifier("textures/model/entity/seal/seal_tongue.png");
