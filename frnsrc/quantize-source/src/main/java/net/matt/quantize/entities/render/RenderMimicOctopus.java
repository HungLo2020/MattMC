...
import net.matt.quantize.entities.models.ModelMimicOctopus;
import net.matt.quantize.entities.mobs.EntityMimicOctopus;
...
public class RenderMimicOctopus extends MobRenderer<EntityMimicOctopus, ModelMimicOctopus> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/mimic_octopus/mimic_octopus.png");
    private static final ResourceLocation TEXTURE_OVERLAY = new ResourceIdentifier("textures/model/entity/mimic_octopus/mimic_octopus_overlay.png");
    private static final ResourceLocation TEXTURE_CREEPER = new ResourceIdentifier("textures/model/entity/mimic_octopus/mimic_octopus_creeper.png");
    private static final ResourceLocation TEXTURE_GUARDIAN = new ResourceIdentifier("textures/model/entity/mimic_octopus/mimic_octopus_guardian.png");
    private static final ResourceLocation TEXTURE_PUFFERFISH = new ResourceIdentifier("textures/model/entity/mimic_octopus/mimic_octopus_pufferfish.png");
    private static final ResourceLocation TEXTURE_MIMICUBE = new ResourceIdentifier("textures/model/entity/mimic_octopus/mimic_octopus_mimicube.png");
    private static final ResourceLocation TEXTURE_EYES = new ResourceIdentifier("textures/model/entity/mimic_octopus/mimic_octopus_eyes.png");
