...
public class EntityAnteater extends Animal implements NeutralMob, IAnimatedEntity, ITargetsDroppedItems {
    ...
    public static EntityAnteater create(EntityType<EntityAnteater> type, Level level) {
        return new EntityAnteater(type, level);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(6, new TemptGoal(this, 1.2D, Ingredient.of(QTags.ANTEATER_FOODSTUFFS), false));
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.ANTEATER_HURT.get();
    }
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(QTags.ANTEATER_BREEDABLES);
    }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        final boolean isFoodstuff = itemstack.is(QTags.ANTEATER_FOODSTUFFS);
        if (isFoodstuff) {
            ...
            if (itemstack.is(QTags.ANTEATER_BREEDABLES)) {
                return type;
            }
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob parent) {
        return QEntities.ANTEATER.get().create(level());
    }
    ...
    public boolean canTargetItem(ItemStack stack) {
        return !this.hasAntOnTongue() && stack.is(QTags.INSECT_ITEMS);
    }
