...
public class WirelessCapacitorScreen extends AbstractContainerScreen<WirelessCapacitorMenu> {
    private static final ResourceIdentifier TEXTURE =
            new ResourceIdentifier("textures/gui/generic.png");

    public WirelessCapacitorScreen(WirelessCapacitorMenu menu, Inventory inv, Component title) {
