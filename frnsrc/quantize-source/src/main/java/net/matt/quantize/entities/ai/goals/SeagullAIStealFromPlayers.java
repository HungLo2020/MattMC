...
public class SeagullAIStealFromPlayers extends Goal {
    ...
    private static final boolean seagullStealing = true; // Placeholder for config check
    ...
    public boolean canUse() {
        ...
        if (this.seagull.getNoActionTime() >= 100 && worldTime != 0 || seagull.isSitting() || !seagullStealing) {
            return false;
        }
    ...
    private boolean isBlacklisted(ItemStack stack){
        ...
        if(loc != null){
            for(String str : seagullStealingBlacklist){
