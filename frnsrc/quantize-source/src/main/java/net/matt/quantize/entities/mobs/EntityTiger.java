...
import net.matt.quantize.entities.ai.goals.AnimalAIPanicBaby;
...
import net.matt.quantize.entities.ai.controllers.MovementControllerCustomCollisions;
...
import net.matt.quantize.modules.entities.ICustomCollisions;
...
public class EntityTiger extends Animal implements ICustomCollisions, IAnimatedEntity, NeutralMob, ITargetsDroppedItems {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, LivingEntity.class, 220, false, false, QEntities.buildPredicateFromTag(QTags.TIGER_TARGETS)) {
    ...
    protected SoundEvent getAmbientSound() {
        return isStealth() ? super.getAmbientSound() : getRemainingPersistentAngerTime() > 0 ? QSounds.TIGER_ANGRY.get() : QSounds.TIGER_IDLE.get();
    }
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(QTags.TIGER_BREEDABLES);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        ...
        EntityTiger baby = QEntities.TIGER.get().create(p_241840_1_);
    ...
    class AttackPlayerGoal extends NearestAttackableTargetGoal<Player> {
        ...
        public AttackPlayerGoal() {
            super(EntityTiger.this, Player.class, 100, false, true, null);
        }
