...
import net.matt.quantize.entities.models.ModelKomodoDragon;
import net.matt.quantize.entities.mobs.EntityKomodoDragon;
...
public class RenderKomodoDragon extends MobRenderer<EntityKomodoDragon, ModelKomodoDragon> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/komodo_dragon/komodo_dragon.png");
    private static final ResourceLocation TEXTURE_SADDLE = new ResourceIdentifier("textures/model/entity/komodo_dragon/komodo_dragon_saddle.png");
    private static final ResourceLocation TEXTURE_MAID = new ResourceIdentifier("textures/model/entity/komodo_dragon/komodo_dragon_maid.png");
