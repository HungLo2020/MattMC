...
import net.matt.quantize.entities.models.ModelUnderminerDwarf;
import net.matt.quantize.entities.QModelLayers;
import net.matt.quantize.entities.layer.LayerUnderminerItem;
import net.matt.quantize.entities.mobs.EntityUnderminer;
...
public class RenderUnderminer extends MobRenderer<EntityUnderminer, EntityModel<EntityUnderminer>> {
    private static final ResourceLocation TEXTURE_DWARF = new ResourceIdentifier("textures/model/entity/underminer/underminer_dwarf.png");
    private static final ResourceLocation TEXTURE_0 = new ResourceIdentifier("textures/model/entity/underminer/underminer_0.png");
    private static final ResourceLocation TEXTURE_1 = new ResourceIdentifier("textures/model/entity/underminer/underminer_1.png");
    public static final List<ResourceLocation> BREAKING_LOCATIONS = IntStream.range(0, 10).mapToObj((destroyStage) -> new ResourceIdentifier("textures/block/ghostly_pickaxe/destroy_stage_" + destroyStage + ".png")).collect(Collectors.toList());
    ...
    public RenderUnderminer(EntityRendererProvider.Context renderManagerIn) {
        ...
        NORMAL_MODEL = new HumanoidModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(QModelLayers.UNDERMINER));
