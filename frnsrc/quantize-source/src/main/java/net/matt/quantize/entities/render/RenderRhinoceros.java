...
import net.matt.quantize.entities.models.ModelRhinoceros;
import net.matt.quantize.entities.mobs.EntityRhinoceros;
...
public class RenderRhinoceros extends MobRenderer<EntityRhinoceros, ModelRhinoceros> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/rhinoceros/rhinoceros.png");
    private static final ResourceLocation TEXTURE_ANGRY = new ResourceIdentifier("textures/model/entity/rhinoceros/rhinoceros_angry.png");
    private static final ResourceLocation TEXTURE_POTION = new ResourceIdentifier("textures/model/entity/rhinoceros/rhinoceros_potion.png");
