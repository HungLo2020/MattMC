...
import net.matt.quantize.entities.mobs.DinosaurSpiritEntity;
...
public class DinosaurSpiritRenderer  extends EntityRenderer<DinosaurSpiritEntity> {
    ...
    private static final ResourceLocation SUBTERRANODON_TEXTURE = new ResourceIdentifier("textures/model/entity/subterranodon/subterranodon.png");
    private static final ResourceLocation TREMORSAURUS_TEXTURE = new ResourceIdentifier("textures/model/entity/tremorsaurus/tremorsaurus.png");
    private static final ResourceLocation GROTTOCERATOPS_TEXTURE = new ResourceIdentifier("textures/model/entity/grottoceratops/grottoceratops.png");
    ...
    public void render(DinosaurSpiritEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        switch (entityIn.getDinosaurType()){
            case SUBTERRANODON:
                ...
                ivertexbuilder = bufferIn.getBuffer(QRenderTypes.getRedGhost(SUBTERRANODON_TEXTURE));
            ...
            case GROTTOCERATOPS:
                ...
                ivertexbuilder = bufferIn.getBuffer(QRenderTypes.getRedGhost(GROTTOCERATOPS_TEXTURE));
            ...
            case TREMORSAURUS:
                ...
                ivertexbuilder = bufferIn.getBuffer(QRenderTypes.getRedGhost(TREMORSAURUS_TEXTURE));
