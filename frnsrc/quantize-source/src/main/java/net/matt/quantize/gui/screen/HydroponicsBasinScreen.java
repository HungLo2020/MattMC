...
public class HydroponicsBasinScreen extends AbstractContainerScreen<HydroponicsBasinMenu> {
    private static final ResourceIdentifier TEXTURE =
            new ResourceIdentifier("textures/gui/hydroponics_basin.png");

    public HydroponicsBasinScreen(HydroponicsBasinMenu menu, Inventory inv, Component title) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        int progressBarY = (this.height - this.imageHeight) / 2 + 72;
