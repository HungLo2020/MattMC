...
import net.matt.quantize.entities.models.ModelSeagull;
import net.matt.quantize.entities.mobs.EntitySeagull;
...
public class RenderSeagull extends MobRenderer<EntitySeagull, ModelSeagull> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/seagull/seagull.png");
    private static final ResourceLocation TEXTURE_WINGULL = new ResourceIdentifier("textures/model/entity/seagull/seagull_wingull.png");
