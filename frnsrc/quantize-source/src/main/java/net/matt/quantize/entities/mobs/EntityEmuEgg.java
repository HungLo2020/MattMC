        ...
        if (!this.level().isClientSide) {
            if (this.random.nextInt(8) == 0) {
                ...
                for (int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_) {
                    EntityEmu lvt_4_1_ = QEntities.EMU.get().create(this.level());
