...
import net.matt.quantize.entities.models.TephraModel;
...
public class TephraRenderer extends EntityRenderer<TephraEntity> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/tephra/tephra.png");
    private static final TephraModel MODEL = new TephraModel();
    private static final ResourceLocation TRAIL_TEXTURE = new ResourceIdentifier("textures/particle/teletor_trail.png");
    ...
    public void render(TephraEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        VertexConsumer ivertexbuilder2 = bufferIn.getBuffer(QRenderTypes.getEyesAlphaEnabled(TEXTURE));
