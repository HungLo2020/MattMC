...
public class ArchaicVineBlock extends GrowingPlantHeadBlock {
    ...
    public ArchaicVineBlock() {
        super(Properties.of().mapColor(MapColor.COLOR_GREEN).randomTicks().noCollission().instabreak().sound(SoundType.VINE), Direction.DOWN, SHAPE, false, 0.1D);
    }
    ...
    protected Block getBodyBlock() {
        return QBlocks.ARCHAIC_VINE_PLANT.get();
    }
