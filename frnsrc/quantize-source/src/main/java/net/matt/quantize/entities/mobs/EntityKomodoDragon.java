...
public class EntityKomodoDragon extends TamableAnimal implements ITargetsDroppedItems, IFollower {
    ...
    private static final Ingredient TEMPTATION_ITEMS = Ingredient.of(QTags.KOMODO_DRAGON_TAMEABLES);
    ...
    public static <T extends Mob> boolean canKomodoDragonSpawn(EntityType<? extends Animal> animal, LevelAccessor worldIn, MobSpawnType reason, BlockPos pos, RandomSource random) {
        boolean spawnBlock = worldIn.getBlockState(pos.below()).is(QTags.KOMODO_DRAGON_SPAWNS);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(8, new EntityAINearestTarget3D(this, LivingEntity.class, 180, false, true, QEntities.buildPredicateFromTag(QTags.KOMODO_DRAGON_TARGETS)));
    }
    ...
    protected SoundEvent getAmbientSound() {
        return QSounds.KOMODO_DRAGON_IDLE.get();
    }

    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.KOMODO_DRAGON_HURT.get();
    }
    ...
    public boolean isFood(ItemStack stack) {
        ...
        return isTame() && stack.is(QTags.KOMODO_DRAGON_BREEDABLES);
    }
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide && this.isAlive() && !this.isBaby() && --this.timeUntilSpit <= 0) {
            this.spawnAtLocation(QItems.KOMODO_SPIT.get());
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if(itemstack.is(QTags.KOMODO_DRAGON_TAMEABLES)){
            if(!isTame()){
    ...
    public EntityKomodoDragon(EntityType type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        return QEntities.KOMODO_DRAGON.get().create(p_241840_1_);
    }

    @Override
    public boolean canTargetItem(ItemStack stack) {
        return stack.is(QTags.KOMODO_DRAGON_TAMEABLES) || stack.getItem().getFoodProperties() != null && stack.getItem().getFoodProperties().isMeat();
    }
