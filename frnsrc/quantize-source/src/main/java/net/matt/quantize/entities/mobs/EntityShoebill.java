...
public class EntityShoebill extends Animal implements IAnimatedEntity, ITargetsDroppedItems {
    ...
    protected SoundEvent getAmbientSound() {
        return QSounds.SHOEBILL_HURT.get();
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new TemptGoal(this, 1.1D, Ingredient.of(QTags.SHOEBILL_FOODSTUFFS), false));
    ...
    public static EntityShoebill create(EntityType<EntityShoebill> type, Level world) {
        return new EntityShoebill(type, world);
    }
    ...
    public InteractionResult mobInteract(Player p_230254_1_, InteractionHand p_230254_2_) {
        ItemStack lvt_3_1_ = p_230254_1_.getItemInHand(p_230254_2_);
         if (lvt_3_1_.is(QTags.SHOEBILL_LUCK_FOODS) && this.isAlive()) {
         ...
         } else if (lvt_3_1_.is(QTags.SHOEBILL_LURE_FOODS) && this.isAlive()) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
        return QEntities.SHOEBILL.get().create(serverWorld);
    }

    @Override
    public boolean canTargetItem(ItemStack stack) {
        return stack.is(QTags.SHOEBILL_FOODSTUFFS) || stack.is(QTags.SHOEBILL_LUCK_FOODS) && luckLevel < 10 || stack.is(QTags.SHOEBILL_LURE_FOODS) && lureLevel < 10;
    }
    ...
    public void onGetItem(ItemEntity e) {
        this.gameEvent(GameEvent.EAT);
        this.playSound(SoundEvents.CAT_EAT, this.getSoundVolume(), this.getVoicePitch());
        if (e.getItem().is(QTags.SHOEBILL_LUCK_FOODS)) {
            luckLevel = Mth.clamp(luckLevel + 1, 0, 10);
        }
        else if (e.getItem().is(QTags.SHOEBILL_LURE_FOODS)) {
            lureLevel = Mth.clamp(lureLevel + 1, 0, 10);
        }
        this.heal(5);
    }
