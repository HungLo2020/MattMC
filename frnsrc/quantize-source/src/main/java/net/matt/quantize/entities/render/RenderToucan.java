...
import net.matt.quantize.entities.models.ModelToucan;
import net.matt.quantize.entities.mobs.EntityToucan;
...
public class RenderToucan extends MobRenderer<EntityToucan, ModelToucan> {
    private static final ResourceLocation TEXTURE_0 = new ResourceIdentifier("textures/model/entity/toucan/toucan_0.png");
    private static final ResourceLocation TEXTURE_1 = new ResourceIdentifier("textures/model/entity/toucan/toucan_1.png");
    private static final ResourceLocation TEXTURE_2 = new ResourceIdentifier("textures/model/entity/toucan/toucan_2.png");
    private static final ResourceLocation TEXTURE_3 = new ResourceIdentifier("textures/model/entity/toucan/toucan_3.png");
    private static final ResourceLocation TEXTURE_GOLDEN = new ResourceIdentifier("textures/model/entity/toucan/toucan_gold.png");
    private static final ResourceLocation TEXTURE_SAM = new ResourceIdentifier("textures/model/entity/toucan/toucan_sam.png");
