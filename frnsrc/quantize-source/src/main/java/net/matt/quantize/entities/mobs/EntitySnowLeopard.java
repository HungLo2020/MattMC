...
import net.matt.quantize.entities.ai.controllers.*;
...
public class EntitySnowLeopard extends Animal implements IAnimatedEntity, ITargetsDroppedItems {
    ...
    public EntitySnowLeopard(EntityType type, Level worldIn) {
        super(type, worldIn);
    ...
    public static <T extends Mob> boolean canSnowLeopardSpawn(EntityType<EntitySnowLeopard> snowleperd, LevelAccessor worldIn, MobSpawnType reason, BlockPos p_223317_3_, RandomSource random) {
        return worldIn.getBlockState(p_223317_3_.below()).is(QTags.SNOW_LEOPARD_SPAWNS) && worldIn.getRawBrightness(p_223317_3_, 0) > 8;
    }

    public boolean isFood(ItemStack stack) {
        return stack.is(QTags.SNOW_LEOPARD_BREEDABLES);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, false, true, QEntities.buildPredicateFromTag(QTags.SNOW_LEOPARD_TARGETS)));
    ...
    protected SoundEvent getAmbientSound() {
        return QSounds.SNOW_LEOPARD_IDLE.get();
    }

    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.SNOW_LEOPARD_HURT.get();
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
        return QEntities.SNOW_LEOPARD.get().create(serverWorld);
    }
