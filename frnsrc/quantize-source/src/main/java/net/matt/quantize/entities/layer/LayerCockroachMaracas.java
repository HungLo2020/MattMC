...
import net.matt.quantize.entities.models.ModelSombrero;
import net.matt.quantize.entities.render.RenderCockroach;
...
public class LayerCockroachMaracas extends RenderLayer<EntityCockroach, ModelCockroach> {
    ...
    private static final ResourceLocation SOMBRERO_TEX = new ResourceIdentifier("textures/armor/sombrero.png");

    public LayerCockroachMaracas(RenderCockroach render, EntityRendererProvider.Context renderManagerIn) {
        super(render);
        stack = new ItemStack(QItems.MARACA.get());
        this.sombrero = new ModelSombrero(renderManagerIn.bakeLayer(QModelLayers.SOMBRERO));
