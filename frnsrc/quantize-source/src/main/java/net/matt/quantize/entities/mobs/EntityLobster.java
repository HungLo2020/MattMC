...
public class EntityLobster extends WaterAnimal implements ISemiAquatic, Bucketable {
    ...
    public EntityLobster(EntityType type, Level p_i48565_2_) {
        super(type, p_i48565_2_);
        this.setPathfindingMalus(BlockPathTypes.WATER, 0.0F);
        this.setPathfindingMalus(BlockPathTypes.WATER_BORDER, 0.0F);
    }

    public static EntityLobster create(EntityType<EntityLobster> type, Level world) {
        return new EntityLobster(type, world);
    }
    ...
    protected SoundEvent getDeathSound() {
        return QSounds.LOBSTER_HURT.get();
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(QItems.LOBSTER_BUCKET.get());
    ...
    public void tick() {
        super.tick();
        //System.out.println("EntityLobster Name: " + this.getName().getString() + ", Position: " + this.blockPosition());
        prevAttackProgress = attackProgress;
        if (this.entityData.get(ATTACK_TICK) > 0) {
            if(attackProgress == 3){
                this.playSound(QSounds.LOBSTER_ATTACK.get(), this.getSoundVolume(), this.getVoicePitch());
            }
    ...
    public static <T extends Mob> boolean canLobsterSpawn(EntityType type, LevelAccessor worldIn, MobSpawnType reason, BlockPos pos, RandomSource randomIn) {
        boolean spawnBlock = worldIn.getBlockState(pos.below()).is(QTags.LOBSTER_SPAWNABLE);
