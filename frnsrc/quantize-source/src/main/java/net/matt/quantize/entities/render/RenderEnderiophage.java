...
import net.matt.quantize.entities.models.ModelEnderiophage;
import net.matt.quantize.entities.mobs.EntityEnderiophage;
...
public class RenderEnderiophage extends MobRenderer<EntityEnderiophage, ModelEnderiophage> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/enderiophage/enderiophage.png");
    private static final ResourceLocation TEXTURE_GLOW = new ResourceIdentifier("textures/model/entity/enderiophage/enderiophage_glow.png");
    private static final ResourceLocation TEXTURE_OVERWORLD = new ResourceIdentifier("textures/model/entity/enderiophage/enderiophage_overworld.png");
    private static final ResourceLocation TEXTURE_OVERWORLD_GLOW = new ResourceIdentifier("textures/model/entity/enderiophage/enderiophage_overworld_glow.png");
    private static final ResourceLocation TEXTURE_NETHER = new ResourceIdentifier("textures/model/entity/enderiophage/enderiophage_nether.png");
    private static final ResourceLocation TEXTURE_NETHER_GLOW = new ResourceIdentifier("textures/model/entity/enderiophage/enderiophage_nether_glow.png");
