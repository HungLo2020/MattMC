...
public class ACSurfaceRuleConditionRegistry {
    ...
    public static final DeferredRegister<Codec<? extends SurfaceRules.ConditionSource>> DEF_REG = DeferredRegister.create(Registries.MATERIAL_CONDITION, Quantize.MOD_ID);
