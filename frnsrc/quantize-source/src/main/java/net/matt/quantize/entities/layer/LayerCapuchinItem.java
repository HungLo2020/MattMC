...
import net.matt.quantize.entities.models.ModelAncientDart;
import net.matt.quantize.entities.models.ModelCapuchinMonkey;
import net.matt.quantize.entities.render.RenderCapuchinMonkey;
...
public class LayerCapuchinItem extends RenderLayer<EntityCapuchinMonkey, ModelCapuchinMonkey> {
    ...
    public static final ResourceLocation DART_TEXTURE = new ResourceIdentifier("textures/model/entity/capuchin_monkey/ancient_dart.png");
