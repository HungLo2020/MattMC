...
public class EntityCombJelly extends WaterAnimal implements Bucketable {
    ...
    public static EntityCombJelly create(EntityType<EntityCombJelly> type, Level world) {
        return new EntityCombJelly(type, world);
    }
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.COMB_JELLY_HURT.get();
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(QItems.COMB_JELLY_BUCKET.get());
