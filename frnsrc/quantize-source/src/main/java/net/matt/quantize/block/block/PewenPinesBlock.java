...
public class PewenPinesBlock extends BushBlock {
    ...
    public PewenPinesBlock() {
        super(Properties.of().mapColor(DyeColor.GREEN).instabreak().sound(SoundType.ROOTS).randomTicks().offsetType(OffsetType.XZ).noOcclusion().replaceable().noCollission());
    }
