...
import net.matt.quantize.modules.biomes.EventReplaceBiome;
...
public class BiomeGenerationNoiseCondition {
    ...
    private final int quantizeRarityOffset;
    ...
    private BiomeGenerationNoiseCondition(boolean disabledCompletely, int distanceFromSpawn, int quantizeRarityOffset, float[] continentalness, float[] erosion, float[] humidity, float[] temperature, float[] weirdness, float[] depth, String[] dimensions) {
        ...
        this.depth = depth;
        this.quantizeRarityOffset = quantizeRarityOffset;
    ...
    public boolean test(EventReplaceBiome event, VoronoiGenerator.VoronoiInfo info) {
        ...
        Vec3 rareBiomeCenter = ModBiomeRarity.getRareBiomeCenter(info);
    ...
    public static final class Builder {
        ...
        public Builder quantizeRarityOffset(int rarityOffset) {
