            ...
            if(this.atlatitan.getAnimation() == IAnimatedEntity.NO_ANIMATION){
                if(distance < attackDistance + 4.0D){
                    ...
                    if(random < 0.5F && distance < attackDistance + 1.0D){
                        this.atlatitan.playSound(QSounds.ATLATITAN_KICK.get(), 3.0F, atlatitan.getVoicePitch());
                        ...
                        this.atlatitan.playSound(QSounds.ATLATITAN_TAIL.get(), 3.0F, atlatitan.getVoicePitch());
