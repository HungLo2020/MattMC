...
import net.matt.quantize.entities.ai.goals.CosmicCodAIFollowLeader;
...
public class EntityCosmicCod extends Mob implements Bucketable {
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.COSMIC_COD_HURT.get();
    }
    ...
    public static EntityCosmicCod create(EntityType<EntityCosmicCod> type, Level level) {
        return new EntityCosmicCod(type, level);
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(QItems.COSMIC_COD_BUCKET.get());
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor worldIn, DifficultyInstance difficultyIn, MobSpawnType reason, @Nullable SpawnGroupData spawnDataIn, @Nullable CompoundTag dataTag) {
        if (spawnDataIn == null) {
            ...
            this.createAndSetLeader(((GroupData) spawnDataIn).groupLeader);
        }
