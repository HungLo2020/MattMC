...
import net.matt.quantize.entities.models.ModelLeafcutterAntQueen;
import net.matt.quantize.entities.layer.LayerLeafcutterAntLeaf;
...
public class RenderLeafcutterAnt extends MobRenderer<EntityLeafcutterAnt, AdvancedEntityModel<EntityLeafcutterAnt>> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/leafcutter_ant/leafcutter_ant.png");
    private static final ResourceLocation TEXTURE_QUEEN = new ResourceIdentifier("textures/model/entity/leafcutter_ant/leafcutter_ant_queen.png");
    private static final ResourceLocation TEXTURE_ANGRY = new ResourceIdentifier("textures/model/entity/leafcutter_ant/leafcutter_ant_angry.png");
    private static final ResourceLocation TEXTURE_QUEEN_ANGRY = new ResourceIdentifier("textures/model/entity/leafcutter_ant/leafcutter_ant_queen_angry.png");
