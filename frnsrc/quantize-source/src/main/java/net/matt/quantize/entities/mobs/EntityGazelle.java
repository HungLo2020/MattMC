...
public class EntityGazelle extends Animal implements IAnimatedEntity, IHerdPanic {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.1D, Ingredient.of(QTags.GAZELLE_BREEDABLES), false));
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.GAZELLE_HURT.get();
    }
    ...
    public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
        return QEntities.rollSpawn(0, this.getRandom(), spawnReasonIn) && super.checkSpawnRules(worldIn, spawnReasonIn);
    }
    ...
    public boolean isFood(ItemStack stack) {
        return stack.is(QTags.GAZELLE_BREEDABLES);
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        return QEntities.GAZELLE.get().create(p_241840_1_);
    }
