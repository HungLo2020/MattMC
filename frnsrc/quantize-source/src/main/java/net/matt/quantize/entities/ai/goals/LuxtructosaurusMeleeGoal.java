...
import net.matt.quantize.modules.entities.raycoms.PathResult;
        ...
        if (target != null && target.isAlive()) {
            ...
            if (this.luxtructosaurus.getAnimation() == IAnimatedEntity.NO_ANIMATION) {
                if (distance < attackDistance + 4.0D) {
                    ...
                    if (random < 0.33 && this.luxtructosaurus.onGround()) {
                        ...
                        this.luxtructosaurus.playSound(QSounds.LUXTRUCTOSAURUS_ATTACK_STOMP.get(), 3.0F, this.luxtructosaurus.getVoicePitch());
                    } else if (random < 0.66 && distance < attackDistance + 1.0D) {
                        this.luxtructosaurus.playSound(QSounds.LUXTRUCTOSAURUS_KICK.get(), 3.0F, this.luxtructosaurus.getVoicePitch());
                        ...
                        this.luxtructosaurus.playSound(QSounds.LUXTRUCTOSAURUS_TAIL.get(), 3.0F, this.luxtructosaurus.getVoicePitch());
            ...
            if (successfulJumpCooldown <= 0 && navigationCheckCooldown-- < 0 && (luxtructosaurus.onGround() || luxtructosaurus.isInLava())) {
                ...
                if (!canReach(target) && this.luxtructosaurus.getAnimation() == IAnimatedEntity.NO_ANIMATION) {
                    ...
                    this.luxtructosaurus.playSound(QSounds.LUXTRUCTOSAURUS_JUMP.get(), 5.0F, this.luxtructosaurus.getVoicePitch());
