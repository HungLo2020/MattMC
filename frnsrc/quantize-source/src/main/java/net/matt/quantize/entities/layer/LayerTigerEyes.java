...
import net.matt.quantize.entities.render.RenderTiger;
...
public class LayerTigerEyes  extends RenderLayer<EntityTiger, ModelTiger> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/tiger/tiger_eyes.png");
    private static final ResourceLocation TEXTURE_WHITE = new ResourceIdentifier("textures/model/entity/tiger/tiger_white_eyes.png");
    private static final ResourceLocation TEXTURE_ANGRY = new ResourceIdentifier("textures/model/entity/tiger/tiger_angry_eyes.png");
