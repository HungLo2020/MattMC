...
import net.matt.quantize.entities.models.ModelGiantSquid;
import net.matt.quantize.entities.mobs.EntityGiantSquid;
import net.matt.quantize.entities.mobs.EntityGiantSquidPart;
...
public class RenderGiantSquid extends MobRenderer<EntityGiantSquid, ModelGiantSquid> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/giant_squid/giant_squid.png");
    private static final ResourceLocation TEXTURE_BLUE = new ResourceIdentifier("textures/model/entity/giant_squid/giant_squid_blue.png");
    private static final ResourceLocation TEXTURE_DEPRESSURIZED = new ResourceIdentifier("textures/model/entity/giant_squid/giant_squid_depressurized.png");
