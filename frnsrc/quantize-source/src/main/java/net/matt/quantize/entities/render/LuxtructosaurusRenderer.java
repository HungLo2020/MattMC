...
import net.matt.quantize.entities.models.LuxtructosaurusModel;
...
public class LuxtructosaurusRenderer extends MobRenderer<LuxtructosaurusEntity, LuxtructosaurusModel> implements CustomBookEntityRenderer {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/luxtructosaurus/luxtructosaurus.png");
    private static final ResourceLocation TEXTURE_ENRAGED = new ResourceIdentifier("textures/model/entity/luxtructosaurus/luxtructosaurus_enraged.png");
    private static final ResourceLocation TEXTURE_ENRAGED_GLOW = new ResourceIdentifier("textures/model/entity/luxtructosaurus/luxtructosaurus_enraged_glow.png");
    ...
    class LayerGlow extends RenderLayer<LuxtructosaurusEntity, LuxtructosaurusModel> {
        ...
        public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, LuxtructosaurusEntity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            VertexConsumer ivertexbuilder1 = bufferIn.getBuffer(QRenderTypes.getEyesAlphaEnabled(TEXTURE_ENRAGED_GLOW));
