...
import net.matt.quantize.entities.models.VallumraptorModel;
import net.matt.quantize.entities.mobs.VallumraptorEntity;
...
public class VallumraptorRenderer extends MobRenderer<VallumraptorEntity, VallumraptorModel> {
    private static final ResourceLocation TEXTURE = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor.png");
    private static final ResourceLocation TEXTURE_ELDER = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor_elder.png");
    private static final ResourceLocation TEXTURE_ALAN = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor_alan.png");
    private static final ResourceLocation TEXTURE_ALAN_ELDER = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor_alan_elder.png");
    private static final ResourceLocation TEXTURE_RETRO = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor_retro.png");
    private static final ResourceLocation TEXTURE_RETRO_ELDER = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor_retro_elder.png");

    private static final ResourceLocation TEXTURE_TECTONIC = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor_tectonic.png");
    private static final ResourceLocation TEXTURE_TECTONIC_ELDER = new ResourceIdentifier("textures/model/entity/vallumraptor/vallumraptor_tectonic_elder.png");
