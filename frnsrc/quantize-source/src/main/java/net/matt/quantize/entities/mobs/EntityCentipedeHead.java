...
public class EntityCentipedeHead extends Monster {
    ...
    public boolean checkSpawnRules(LevelAccessor worldIn, MobSpawnType spawnReasonIn) {
        return QEntities.rollSpawn(1, this.getRandom(), spawnReasonIn) && super.checkSpawnRules(worldIn, spawnReasonIn);
    }
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
        return QSounds.CENTIPEDE_HURT.get();
    }
    ...
    protected void playStepSound(BlockPos pos, BlockState blockIn) {
        this.playSound(QSounds.CENTIPEDE_WALK.get(), 1F, 1.0F);
    }
    ...
    public boolean doHurtTarget(Entity entityIn) {
        if (super.doHurtTarget(entityIn)) {
            ...
            this.playSound(QSounds.CENTIPEDE_ATTACK.get(), this.getSoundVolume(), this.getVoicePitch());
    ...
    public static EntityCentipedeHead create(EntityType<EntityCentipedeHead> type, Level level) {
        return new EntityCentipedeHead(type, level);
    }
    ...
    public EntityCentipedeBody createBody(LivingEntity parent, boolean tail) {
        return tail ? new EntityCentipedeBody(QEntities.CENTIPEDE_TAIL.get(), parent, 0.84F, 180, 0) : new EntityCentipedeBody(QEntities.CENTIPEDE_BODY.get(), parent, 0.84F, 180, 0);
    }
