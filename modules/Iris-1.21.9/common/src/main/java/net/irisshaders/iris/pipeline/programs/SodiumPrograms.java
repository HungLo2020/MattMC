...
import net.minecraft.client.renderer.gl.advanced.shader.GlShader;
import net.minecraft.client.renderer.gl.advanced.shader.ShaderParser;
import net.minecraft.client.renderer.gl.advanced.shader.ShaderType;
