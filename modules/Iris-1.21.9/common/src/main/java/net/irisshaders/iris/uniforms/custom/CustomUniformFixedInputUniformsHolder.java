...
import net.iris.uniforms.custom.cached.BooleanCachedUniform;
import net.iris.uniforms.custom.cached.CachedUniform;
import net.iris.uniforms.custom.cached.Float2VectorCachedUniform;
import net.iris.uniforms.custom.cached.Float3VectorCachedUniform;
import net.iris.uniforms.custom.cached.Float4MatrixCachedUniform;
import net.iris.uniforms.custom.cached.Float4VectorCachedUniform;
import net.iris.uniforms.custom.cached.FloatCachedUniform;
import net.iris.uniforms.custom.cached.Int2VectorCachedUniform;
import net.iris.uniforms.custom.cached.Int3VectorCachedUniform;
import net.iris.uniforms.custom.cached.IntCachedUniform;
