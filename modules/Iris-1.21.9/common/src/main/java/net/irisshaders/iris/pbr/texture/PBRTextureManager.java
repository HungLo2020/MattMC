...
import net.iris.pbr.loader.PBRTextureLoader;
import net.iris.pbr.loader.PBRTextureLoader.PBRTextureConsumer;
import net.iris.pbr.loader.PBRTextureLoaderRegistry;
