...
import net.iris.layer.GbufferPrograms;
...
import net.iris.mixinterface.LocalPlayerInterface;
import net.iris.pbr.TextureInfoCache;
import net.iris.pbr.TextureInfoCache.TextureInfo;
import net.iris.pbr.TextureTracker;
import net.iris.shaderpack.IdMap;
import net.iris.shaderpack.properties.PackDirectives;
import net.iris.uniforms.transforms.SmoothedFloat;
import net.iris.uniforms.transforms.SmoothedVec2f;
