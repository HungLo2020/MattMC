...
import net.iris.shaderpack.materialmap.BlockEntry;
import net.iris.shaderpack.materialmap.BlockRenderType;
import net.iris.shaderpack.materialmap.Entry;
import net.iris.shaderpack.materialmap.LegacyIdMap;
import net.iris.shaderpack.materialmap.NamespacedId;
import net.iris.shaderpack.materialmap.TagEntry;
