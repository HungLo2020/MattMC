...
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeApplyShaderRenderEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeBufferRenderEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeDeferredRenderEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeGenericObjectRenderEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeGenericRenderSetupEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeRenderCleanupEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeRenderEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeRenderPassEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeRenderSetupEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiBeforeTextureClearEvent;
import net.distant_horizons.api.methods.events.abstractEvents.DhApiColorDepthTextureCreatedEvent;
