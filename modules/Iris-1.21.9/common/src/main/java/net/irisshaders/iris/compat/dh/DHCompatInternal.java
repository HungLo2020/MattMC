...
import net.iris.compat.dh.DhFrameBufferWrapper;
import net.iris.compat.dh.IrisGenericRenderProgram;
import net.iris.compat.dh.IrisLodRenderProgram;
...
import net.iris.gl.texture.DepthCopyStrategy;
...
import net.iris.targets.DepthTexture;
