...
public class SodiumFabricMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        HookRegistry.registerChunkStatusHook(new SodiumChunkStatusHook());
        HookRegistry.registerWindowCreationHook(new SodiumWindowCreationHook());
        HookRegistry.registerRenderContextHook(new SodiumRenderContextHook());
    }
}
