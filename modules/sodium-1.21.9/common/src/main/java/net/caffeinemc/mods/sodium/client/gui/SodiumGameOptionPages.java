...
import net.minecraft.client.renderer.sodium.gui.options.binding.compat.VanillaBooleanOptionBinding;
import net.minecraft.client.renderer.sodium.gui.options.control.*;
import net.minecraft.client.renderer.sodium.gui.options.storage.MinecraftOptionsStorage;
import net.minecraft.client.renderer.sodium.gui.options.storage.SodiumOptionsStorage;
