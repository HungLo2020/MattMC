package net.minecraft.client.renderer.chunk.advanced.region;
...
import net.minecraft.client.renderer.chunk.advanced.translucent_sorting.data.SharedIndexSorter;
