...
public final class SystemProperties {
	...
	// skip runtime mod discovery and use hardcoded internal mods (Sodium, Iris) - part of deep integration plan
	public static final String SKIP_MOD_DISCOVERY = "fabric.skipModDiscovery";
