...
import net.distant_horizons.api.methods.events.DhApiEventRegister;
...
import net.distant_horizons.fabric.testing.TestChunkInputReplacerEvent;
import net.distant_horizons.fabric.testing.TestWorldGenBindingEvent;
