...
public class RealmsBackupScreen extends RealmsScreen {
	...
	class Entry extends ContainerObjectSelectionList.Entry<RealmsBackupScreen.Entry> {
				...
				this.changesButton = Button.builder(
					...
					.createNarration(
						supplier -> CommonComponents.joinForNarration(
							new Component[]{Component.translatable("mco.backup.narration", new Object[]{this.getShortBackupDate()}), (Component)supplier.get()}
						)
					)
					.build();
		...
		private void restoreClicked() {
			...
			Component component2 = Component.translatable("mco.configure.world.restore.question.line1", new Object[]{this.getShortBackupDate(), component});
			RealmsBackupScreen.this.minecraft
				.setScreen(
		...
		public void renderContent(GuiGraphics guiGraphics, int i, int j, boolean bl, float f) {
			...
			int l = k - 9 - 2;
			int m = k + 2;
			int n = this.backup.isUploadedVersion() ? -8388737 : -1;
			guiGraphics.drawString(
				RealmsBackupScreen.this.font,
				Component.translatable("mco.backup.entry", new Object[]{RealmsUtil.convertToAgePresentationFromInstant(this.backup.lastModifiedDate)}),
				this.getContentX(),
				l,
				n
			);
			guiGraphics.drawString(RealmsBackupScreen.this.font, this.getMediumDatePresentation(this.backup.lastModifiedDate), this.getContentX(), m, -11776948);
			int o = 0;
			int p = this.getContentYMiddle() - 10;
			if (this.restoreButton != null) {
				o += this.restoreButton.getWidth() + 8;
				this.restoreButton.setX(this.getContentRight() - o);
				this.restoreButton.setY(p);
				this.restoreButton.render(guiGraphics, i, j, f);
			}

			if (this.changesButton != null) {
				o += this.changesButton.getWidth() + 8;
				this.changesButton.setX(this.getContentRight() - o);
