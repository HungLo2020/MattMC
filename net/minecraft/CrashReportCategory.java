...
public class CrashReportCategory {
	...
	public static void populateBlockDetails(
		CrashReportCategory crashReportCategory, LevelHeightAccessor levelHeightAccessor, BlockPos blockPos, BlockState blockState
	) {
		crashReportCategory.setDetail("Block", blockState::toString);
		populateBlockLocationDetails(crashReportCategory, levelHeightAccessor, blockPos);
	}

	public static CrashReportCategory populateBlockLocationDetails(
		CrashReportCategory crashReportCategory, LevelHeightAccessor levelHeightAccessor, BlockPos blockPos
	) {
		return crashReportCategory.setDetail("Block location", (CrashReportDetail<String>)(() -> formatLocation(levelHeightAccessor, blockPos)));
	}
