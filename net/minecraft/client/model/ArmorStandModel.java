...
public class ArmorStandModel extends ArmorStandArmorModel {
	...
	public void setupAnim(ArmorStandRenderState armorStandRenderState) {
		...
		this.rightBodyStick.xRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.x();
		this.rightBodyStick.yRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.y();
		this.rightBodyStick.zRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.z();
		this.leftBodyStick.xRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.x();
		this.leftBodyStick.yRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.y();
		this.leftBodyStick.zRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.z();
		this.shoulderStick.xRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.x();
		this.shoulderStick.yRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.y();
		this.shoulderStick.zRot = (float) (Math.PI / 180.0) * armorStandRenderState.bodyPose.z();
	}
