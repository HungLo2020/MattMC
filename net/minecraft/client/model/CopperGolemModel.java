...
public class CopperGolemModel extends EntityModel<CopperGolemRenderState> implements ArmedModel<CopperGolemRenderState>, HeadedModel {
	...
	public void setupAnim(CopperGolemRenderState copperGolemRenderState) {
		...
		this.head.xRot = copperGolemRenderState.xRot * (float) (Math.PI / 180.0);
		this.head.yRot = copperGolemRenderState.yRot * (float) (Math.PI / 180.0);
		if (copperGolemRenderState.rightHandItem.isEmpty() && copperGolemRenderState.leftHandItem.isEmpty()) {
	...
	public void translateToHand(CopperGolemRenderState copperGolemRenderState, HumanoidArm humanoidArm, PoseStack poseStack) {
		...
		if (copperGolemRenderState.copperGolemState.equals(CopperGolemState.IDLE)) {
			poseStack.mulPose(Axis.YP.rotationDegrees(humanoidArm == HumanoidArm.RIGHT ? -90.0F : 90.0F));
