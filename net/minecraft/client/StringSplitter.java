...
public class StringSplitter {
	...
	public int plainIndexAtWidth(String string, int i, Style style) {
		StringSplitter.WidthLimitedCharSink widthLimitedCharSink = new StringSplitter.WidthLimitedCharSink(i);
	...
	public FormattedText headByWidth(FormattedText formattedText, int i, Style style) {
		final StringSplitter.WidthLimitedCharSink widthLimitedCharSink = new StringSplitter.WidthLimitedCharSink(i);
		return (FormattedText)formattedText.visit(new StyledContentConsumer<FormattedText>() {
	...
	public int findLineBreak(String string, int i, Style style) {
		StringSplitter.LineBreakFinder lineBreakFinder = new StringSplitter.LineBreakFinder(i);
	...
	public List<FormattedText> splitLines(FormattedText formattedText, int i, Style style) {
		List<FormattedText> list = Lists.<FormattedText>newArrayList();
		this.splitLines(formattedText, i, style, (BiConsumer<FormattedText, Boolean>)((formattedTextx, boolean_) -> list.add(formattedTextx)));
		return list;
	}
	...
	public List<FormattedText> splitLines(FormattedText formattedText, int i, Style style, FormattedText formattedText2) {
		...
		this.splitLines(
			...
			i,
			style,
			(BiConsumer<FormattedText, Boolean>)((formattedText2x, boolean_) -> list.add(
				boolean_ ? FormattedText.composite(new FormattedText[]{formattedText2, formattedText2x}) : formattedText2x
			))
		);
		return list;
	}
