...
public class ChatListener {
	private static final Component CHAT_VALIDATION_ERROR = Component.translatable("chat.validation_error")
	...
	public void handleChatMessageError(UUID uUID, @Nullable MessageSignature messageSignature, Bound bound) {
	...
	public void handleDisguisedChatMessage(Component component, Bound bound) {
		Instant instant = Instant.now();
		this.handleMessage(null, () -> {
