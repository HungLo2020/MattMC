...
public class TextFieldHelper {
	...
	public boolean charTyped(CharacterEvent characterEvent) {
		if (characterEvent.isAllowedChatCharacter()) {
			this.insertText((String)this.getMessageFn.get(), characterEvent.codepointAsString());
		}
	...
	public boolean keyPressed(KeyEvent keyEvent) {
		if (keyEvent.isSelectAll()) {
			...
			TextFieldHelper.CursorStep cursorStep = keyEvent.hasControlDown() ? TextFieldHelper.CursorStep.WORD : TextFieldHelper.CursorStep.CHARACTER;
			if (keyEvent.key() == 259) {
