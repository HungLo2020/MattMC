...
public class LoadingDotsWidget extends AbstractWidget {
	...
	protected void renderWidget(GuiGraphics guiGraphics, int i, int j, float f) {
		...
		guiGraphics.drawString(this.font, component, k - this.font.width(component) / 2, l - 9, -1);
		String string = LoadingDotsText.get(Util.getMillis());
		guiGraphics.drawString(this.font, string, k - this.font.width(string) / 2, l + 9, -8355712);
	}
