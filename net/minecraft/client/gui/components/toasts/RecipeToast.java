...
public class RecipeToast implements Toast {
	...
	public void update(ToastManager toastManager, long l) {
		...
		if (this.recipeItems.isEmpty()) {
			...
			this.wantedVisibility = l - this.lastChanged >= 5000.0 * toastManager.getNotificationDisplayTimeMultiplier() ? Toast.Visibility.HIDE : Toast.Visibility.SHOW;
		}

		this.displayedRecipeIndex = (int)(
			l / Math.max(1.0, 5000.0 * toastManager.getNotificationDisplayTimeMultiplier() / this.recipeItems.size()) % this.recipeItems.size()
		);
	}
