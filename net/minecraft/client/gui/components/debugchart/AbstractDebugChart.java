...
public abstract class AbstractDebugChart {
	...
	public void drawChart(GuiGraphics guiGraphics, int i, int j) {
		...
		if (p > 0) {
			...
			String string2 = this.toDisplayString((double)l / p) + " avg";
			String string3 = this.toDisplayString(n) + " max";
			guiGraphics.drawString(this.font, string, i + 2, k - 60 - 9, -2039584);
			guiGraphics.drawCenteredString(this.font, string2, i + j / 2, k - 60 - 9, -2039584);
			guiGraphics.drawString(this.font, string3, i + j - this.font.width(string3) - 2, k - 60 - 9, -2039584);
		}
	...
	protected void drawStringWithShade(GuiGraphics guiGraphics, String string, int i, int j) {
		guiGraphics.fill(i, j, i + this.font.width(string) + 1, j + 9, -1873784752);
