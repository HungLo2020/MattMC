...
public class ReportReasonSelectionScreen extends Screen {
	...
	protected void init() {
		...
		ReportReasonSelectionScreen.ReasonSelectionList.Entry entry = (ReportReasonSelectionScreen.ReasonSelectionList.Entry)Optionull.map(
	...
	public void render(GuiGraphics guiGraphics, int i, int j, float f) {
		...
		guiGraphics.submitOutline(this.descriptionLeft(), this.descriptionTop(), this.descriptionWidth(), this.descriptionHeight(), -1);
	...
	public class ReasonSelectionList extends ObjectSelectionList<ReportReasonSelectionScreen.ReasonSelectionList.Entry> {
		...
		public class Entry extends ObjectSelectionList.Entry<ReportReasonSelectionScreen.ReasonSelectionList.Entry> {
			...
			public void renderContent(GuiGraphics guiGraphics, int i, int j, boolean bl, float f) {
				...
				int l = this.getContentY() + (this.getContentHeight() - 9) / 2 + 1;
