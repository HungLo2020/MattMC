...
public class NameReportScreen extends AbstractReportScreen<NameReport.Builder> {
	...
	protected void addContent() {
		...
		this.layout
			.addChild(
				new StringWidget(Component.translatable("gui.abuseReport.name.reporting", new Object[]{component}), this.font),
	...
	public boolean mouseReleased(MouseButtonEvent mouseButtonEvent) {
		if (super.mouseReleased(mouseButtonEvent)) {
			...
			return this.commentBox != null ? this.commentBox.mouseReleased(mouseButtonEvent) : false;
		}
	}
}
