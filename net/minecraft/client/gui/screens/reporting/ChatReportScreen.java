...
public class ChatReportScreen extends AbstractReportScreen<ChatReport.Builder> {
	...
	protected void onReportChanged() {
		...
		if (intSet.isEmpty()) {
			...
			this.selectMessagesButton.setMessage(Component.translatable("gui.chatReport.selected_chat", new Object[]{intSet.size()}));
		}
	...
	public boolean mouseReleased(MouseButtonEvent mouseButtonEvent) {
		return super.mouseReleased(mouseButtonEvent) ? true : this.commentBox.mouseReleased(mouseButtonEvent);
	}
}
