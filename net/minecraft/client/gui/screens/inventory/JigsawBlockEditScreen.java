...
public class JigsawBlockEditScreen extends Screen {
	...
	private CycleButton<JointType> jointButton;
	...
	protected void init() {
		...
		this.jointButton = this.addRenderableWidget(
			CycleButton.<JointType>builder(JointType::getTranslatedName)
				.withValues(JointType.values())
		...
		this.addRenderableWidget(new AbstractSliderButton(this.width / 2 - 154, 185, 100, 20, CommonComponents.EMPTY, 0.0) {
			...
			protected void updateMessage() {
				this.setMessage(Component.translatable("jigsaw_block.levels", new Object[]{JigsawBlockEditScreen.this.levels}));
			}
	...
	public void resize(Minecraft minecraft, int i, int j) {
		...
		int k = this.levels;
		JointType jointType = this.joint;
	...
	public boolean keyPressed(KeyEvent keyEvent) {
		if (super.keyPressed(keyEvent)) {
			return true;
		} else if (this.doneButton.active && keyEvent.isConfirmation()) {
			this.onDone();
			return true;
		} else {
			return false;
