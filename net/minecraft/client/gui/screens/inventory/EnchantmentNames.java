...
public class EnchantmentNames {
	private static final FontDescription ALT_FONT = new Resource(ResourceLocation.withDefaultNamespace("alt"));
	...
	public FormattedText getRandomName(Font font, int i) {
		...
		for (int k = 0; k < j; k++) {
			...
			stringBuilder.append((String)Util.getRandom(this.words, this.random));
		}
