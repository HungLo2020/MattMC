...
public class SocialInteractionsScreen extends Screen {
	...
	public Component getNarrationMessage() {
		return (Component)(this.serverLabel != null
			? CommonComponents.joinForNarration(new Component[]{super.getNarrationMessage(), this.serverLabel})
	...
	private void updateServerLabel(Minecraft minecraft) {
		...
		if (this.playerCount != i) {
			...
			if (i > 1) {
				this.serverLabel = Component.translatable("gui.socialInteractions.server_label.multiple", new Object[]{string, i});
			} else {
				this.serverLabel = Component.translatable("gui.socialInteractions.server_label.single", new Object[]{string, i});
			}
