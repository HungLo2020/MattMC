	...
	class DetailsScreen extends Screen {
		...
		class PackListEntry extends ObjectSelectionList.Entry<ConfirmExperimentalFeaturesScreen.DetailsScreen.PackListEntry> {
			...
			public void renderContent(GuiGraphics guiGraphics, int i, int j, boolean bl, float f) {
				guiGraphics.drawString(DetailsScreen.this.minecraft.font, this.packId, this.getContentX(), this.getContentY(), -1);
				this.splitMessage.render(guiGraphics, MultiLineLabel.Align.LEFT, this.getContentX(), this.getContentY() + 12, 9, true, -1);
			}
