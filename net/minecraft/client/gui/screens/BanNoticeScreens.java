...
public class BanNoticeScreens {
	...
	private static final Component SKIN_BAN_DESCRIPTION = Component.translatable(
		"gui.banned.skin.description", new Object[]{Component.translationArg(CommonLinks.SUSPENSION_HELP)}
	);
	...
	public static ConfirmLinkScreen createNameBan(String string, Runnable runnable) {
		...
		return new ConfirmLinkScreen(
			...
			Component.translatable(
				...
				new Object[]{Component.literal(string).withStyle(ChatFormatting.YELLOW), Component.translationArg(CommonLinks.SUSPENSION_HELP)}
			),
			uRI,
	...
	private static Component getBannedScreenText(BanDetails banDetails) {
		return Component.translatable(
			"gui.banned.description", new Object[]{getBanReasonText(banDetails), getBanStatusText(banDetails), Component.translationArg(CommonLinks.SUSPENSION_HELP)}
		);
	}
	...
	private static Component getBanReasonText(BanDetails banDetails) {
		...
		if (StringUtils.isNumeric(string)) {
			...
			return Component.translatable("gui.banned.description.reason", new Object[]{component});
		} else {
	...
	private static Component getBanStatusText(BanDetails banDetails) {
		if (isTemporaryBan(banDetails)) {
			...
			return Component.translatable(
				...
				new Object[]{Component.translatable("gui.banned.description.temporary.duration", new Object[]{component}).withStyle(ChatFormatting.BOLD)}
			);
		} else {
