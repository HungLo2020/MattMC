...
public class RecipeBookPage {
	...
	public void renderTooltip(GuiGraphics guiGraphics, int i, int j) {
		if (this.minecraft.screen != null && this.hoveredButton != null && !this.overlay.isVisible()) {
			...
			guiGraphics.setComponentTooltipForNextFrame(this.minecraft.font, this.hoveredButton.getTooltipText(itemStack), i, j, resourceLocation);
		}
	}
	...
	public boolean mouseClicked(MouseButtonEvent mouseButtonEvent, int i, int j, int k, int l, boolean bl) {
		...
		if (this.overlay.isVisible()) {
			...
			return true;
		} else if (this.forwardButton.mouseClicked(mouseButtonEvent, bl)) {
			this.currentPage++;
			this.updateButtonsForPage();
			return true;
		} else if (this.backButton.mouseClicked(mouseButtonEvent, bl)) {
			this.currentPage--;
			this.updateButtonsForPage();
			return true;
		} else {
			...
			for (RecipeButton recipeButton : this.buttons) {
				if (recipeButton.mouseClicked(mouseButtonEvent, bl)) {
