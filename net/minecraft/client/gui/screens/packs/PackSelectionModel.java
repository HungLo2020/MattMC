...
public class PackSelectionModel {
	...
	public PackSelectionModel(
		Consumer<PackSelectionModel.EntryBase> consumer, Function<Pack, ResourceLocation> function, PackRepository packRepository, Consumer<PackRepository> consumer2
	) {
