		...
		class HeaderEntry extends StatsScreen.ItemStatisticsList.Entry {
			...
			public void renderContent(GuiGraphics guiGraphics, int i, int j, boolean bl, float f) {
				...
				if (ItemStatisticsList.this.sortColumn != null) {
					...
					guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, resourceLocation, this.getContentX() + k, this.getContentY() + 1, 18, 18);
				}
			}
			...
			class StatSortButton extends ImageButton {
				...
				StatSortButton(final int i, final ResourceLocation resourceLocation) {
					super(
						18,
						18,
