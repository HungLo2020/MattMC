...
public abstract class IllagerRenderer<T extends AbstractIllager, S extends IllagerRenderState> extends MobRenderer<T, S, IllagerModel<S>> {
	...
	public void extractRenderState(T abstractIllager, S illagerRenderState, float f) {
		...
		ArmedEntityRenderState.extractArmedEntityRenderState(abstractIllager, illagerRenderState, this.itemModelResolver);
		...
		illagerRenderState.maxCrossbowChargeDuration = illagerRenderState.armPose == IllagerArmPose.CROSSBOW_CHARGE
