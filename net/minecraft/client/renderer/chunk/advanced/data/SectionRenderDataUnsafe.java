package net.minecraft.client.renderer.chunk.advanced.data;
...
public class SectionRenderDataUnsafe {
     ...
     * should be sourced from a monotonic sequence (see {@link net.minecraft.client.renderer.chunk.advanced.SharedQuadIndexBuffer}).
     *
