package net.minecraft.client.renderer.sodium.platform.windows.api.d3dkmt;
...
import net.minecraft.client.renderer.sodium.platform.windows.WindowsFileVersion;
import net.minecraft.client.renderer.sodium.platform.windows.api.Gdi32;
import net.minecraft.client.renderer.sodium.platform.windows.api.version.Version;
...
import static net.minecraft.client.renderer.sodium.platform.windows.api.Gdi32.*;
import static net.minecraft.client.renderer.sodium.platform.windows.api.d3dkmt.D3DKMTQueryAdapterInfoType.WDDM12.*;
