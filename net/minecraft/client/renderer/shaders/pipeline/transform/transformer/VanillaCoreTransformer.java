package net.minecraft.client.renderer.shaders.pipeline.transform.transformer;
...
import static net.minecraft.client.renderer.shaders.pipeline.transform.transformer.CommonTransformer.addIfNotExists;
