...
import net.minecraft.client.renderer.shaders.gl.IrisLimits;
...
import net.minecraft.client.renderer.shaders.gl.state.ShaderAttributeInputs;
import net.minecraft.client.renderer.shaders.texture.TextureType;
import net.minecraft.client.renderer.shaders.helpers.Tri;
import net.minecraft.client.renderer.shaders.pipeline.transform.parameter.ComputeParameters;
import net.minecraft.client.renderer.shaders.pipeline.transform.parameter.DHParameters;
import net.minecraft.client.renderer.shaders.pipeline.transform.parameter.Parameters;
import net.minecraft.client.renderer.shaders.pipeline.transform.parameter.SodiumParameters;
import net.minecraft.client.renderer.shaders.pipeline.transform.parameter.TextureStageParameters;
import net.minecraft.client.renderer.shaders.pipeline.transform.parameter.VanillaParameters;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.CommonTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.CompatibilityTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.CompositeCoreTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.CompositeTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.DHGenericTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.DHTerrainTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.LayoutTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.SodiumCoreTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.SodiumTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.TextureTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.VanillaCoreTransformer;
import net.minecraft.client.renderer.shaders.pipeline.transform.transformer.VanillaTransformer;
