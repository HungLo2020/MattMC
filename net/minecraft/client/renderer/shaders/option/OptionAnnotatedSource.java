...
import net.minecraft.client.renderer.shaders.option.values.OptionValues;
import net.minecraft.client.renderer.shaders.parsing.ParsedString;
// import net.irisshaders.iris.shaderpack.properties.PackShadowDirectives; // TODO: Replace
// import net.irisshaders.iris.shaderpack.transform.line.LineTransform; // TODO: Add when needed
...
public final class OptionAnnotatedSource {
	...
	static {
		...
		for (int i = 0; i < 8; i++){ // PackShadowDirectives.MAX_SHADOW_COLOR_BUFFERS_IRIS
