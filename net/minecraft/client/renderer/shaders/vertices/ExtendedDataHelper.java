...
/**
 * Helper for computing extended vertex data.
 * 
 * VERBATIM from IRIS: frnsrc/Iris-1.21.9/common/src/main/java/net/irisshaders/iris/vertices/ExtendedDataHelper.java
 */
