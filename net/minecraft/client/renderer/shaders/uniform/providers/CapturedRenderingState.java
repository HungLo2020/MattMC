...
/**
 * Captures and stores rendering state for use by uniforms.
 * 
 * COPIED VERBATIM from IRIS's CapturedRenderingState.java
 * Reference: frnsrc/Iris-1.21.9/.../uniforms/CapturedRenderingState.java
 * 
