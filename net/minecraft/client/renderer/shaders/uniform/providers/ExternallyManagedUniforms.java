...
import net.minecraft.client.renderer.shaders.uniform.UniformType;

/**
 * Declares uniforms that are managed by external systems (Sodium, Vanilla rendering, etc.)
 * 
 * COPIED VERBATIM from IRIS's ExternallyManagedUniforms.java
 * Reference: frnsrc/Iris-1.21.9/.../uniforms/ExternallyManagedUniforms.java
 * 
 * Step 27 of NEW-SHADER-PLAN.md
 * 
 * These uniforms are declared but not updated by this system - they are managed by:
 * - Sodium rendering system
 * - Vanilla Minecraft rendering
