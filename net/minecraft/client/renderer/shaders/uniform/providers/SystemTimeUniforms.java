 ...
 * 
 * COPIED VERBATIM from IRIS's SystemTimeUniforms.java
 * Reference: frnsrc/Iris-1.21.9/.../uniforms/SystemTimeUniforms.java
 * 
 * Step 26 of NEW-SHADER-PLAN.md
 * 
 * Uniforms provided:
 * - frameCounter: Frame counter that wraps every 720720 frames
 * - frameTime: Time taken by last frame in seconds
 * - frameTimeCounter: Cumulative time since start in seconds (resets every hour)
 */
