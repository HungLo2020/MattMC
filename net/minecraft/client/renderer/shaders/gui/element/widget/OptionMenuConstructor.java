...
import net.minecraft.client.renderer.shaders.gui.element.screen.ElementWidgetScreenData;
import net.minecraft.client.renderer.shaders.gui.screen.ShaderPackScreen;
import net.minecraft.client.renderer.shaders.shaderpack.option.menu.OptionMenuBooleanOptionElement;
...
import net.minecraft.client.renderer.shaders.shaderpack.option.menu.OptionMenuElementScreen;
import net.minecraft.client.renderer.shaders.shaderpack.option.menu.OptionMenuLinkElement;
import net.minecraft.client.renderer.shaders.shaderpack.option.menu.OptionMenuMainElementScreen;
import net.minecraft.client.renderer.shaders.shaderpack.option.menu.OptionMenuProfileElement;
import net.minecraft.client.renderer.shaders.shaderpack.option.menu.OptionMenuStringOptionElement;
import net.minecraft.client.renderer.shaders.shaderpack.option.menu.OptionMenuSubElementScreen;
