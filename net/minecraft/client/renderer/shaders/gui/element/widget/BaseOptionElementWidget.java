...
/**
 * Base class for option element widgets that display a value.
 * Provides label trimming, tooltips, value display, and keyboard navigation.
 * 
 * Adapted from IRIS 1.21.9 BaseOptionElementWidget.java
 */
