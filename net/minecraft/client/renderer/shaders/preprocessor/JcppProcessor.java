...
/**
 * JCPP-based GLSL preprocessor for processing #define, #ifdef, #include, etc.
 * 
 * VERBATIM copy from IRIS.
 * Reference: frnsrc/Iris-1.21.9/common/src/main/java/net/irisshaders/iris/shaderpack/preprocessor/JcppProcessor.java
 */
