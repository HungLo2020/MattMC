...
/**
 * Pixel format enum defining how pixel data is structured.
 * Copied VERBATIM from IRIS 1.21.9 PixelFormat.java
 */
public enum PixelFormat {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PixelFormat.class);
    ...
    public static Optional<PixelFormat> fromString(String name) {
        try {
            ...
            LOGGER.error("Looking for an illegal pixel format: " + name.toUpperCase(Locale.US));
