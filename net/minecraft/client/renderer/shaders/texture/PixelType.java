...
/**
 * Pixel type enum defining the data type of pixel components.
 * Copied VERBATIM from IRIS 1.21.9 PixelType.java
 */
public enum PixelType {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PixelType.class);
    ...
    public static Optional<PixelType> fromString(String name) {
        try {
            ...
            LOGGER.error("Failed to find pixel type " + name.toUpperCase(Locale.ROOT));
