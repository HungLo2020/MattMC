...
/**
 * Depth buffer format enum copied VERBATIM from IRIS 1.21.9.
 * Source: frnsrc/Iris-1.21.9/common/src/main/java/net/irisshaders/iris/gl/texture/DepthBufferFormat.java
 */
public enum DepthBufferFormat {
	...
	public int getGlFormat() {
		return switch (this) {
			case DEPTH, DEPTH16 -> GL30C.GL_UNSIGNED_SHORT;
			case DEPTH24, DEPTH32 -> GL30C.GL_UNSIGNED_INT;
