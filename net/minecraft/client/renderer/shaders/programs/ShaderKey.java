...
import net.minecraft.client.renderer.shaders.gl.blending.AlphaTestFunction;
import net.minecraft.client.renderer.shaders.gl.blending.AlphaTests;
...
IE_COMPAT(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.TERRAIN, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
...
IE_COMPAT_SHADOW(ProgramId.ShadowEntities, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.TERRAIN, FogMode.OFF, LightingModel.LIGHTMAP),
