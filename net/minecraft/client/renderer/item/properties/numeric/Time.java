...
public class Time extends NeedleDirectionHelper implements RangeSelectItemModelProperty {
	...
	@Override
	protected float calculate(ItemStack itemStack, ClientLevel clientLevel, int i, @Nullable ItemOwner itemOwner) {
	...
	public static enum TimeSource implements StringRepresentable {
		RANDOM("random") {
			@Override
			public float get(@Nullable ClientLevel clientLevel, ItemStack itemStack, @Nullable ItemOwner itemOwner, RandomSource randomSource) {
				return randomSource.nextFloat();
			}
		},
		DAYTIME("daytime") {
			@Override
			public float get(ClientLevel clientLevel, ItemStack itemStack, @Nullable ItemOwner itemOwner, RandomSource randomSource) {
		...
		abstract float get(ClientLevel clientLevel, ItemStack itemStack, @Nullable ItemOwner itemOwner, RandomSource randomSource);
	}
}
