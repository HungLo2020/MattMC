...
public abstract class NeedleDirectionHelper {
	...
	public float get(ItemStack itemStack, @Nullable ClientLevel clientLevel, @Nullable ItemOwner itemOwner, int i) {
		...
		if (itemOwner == null) {
			...
			if (clientLevel == null && itemOwner != null && itemOwner.level() instanceof ClientLevel clientLevel2) {
	...
	protected abstract float calculate(ItemStack itemStack, ClientLevel clientLevel, int i, @Nullable ItemOwner itemOwner);
