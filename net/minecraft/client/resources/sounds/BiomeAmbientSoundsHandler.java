...
public class BiomeAmbientSoundsHandler implements AmbientSoundHandler {
	...
	public void tick() {
		...
		Biome biome = (Biome)this.biomeManager.getNoiseBiomeAtPosition(this.player.getX(), this.player.getY(), this.player.getZ()).value();
				...
				ambientMoodSettings -> {
					...
					if (this.moodiness >= 1.0F) {
						...
						SimpleSoundInstance simpleSoundInstance = SimpleSoundInstance.forAmbientMood(
							(SoundEvent)ambientMoodSettings.getSoundEvent().value(),
							this.random,
