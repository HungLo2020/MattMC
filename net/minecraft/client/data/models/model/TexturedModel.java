...
public class TexturedModel {
	...
	public static TexturedModel.Provider createDefault(Function<Block, TextureMapping> function, ModelTemplate modelTemplate) {
	...
	public interface Provider {
		...
		default ResourceLocation create(Block block, BiConsumer<ResourceLocation, ModelInstance> biConsumer) {
			return this.get(block).create(block, biConsumer);
		}

		default ResourceLocation createWithSuffix(Block block, String string, BiConsumer<ResourceLocation, ModelInstance> biConsumer) {
