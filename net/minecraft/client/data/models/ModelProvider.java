...
public class ModelProvider implements DataProvider {
	...
	public ModelProvider(PackOutput packOutput) {
		...
		this.itemInfoPathProvider = packOutput.createPathProvider(Target.RESOURCE_PACK, "items");
	...
	static class BlockStateGeneratorCollector implements Consumer<BlockModelDefinitionGenerator> {
		...
		public void validate() {
			Stream<Reference<Block>> stream = BuiltInRegistries.BLOCK.listElements().filter(reference -> true);
		...
		public CompletableFuture<?> save(CachedOutput cachedOutput, PathProvider pathProvider) {
