...
public class GameProfileArgument implements ArgumentType<GameProfileArgument.Result> {
	...
	private static GameProfileArgument.Result parse(StringReader stringReader, boolean bl) throws CommandSyntaxException {
		if (stringReader.canRead() && stringReader.peek() == '@') {
			...
			return commandSourceStack -> {
				...
				return Collections.singleton((NameAndId)optional.orElseThrow(ERROR_UNKNOWN_PLAYER::create));
			};
		}
	}
	...
	public interface Result {
		Collection<NameAndId> getNames(CommandSourceStack commandSourceStack) throws CommandSyntaxException;
	}
	...
	public static class SelectorResult implements GameProfileArgument.Result {
		...
		public Collection<NameAndId> getNames(CommandSourceStack commandSourceStack) throws CommandSyntaxException {
			...
			if (list.isEmpty()) {
				...
				List<NameAndId> list2 = new ArrayList();
