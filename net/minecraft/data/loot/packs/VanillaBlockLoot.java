...
public class VanillaBlockLoot extends BlockLootSubProvider {
	...
	public void generate() {
		...
		Blocks.COPPER_BARS.forEach(block -> this.dropSelf(block));
		...
		Blocks.COPPER_CHAIN.forEach(block -> this.dropSelf(block));
		...
		this.add(Blocks.COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		this.add(Blocks.EXPOSED_COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		this.add(Blocks.WEATHERED_COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		this.add(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		this.add(Blocks.WAXED_COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		this.add(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		this.add(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		this.add(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, block -> this.createCopperGolemStatueBlock(block));
		...
		this.add(Blocks.RESIN_BRICK_SLAB, block -> this.createSlabItemTable(block));
		...
		this.add(Blocks.COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		this.add(Blocks.EXPOSED_COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		this.add(Blocks.WEATHERED_COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		this.add(Blocks.OXIDIZED_COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		this.add(Blocks.WAXED_COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		this.add(Blocks.WAXED_EXPOSED_COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		this.add(Blocks.WAXED_WEATHERED_COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		this.add(Blocks.WAXED_OXIDIZED_COPPER_CHEST, block -> this.createNameableBlockEntityTable(block));
		...
		this.add(Blocks.SHORT_DRY_GRASS, itemLike -> this.createShearsOrSilkTouchOnlyDrop(itemLike));
		this.add(Blocks.TALL_DRY_GRASS, itemLike -> this.createShearsOrSilkTouchOnlyDrop(itemLike));
		this.add(Blocks.BUSH, itemLike -> this.createShearsOrSilkTouchOnlyDrop(itemLike));
