...
public class VegetationPlacements {
	...
	public static void bootstrap(BootstrapContext<PlacedFeature> bootstrapContext) {
		...
		Holder<ConfiguredFeature<?, ?>> holder7 = holderGetter.getOrThrow(VegetationFeatures.PATCH_GRASS_MEADOW);
		Holder<ConfiguredFeature<?, ?>> holder8 = holderGetter.getOrThrow(VegetationFeatures.PATCH_LEAF_LITTER);
		Holder<ConfiguredFeature<?, ?>> holder9 = holderGetter.getOrThrow(VegetationFeatures.PATCH_TAIGA_GRASS);
		Holder<ConfiguredFeature<?, ?>> holder10 = holderGetter.getOrThrow(VegetationFeatures.PATCH_GRASS_JUNGLE);
		Holder<ConfiguredFeature<?, ?>> holder11 = holderGetter.getOrThrow(VegetationFeatures.SINGLE_PIECE_OF_GRASS);
		Holder<ConfiguredFeature<?, ?>> holder12 = holderGetter.getOrThrow(VegetationFeatures.PATCH_DEAD_BUSH);
		Holder<ConfiguredFeature<?, ?>> holder13 = holderGetter.getOrThrow(VegetationFeatures.PATCH_DRY_GRASS);
		Holder<ConfiguredFeature<?, ?>> holder14 = holderGetter.getOrThrow(VegetationFeatures.PATCH_FIREFLY_BUSH);
		...
		Holder<ConfiguredFeature<?, ?>> holder20 = holderGetter.getOrThrow(VegetationFeatures.PATCH_BUSH);
		Holder<ConfiguredFeature<?, ?>> holder21 = holderGetter.getOrThrow(VegetationFeatures.PATCH_CACTUS);
		Holder<ConfiguredFeature<?, ?>> holder22 = holderGetter.getOrThrow(VegetationFeatures.PATCH_SUGAR_CANE);
		Holder<ConfiguredFeature<?, ?>> holder23 = holderGetter.getOrThrow(VegetationFeatures.PATCH_BROWN_MUSHROOM);
		Holder<ConfiguredFeature<?, ?>> holder24 = holderGetter.getOrThrow(VegetationFeatures.PATCH_RED_MUSHROOM);
		Holder<ConfiguredFeature<?, ?>> holder25 = holderGetter.getOrThrow(VegetationFeatures.FLOWER_DEFAULT);
		Holder<ConfiguredFeature<?, ?>> holder26 = holderGetter.getOrThrow(VegetationFeatures.FLOWER_FLOWER_FOREST);
		Holder<ConfiguredFeature<?, ?>> holder27 = holderGetter.getOrThrow(VegetationFeatures.FLOWER_SWAMP);
		Holder<ConfiguredFeature<?, ?>> holder28 = holderGetter.getOrThrow(VegetationFeatures.FLOWER_PLAIN);
		Holder<ConfiguredFeature<?, ?>> holder29 = holderGetter.getOrThrow(VegetationFeatures.FLOWER_MEADOW);
		Holder<ConfiguredFeature<?, ?>> holder30 = holderGetter.getOrThrow(VegetationFeatures.FLOWER_CHERRY);
		Holder<ConfiguredFeature<?, ?>> holder31 = holderGetter.getOrThrow(VegetationFeatures.FLOWER_PALE_GARDEN);
		Holder<ConfiguredFeature<?, ?>> holder32 = holderGetter.getOrThrow(VegetationFeatures.WILDFLOWERS_BIRCH_FOREST);
		Holder<ConfiguredFeature<?, ?>> holder33 = holderGetter.getOrThrow(VegetationFeatures.WILDFLOWERS_MEADOW);
		Holder<ConfiguredFeature<?, ?>> holder34 = holderGetter.getOrThrow(VegetationFeatures.TREES_PLAINS);
		Holder<ConfiguredFeature<?, ?>> holder35 = holderGetter.getOrThrow(VegetationFeatures.DARK_FOREST_VEGETATION);
		Holder<ConfiguredFeature<?, ?>> holder36 = holderGetter.getOrThrow(VegetationFeatures.PALE_GARDEN_VEGETATION);
		Holder<ConfiguredFeature<?, ?>> holder37 = holderGetter.getOrThrow(VegetationFeatures.FOREST_FLOWERS);
		Holder<ConfiguredFeature<?, ?>> holder38 = holderGetter.getOrThrow(VegetationFeatures.PALE_FOREST_FLOWERS);
		Holder<ConfiguredFeature<?, ?>> holder39 = holderGetter.getOrThrow(VegetationFeatures.PALE_MOSS_PATCH);
		Holder<ConfiguredFeature<?, ?>> holder40 = holderGetter.getOrThrow(VegetationFeatures.TREES_FLOWER_FOREST);
		Holder<ConfiguredFeature<?, ?>> holder41 = holderGetter.getOrThrow(VegetationFeatures.MEADOW_TREES);
		Holder<ConfiguredFeature<?, ?>> holder42 = holderGetter.getOrThrow(VegetationFeatures.TREES_TAIGA);
		Holder<ConfiguredFeature<?, ?>> holder43 = holderGetter.getOrThrow(VegetationFeatures.TREES_BADLANDS);
		Holder<ConfiguredFeature<?, ?>> holder44 = holderGetter.getOrThrow(VegetationFeatures.TREES_GROVE);
		Holder<ConfiguredFeature<?, ?>> holder45 = holderGetter.getOrThrow(VegetationFeatures.TREES_SNOWY);
		Holder<ConfiguredFeature<?, ?>> holder46 = holderGetter.getOrThrow(TreeFeatures.CHERRY_BEES_005);
		Holder<ConfiguredFeature<?, ?>> holder47 = holderGetter.getOrThrow(TreeFeatures.SWAMP_OAK);
		Holder<ConfiguredFeature<?, ?>> holder48 = holderGetter.getOrThrow(VegetationFeatures.TREES_SAVANNA);
		Holder<ConfiguredFeature<?, ?>> holder49 = holderGetter.getOrThrow(VegetationFeatures.BIRCH_TALL);
		Holder<ConfiguredFeature<?, ?>> holder50 = holderGetter.getOrThrow(VegetationFeatures.TREES_BIRCH);
		Holder<ConfiguredFeature<?, ?>> holder51 = holderGetter.getOrThrow(VegetationFeatures.TREES_WINDSWEPT_HILLS);
		Holder<ConfiguredFeature<?, ?>> holder52 = holderGetter.getOrThrow(VegetationFeatures.TREES_WATER);
		Holder<ConfiguredFeature<?, ?>> holder53 = holderGetter.getOrThrow(VegetationFeatures.TREES_BIRCH_AND_OAK_LEAF_LITTER);
		Holder<ConfiguredFeature<?, ?>> holder54 = holderGetter.getOrThrow(VegetationFeatures.TREES_SPARSE_JUNGLE);
		Holder<ConfiguredFeature<?, ?>> holder55 = holderGetter.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA);
		Holder<ConfiguredFeature<?, ?>> holder56 = holderGetter.getOrThrow(VegetationFeatures.TREES_OLD_GROWTH_PINE_TAIGA);
		Holder<ConfiguredFeature<?, ?>> holder57 = holderGetter.getOrThrow(VegetationFeatures.TREES_JUNGLE);
		Holder<ConfiguredFeature<?, ?>> holder58 = holderGetter.getOrThrow(VegetationFeatures.BAMBOO_VEGETATION);
		Holder<ConfiguredFeature<?, ?>> holder59 = holderGetter.getOrThrow(VegetationFeatures.MUSHROOM_ISLAND_VEGETATION);
		Holder<ConfiguredFeature<?, ?>> holder60 = holderGetter.getOrThrow(VegetationFeatures.MANGROVE_VEGETATION);
		...
		PlacementUtils.register(bootstrapContext, PATCH_LEAF_LITTER, holder8, worldSurfaceSquaredWithCount(2));
		PlacementUtils.register(
		...
		PlacementUtils.register(
			bootstrapContext, PATCH_GRASS_TAIGA_2, holder9, InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()
		);
		PlacementUtils.register(bootstrapContext, PATCH_GRASS_TAIGA, holder9, worldSurfaceSquaredWithCount(7));
		PlacementUtils.register(bootstrapContext, PATCH_GRASS_JUNGLE, holder10, worldSurfaceSquaredWithCount(25));
		PlacementUtils.register(bootstrapContext, GRASS_BONEMEAL, holder11, PlacementUtils.isEmpty());
		PlacementUtils.register(bootstrapContext, PATCH_DEAD_BUSH_2, holder12, worldSurfaceSquaredWithCount(2));
		...
		PlacementUtils.register(bootstrapContext, PATCH_DEAD_BUSH_BADLANDS, holder12, worldSurfaceSquaredWithCount(20));
		PlacementUtils.register(
			bootstrapContext,
		...
		PlacementUtils.register(
			bootstrapContext, PATCH_BUSH, holder20, RarityFilter.onAverageOnceEvery(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
		);
		PlacementUtils.register(
			bootstrapContext,
			PATCH_CACTUS_DESERT,
		...
		PlacementUtils.register(
			bootstrapContext, PATCH_SUGAR_CANE, holder22, RarityFilter.onAverageOnceEvery(6), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
		);
		PlacementUtils.register(
			bootstrapContext,
		...
		PlacementUtils.register(bootstrapContext, BROWN_MUSHROOM_NORMAL, holder23, getMushroomPlacement(256, null));
		PlacementUtils.register(bootstrapContext, RED_MUSHROOM_NORMAL, holder24, getMushroomPlacement(512, null));
		PlacementUtils.register(bootstrapContext, BROWN_MUSHROOM_TAIGA, holder23, getMushroomPlacement(4, null));
		PlacementUtils.register(bootstrapContext, RED_MUSHROOM_TAIGA, holder24, getMushroomPlacement(256, null));
		PlacementUtils.register(bootstrapContext, BROWN_MUSHROOM_OLD_GROWTH, holder23, getMushroomPlacement(4, CountPlacement.of(3)));
		PlacementUtils.register(bootstrapContext, RED_MUSHROOM_OLD_GROWTH, holder24, getMushroomPlacement(171, null));
		PlacementUtils.register(bootstrapContext, BROWN_MUSHROOM_SWAMP, holder23, getMushroomPlacement(0, CountPlacement.of(2)));
		PlacementUtils.register(bootstrapContext, RED_MUSHROOM_SWAMP, holder24, getMushroomPlacement(64, null));
		PlacementUtils.register(
			bootstrapContext, FLOWER_WARM, holder25, RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
		);
		PlacementUtils.register(
			bootstrapContext, FLOWER_DEFAULT, holder25, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
		);
		PlacementUtils.register(
			bootstrapContext,
		...
		PlacementUtils.register(
			bootstrapContext, FLOWER_SWAMP, holder27, RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
		);
		PlacementUtils.register(
			bootstrapContext,
			FLOWER_PLAINS,
		...
		PlacementUtils.register(
			bootstrapContext, PALE_MOSS_PATCH, holder39, CountPlacement.of(1), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_NO_LEAVES, BiomeFilter.biome()
		);
		PlacementUtils.register(bootstrapContext, TREES_FLOWER_FOREST, holder40, treePlacement(PlacementUtils.countExtra(6, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_MEADOW, holder41, treePlacement(RarityFilter.onAverageOnceEvery(100)));
		PlacementUtils.register(bootstrapContext, TREES_CHERRY, holder46, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.CHERRY_SAPLING));
		PlacementUtils.register(bootstrapContext, TREES_TAIGA, holder42, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_GROVE, holder44, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_BADLANDS, holder43, treePlacement(PlacementUtils.countExtra(5, 0.1F, 1), Blocks.OAK_SAPLING));
		PlacementUtils.register(bootstrapContext, TREES_SNOWY, holder45, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1), Blocks.SPRUCE_SAPLING));
		PlacementUtils.register(
			bootstrapContext,
			TREES_SWAMP,
			holder47,
		...
		PlacementUtils.register(bootstrapContext, TREES_WINDSWEPT_SAVANNA, holder48, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_SAVANNA, holder48, treePlacement(PlacementUtils.countExtra(1, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, BIRCH_TALL, holder49, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_BIRCH, holder50, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1), Blocks.BIRCH_SAPLING));
		PlacementUtils.register(bootstrapContext, TREES_WINDSWEPT_FOREST, holder51, treePlacement(PlacementUtils.countExtra(3, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_WINDSWEPT_HILLS, holder51, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_WATER, holder52, treePlacement(PlacementUtils.countExtra(0, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_BIRCH_AND_OAK_LEAF_LITTER, holder53, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_SPARSE_JUNGLE, holder54, treePlacement(PlacementUtils.countExtra(2, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_OLD_GROWTH_SPRUCE_TAIGA, holder55, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_OLD_GROWTH_PINE_TAIGA, holder56, treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, TREES_JUNGLE, holder57, treePlacement(PlacementUtils.countExtra(50, 0.1F, 1)));
		PlacementUtils.register(bootstrapContext, BAMBOO_VEGETATION, holder58, treePlacement(PlacementUtils.countExtra(30, 0.1F, 1)));
