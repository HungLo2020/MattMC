...
public class Main {
						...
						executor -> WorldLoader.load(
							...
							dataLoadContext -> {
								...
								if (dynamic2 != null) {
									...
									return createNewWorldData(dedicatedServerSettings, dataLoadContext, registry, optionSet.has(optionSpec3), optionSet.has(optionSpec4));
								}
							},
							WorldStem::new,
	...
	private static WorldLoader.DataLoadOutput<WorldData> createNewWorldData(
		DedicatedServerSettings dedicatedServerSettings, WorldLoader.DataLoadContext dataLoadContext, Registry<LevelStem> registry, boolean bl, boolean bl2
	) {
