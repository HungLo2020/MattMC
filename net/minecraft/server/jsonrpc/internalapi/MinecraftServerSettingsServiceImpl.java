...
public class MinecraftServerSettingsServiceImpl implements MinecraftServerSettingsService {
	...
	@Override
	public int setOperatorUserPermissionLevel(int i, ClientInfo clientInfo) {
		this.jsonrpcLogger.log(clientInfo, "Update operator user permission level from {} to {}", this.getOperatorUserPermissionLevel(), i);
		this.server.setOperatorUserPermissionLevel(i);
