...
public class MinecraftOperatorListServiceImpl implements MinecraftOperatorListService {
	...
	@Override
	public void op(NameAndId nameAndId, Optional<Integer> optional, Optional<Boolean> optional2, ClientInfo clientInfo) {
		this.jsonrpcLogger.log(clientInfo, "Op '{}'", nameAndId);
		this.minecraftServer.getPlayerList().op(nameAndId, optional, optional2);
	}
