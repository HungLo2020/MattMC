...
public class ServerSettingsService {
	...
	public static int operatorUserPermissionLevel(MinecraftApi minecraftApi) {
		return minecraftApi.serverSettingsService().getOperatorUserPermissionLevel();
	}

	public static int setOperatorUserPermissionLevel(MinecraftApi minecraftApi, int i, ClientInfo clientInfo) {
		return minecraftApi.serverSettingsService().setOperatorUserPermissionLevel(i, clientInfo);
	}
