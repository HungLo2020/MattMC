...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider, GeneratingChunkMap {
	...
	public final BlockableEventLoop<Runnable> mainThreadExecutor; // Made accessible by DH access widener
	...
	@Nullable
	public ChunkStatus getLatestStatus(long l) {
	...
	public void tick(BooleanSupplier booleanSupplier) { // Made accessible by DH access widener
