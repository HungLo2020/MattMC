...
public interface ClientGamePacketListener extends ClientCommonPacketListener, ClientPongPacketListener {
	...
	void handleTestInstanceBlockStatus(ClientboundTestInstanceBlockStatus clientboundTestInstanceBlockStatus);

	void handleWaypoint(ClientboundTrackedWaypointPacket clientboundTrackedWaypointPacket);

	void handleDebugChunkValue(ClientboundDebugChunkValuePacket clientboundDebugChunkValuePacket);

	void handleDebugBlockValue(ClientboundDebugBlockValuePacket clientboundDebugBlockValuePacket);

	void handleDebugEntityValue(ClientboundDebugEntityValuePacket clientboundDebugEntityValuePacket);

	void handleDebugEvent(ClientboundDebugEventPacket clientboundDebugEventPacket);

	void handleGameTestHighlightPos(ClientboundGameTestHighlightPosPacket clientboundGameTestHighlightPosPacket);
}
