...
public interface StreamCodec<B, V> extends StreamDecoder<B, V>, StreamEncoder<B, V> {
	...
	static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9> StreamCodec<B, C> composite(
		...
		Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, C> function92
	) {
		return new StreamCodec<B, C>() {
			@Override
			public C decode(B object) {
			...
			public void encode(B object, C object2) {
				...
				streamCodec7.encode(object, (T7)function7.apply(object2));
				streamCodec8.encode(object, (T8)function8.apply(object2));
				streamCodec9.encode(object, (T9)function9.apply(object2));
			}
		};
	}
	...
	static <B, C, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> StreamCodec<B, C> composite(
		...
		Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, C> function112
	) {
		return new StreamCodec<B, C>() {
			@Override
			public C decode(B object) {
			...
			public void encode(B object, C object2) {
				...
				streamCodec8.encode(object, (T8)function8.apply(object2));
				streamCodec9.encode(object, (T9)function9.apply(object2));
				streamCodec10.encode(object, (T10)function10.apply(object2));
				streamCodec11.encode(object, (T11)function11.apply(object2));
			}
		};
	}
