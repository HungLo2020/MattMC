...
public class GameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> RULE_LOCATOR_BAR = register(
		...
		GameRules.BooleanValue.create(true, (minecraftServer, booleanValue) -> minecraftServer.getAllLevels().forEach(serverLevel -> {
	...
	public static final GameRules.Key<GameRules.BooleanValue> RULE_SPAWN_MONSTERS = register(
		...
		GameRules.BooleanValue.create(true, (minecraftServer, booleanValue) -> minecraftServer.updateMobSpawningFlags())
	);
	...
	public static Stream<Entry<GameRules.Key<?>, GameRules.Type<?>>> availableRules(FeatureFlagSet featureFlagSet) {
	...
	public static class BooleanValue extends GameRules.Value<GameRules.BooleanValue> {
		...
		private static GameRules.Type<GameRules.BooleanValue> create(
			boolean bl, BiConsumer<MinecraftServer, GameRules.BooleanValue> biConsumer, FeatureFlagSet featureFlagSet
		) {
			return new GameRules.Type<>(
				BoolArgumentType::bool,
				type -> new GameRules.BooleanValue(type, bl),
				biConsumer,
