...
public class PrimaryLevelData implements ServerLevelData, WorldData {
	...
	private PrimaryLevelData(
		...
		boolean bl4,
		boolean bl5,
		Optional<WorldBorder.Settings> optional,
		int o,
		int p,
		@Nullable UUID uUID,
		Set<String> set,
	...
	public static <T> PrimaryLevelData parse(
		...
		return new PrimaryLevelData(
			...
			(LevelData.RespawnData)dynamic.get("spawn").read(LevelData.RespawnData.CODEC).result().orElse(LevelData.RespawnData.DEFAULT),
			l,
			...
			WorldBorder.Settings.CODEC.parse(dynamic.get("world_border").orElseEmptyMap()).result(),
