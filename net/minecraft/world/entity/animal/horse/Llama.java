...
public class Llama extends AbstractChestedHorse implements RangedAttackMob {
	...
	protected void addAdditionalSaveData(ValueOutput valueOutput) {
		...
		valueOutput.store("Variant", Llama.Variant.LEGACY_CODEC, this.getVariant());
	...
	protected void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.setVariant((Llama.Variant)valueInput.read("Variant", Llama.Variant.LEGACY_CODEC).orElse(Llama.Variant.DEFAULT));
	}
	...
	public <T> T get(DataComponentType<? extends T> dataComponentType) {
		return dataComponentType == DataComponents.LLAMA_VARIANT
	...
	protected <T> boolean applyImplicitComponent(DataComponentType<T> dataComponentType, T object) {
		if (dataComponentType == DataComponents.LLAMA_VARIANT) {
			this.setVariant(castComponentValue(DataComponents.LLAMA_VARIANT, object));
			return true;
		} else {
