...
public class Armadillo extends Animal {
	...
	protected void addAdditionalSaveData(ValueOutput valueOutput) {
		...
		valueOutput.store("state", Armadillo.ArmadilloState.CODEC, this.getState());
	...
	protected void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.switchToState((Armadillo.ArmadilloState)valueInput.read("state", Armadillo.ArmadilloState.CODEC).orElse(Armadillo.ArmadilloState.IDLE));
		valueInput.getInt("scute_time").ifPresent(integer -> this.scuteTime = integer);
	}
	...
	public InteractionResult mobInteract(Player player, InteractionHand interactionHand) {
		...
		if (itemStack.is(Items.BRUSH) && this.brushOffScute(player, itemStack)) {
			itemStack.hurtAndBreak(16, player, interactionHand.asEquipmentSlot());
