...
PERF_JAVA_TOOL_OPTIONS="-Dmattmc.runPerfBenchmarks=true -Dmattmc.perf.quads=$QUADS -Dmattmc.perf.warmup=$WARMUP -Dmattmc.perf.iterations=$ITERATIONS -Dmattmc.perf.output=$OUTPUT_FILE"
